...
StructuredBuffer<uint> __3__37__0__0__g_histogram2 : register(t4, space37);

StructuredBuffer<uint> __3__37__0__0__g_histogramR : register(t5, space37);

StructuredBuffer<uint> __3__37__0__0__g_histogramG : register(t6, space37);
    ...
    if (_135) {
      ...
      while (true) {
        ...
        while (true) {
          ...
          // natural viewing. We still keep a single histogram-field proxy here
          // as an engineering background estimate for PsychoV17.
          float _psychov17_field_yf = _198;
          [branch]
          if (IMPROVED_AUTO_EXPOSURE == 2) {
            // Use a central 20-80% histogram band so the adapting field tracks
            // sustained background rather than histogram extremes.
            ...
            while (true) {
              ...
              if ((_psychov17_take > 0.0f) && (_psychov17_bin != 0)) {
                // Average the adapting field in log luminance so ratios, not
                // linear deltas, drive the sustained state.
              ...
              if (_psychov17_sum_weight <= 0.0f) {
                ...
                // Keep the sustained-field Yf positive, then convert the
                // geometric-mean log estimate back to linear luminance.
          ...
          while (true) {
            ...
            float _298 = saturate(_smoothed_target_yf);
            ...
            // Vanilla and smoothed AE use the game's placement curve directly.
            // Perceptual AE also keeps that dynamic target by default; only the
            // optional min/max brightness bounds below constrain it.
            float _323 = _322 + _param2.z;
            ...
            // Baseline game exposure target. Modes 0/1 use this directly.
            ...
            if (IMPROVED_AUTO_EXPOSURE == 2) {
              ...
              // field itself, not the game's exposure-placement curve. Min/max
              // brightness bounds clamp that perceptual target directly.
              //
              // AE2 tonemap uses:
            ...
            while (true) {
              ...
              if (IMPROVED_AUTO_EXPOSURE == 2) {
                ...
                // state too. The fast/slow residuals already model adaptation
                // memory; feeding raw histogram jitter straight into the live
                // field makes scripted flashes and intro cards pulse even when
                // the adaptation times are very long.
                _407 = max(_smoothed_target_yf, 9.999999747378752e-05f);
              } else {
              ...
              // exposure state when either custom AE path is active.
...
//     int _39 = __3__37__0__0__g_histogram[((int)(SV_GroupIndex << 2))];
//     int _42 = __3__37__0__0__g_histogram2[((int)(SV_GroupIndex << 2))];
//     int _45 = __3__37__0__0__g_histogram[(((int)(SV_GroupIndex << 2)) | 1)];
//     int _48 = __3__37__0__0__g_histogram2[(((int)(SV_GroupIndex << 2)) | 1)];
//     int _52 = __3__37__0__0__g_histogram[(((int)(SV_GroupIndex << 2)) | 2)];
//     int _55 = __3__37__0__0__g_histogram2[(((int)(SV_GroupIndex << 2)) | 2)];
//     int _59 = __3__37__0__0__g_histogram[(((int)(SV_GroupIndex << 2)) | 3)];
//     int _62 = __3__37__0__0__g_histogram2[(((int)(SV_GroupIndex << 2)) | 3)];
//     g_pyramid[(int)(SV_GroupIndex)] = (int)(max((uint)((int)(max((uint)((int)(max((uint)(_39), (uint)(_45)))), (uint)(_52)))), (uint)(_59)));
//     g_pyramid2[(int)(SV_GroupIndex)] = (int)(max((uint)((int)(max((uint)((int)(max((uint)(_42), (uint)(_48)))), (uint)(_55)))), (uint)(_62)));
//     GroupMemoryBarrierWithGroupSync();
//     if ((uint)(int)(SV_GroupIndex) < (uint)32) {
//       g_pyramid[(int)(SV_GroupIndex)] = (int)(max((uint)(g_pyramid[(int)(SV_GroupIndex)]), (uint)(g_pyramid[((int)(SV_GroupIndex + 32u))])));
//       g_pyramid2[(int)(SV_GroupIndex)] = (int)(max((uint)(g_pyramid2[(int)(SV_GroupIndex)]), (uint)(g_pyramid2[((int)(SV_GroupIndex + 32u))])));
//     }
//     GroupMemoryBarrierWithGroupSync();
//     if ((uint)(int)(SV_GroupIndex) < (uint)16) {
//       g_pyramid[(int)(SV_GroupIndex)] = (int)(max((uint)(g_pyramid[(int)(SV_GroupIndex)]), (uint)(g_pyramid[((int)(SV_GroupIndex + 16u))])));
//       g_pyramid2[(int)(SV_GroupIndex)] = (int)(max((uint)(g_pyramid2[(int)(SV_GroupIndex)]), (uint)(g_pyramid2[((int)(SV_GroupIndex + 16u))])));
//     }
//     GroupMemoryBarrierWithGroupSync();
//     if ((uint)(int)(SV_GroupIndex) < (uint)8) {
//       g_pyramid[(int)(SV_GroupIndex)] = (int)(max((uint)(g_pyramid[(int)(SV_GroupIndex)]), (uint)(g_pyramid[((int)(SV_GroupIndex + 8u))])));
//       g_pyramid2[(int)(SV_GroupIndex)] = (int)(max((uint)(g_pyramid2[(int)(SV_GroupIndex)]), (uint)(g_pyramid2[((int)(SV_GroupIndex + 8u))])));
//     }
//     GroupMemoryBarrierWithGroupSync();
//     if ((uint)(int)(SV_GroupIndex) < (uint)4) {
//       g_pyramid[(int)(SV_GroupIndex)] = (int)(max((uint)(g_pyramid[(int)(SV_GroupIndex)]), (uint)(g_pyramid[((int)(SV_GroupIndex + 4u))])));
//       g_pyramid2[(int)(SV_GroupIndex)] = (int)(max((uint)(g_pyramid2[(int)(SV_GroupIndex)]), (uint)(g_pyramid2[((int)(SV_GroupIndex + 4u))])));
//     }
//     GroupMemoryBarrierWithGroupSync();
//     if ((uint)(int)(SV_GroupIndex) < (uint)2) {
//       g_pyramid[(int)(SV_GroupIndex)] = (int)(max((uint)(g_pyramid[(int)(SV_GroupIndex)]), (uint)(g_pyramid[((int)(SV_GroupIndex + 2u))])));
//       g_pyramid2[(int)(SV_GroupIndex)] = (int)(max((uint)(g_pyramid2[(int)(SV_GroupIndex)]), (uint)(g_pyramid2[((int)(SV_GroupIndex + 2u))])));
//     }
//     GroupMemoryBarrierWithGroupSync();
//     bool _126 = ((int)(SV_GroupIndex) == 0);
//     if (_126) {
//       g_pyramid[0] = (int)(max((uint)(g_pyramid[0]), (uint)(g_pyramid[1])));
//       g_pyramid2[0] = (int)(max((uint)(g_pyramid2[0]), (uint)(g_pyramid2[1])));
//       _135 = _126;
//     } else {
//       _135 = false;
//     }
//     GroupMemoryBarrierWithGroupSync();
//     if (_135) {
//       float _138 = float((uint)((uint)(g_pyramid[0])));
//       float _140 = 1.0f / max(9.999999974752427e-07f, _138);
//       _142 = 0;
//       _143 = 0.0f;
//       while(true) {
//         int _146 = __3__37__0__0__g_histogram[_142];
//         float _149 = (float((uint)(uint)(_146)) * _140) + _143;
//         bool __defer_141_380 = false;
//         if (!((_142 + 1) == 256)) {
//           _142 = (_142 + 1);
//           _143 = _149;
//           continue;
...
//           while(true) {
//             int _388 = __3__37__0__0__g_histogram[_383];
//             float _390 = float((uint)(uint)(_388)) * _140;
//             float _397 = (_390 * exp2(((float((uint)(uint)(_383)) * 0.00390625f) - _param0.y) / _param0.x)) + _384;
//             float _398 = _390 + _385;
//             bool __defer_382_455 = false;
//             if (!((_383 + 1) == 256)) {
//               _383 = (_383 + 1);
//               _384 = _397;
//               _385 = _398;
...
//             if (__defer_382_455) {
//               __3__39__0__1__g_exposureUAV[16] = _456;
//               float _458 = _456 / max(9.999999717180685e-10f, _452);
//               __3__39__0__1__g_exposureUAV[17] = _458;
//               break;
//             }
//             float _403 = _397 / max(_398, 9.999999747378752e-05f);
//             float _407 = max(_403, _198);
//             float _410 = __3__39__0__1__g_exposureUAV[11];
//             float _413 = ((_407 - _410) * 0.125f) + _410;
...
//             float _440 = __3__39__0__1__g_exposureUAV[12];
//             float _443 = ((((saturate(_314 * _314) * (((((-2.0f - _302) - _297) + (exp2(_299 * 0.25f) * (_302 + 2.5f))) * exp2(_299 * 0.10000000149011612f)) + _297)) * saturate(_403 * 1e+05f)) - _440) * 0.10000000149011612f) + _440;
//             __3__39__0__1__g_exposureUAV[12] = _443;
...
//               _456 = max(9.999999717180685e-10f, _427);
//             } else {
//               _456 = 1.0f;
//             }
//             __3__39__0__1__g_exposureUAV[16] = _456;
...
//         while(true) {
//           int _170 = __3__37__0__0__g_histogram[_156];
//           float _172 = float((uint)(uint)(_170)) * _140;
//           float _173 = min(_159, _172);
//           float _176 = _160 - _173;
//           float _177 = min(_176, (_172 - _173));
//           float _179 = exp2(((float((uint)(uint)(_156)) * 0.00390625f) - _param0.y) / _param0.x) * _177;
//           float _180 = _179 + _157;
//           float _181 = _177 + _158;
//           float _183 = _179 + _161;
//           float _184 = (_179 * _179) + _162;
//           bool __defer_155_380 = false;
//           if (!((_156 + 1) == 256)) {
//             _156 = (_156 + 1);
//             _157 = _180;
//             _158 = _181;
...
//           }
//           float _188 = _183 * 0.00390625f;
//           float _196 = min(max((_180 / max(_181, 9.999999747378752e-05f)), _param1.z), _param1.w);
//           float _197 = sqrt(max(9.999999717180685e-10f, ((_184 * 0.00390625f) - (_188 * _188))));
//           float _198 = max(9.999999974752427e-07f, _196);
//           _200 = 1;
//           while(true) {
//             int _237 = int(floor((_wrappedViewPos.x * ((_clipmapOffsets[_200]).w)) + ((_clipmapRelativeIndexOffsets[_200]).x)));
//             int _238 = int(floor((_wrappedViewPos.y * ((_clipmapOffsets[_200]).w)) + ((_clipmapRelativeIndexOffsets[_200]).y)));
//             int _239 = int(floor((_wrappedViewPos.z * ((_clipmapOffsets[_200]).w)) + ((_clipmapRelativeIndexOffsets[_200]).z)));
//             if (!((((((((int)_237 >= (int)int(((_clipmapOffsets[_200]).x) + -63.0f))) && (((int)_237 < (int)int(((_clipmapOffsets[_200]).x) + 63.0f))))) && (((((int)_238 >= (int)int(((_clipmapOffsets[_200]).y) + -31.0f))) && (((int)_238 < (int)int(((_clipmapOffsets[_200]).y) + 31.0f))))))) && (((((int)_239 >= (int)int(((_clipmapOffsets[_200]).z) + -63.0f))) && (((int)_239 < (int)int(((_clipmapOffsets[_200]).z) + 63.0f))))))) {
//               if ((uint)(_200 + 1) < (uint)8) {
//                 _200 = (_200 + 1);
//                 continue;
//               } else {
//                 _255 = -10000;
...
//             }
//             if (!((uint)_255 > (uint)3)) {
//               float _265 = 1.0f / float((uint)(1u << (_255 & 31)));
//               float _269 = frac(_clipmapUVRelativeOffset.z * _265);
//               float _281 = __3__36__0__1__g_skyVisibilityVoxelsTexturesLikeUav.SampleLevel(__0__4__0__0__g_staticVoxelSampler, float3((_clipmapUVRelativeOffset.x * _265), (_clipmapUVRelativeOffset.y * _265), (((float((uint)(_255 * 66)) + 1.0f) + ((select((_269 < 0.0f), 1.0f, 0.0f) + _269) * 64.0f)) * 0.0037878789007663727f)), 0.0f);
//               _286 = saturate(1.0f - _281.x);
//             } else {
//               _286 = 1.0f;
//             }
//             float _287 = sqrt(_286);
//             float _297 = (saturate((2.0f / (exp2(_198 * -144.26950073242188f) + 1.0f)) + -1.0f) * (_287 + 2.0f)) + (-1.5f - _287);
//             float _299 = log2(saturate(_198));
//             float _302 = _287 * 2.5f;
//             float _314 = (_197 * 10.0f) / max(9.999999717180685e-10f, _196);
//             float _320 = __3__39__0__1__g_autoWhiteBalanceColorUAV[1].w;
//             float _325 = min(max(_198, 9.999999747378752e-05f), 7.0f);
//             float _328 = saturate((_325 + -0.009999999776482582f) * 0.14306151866912842f);
//             float _331 = saturate((_325 + -9.999999747378752e-05f) * 101.01010131835938f);
//             float _332 = _331 * 2.0f;
//             float _335 = (_331 * 3.0f) + -3.0f;
//             float _340 = _335 - (_335 * _328);
//             float _348 = (log2(_198 * 8.0f) - _340) - ((((_332 + -3.5f) + ((3.0f - _332) * _328)) - _340) * sqrt(saturate(_287)));
//             float _349 = exp2(_348);
//             float _350 = 0.8333333134651184f / _349;
//             if (!(_temporalReprojectionParams.w > 0.5f)) {
//               float _357 = __3__39__0__1__g_exposureUAV[1];
//               if (_350 > _357) {
//                 float _363 = 1.0f / _357;
//                 _381 = (1.0f / (((1.0f - exp2(-0.0f - (_param2.x * _timeNoScale.z))) * ((_349 * 1.2000000476837158f) - _363)) + _363));
//               } else {
...
//     }
//   } else {
//     if (_param2.w > 0.0010000000474974513f) {
//       int _467 = __3__37__0__0__g_histogramR[((int)(SV_GroupIndex << 2))];
//       int _470 = __3__37__0__0__g_histogramG[((int)(SV_GroupIndex << 2))];
//       int _473 = __3__37__0__0__g_histogramB[((int)(SV_GroupIndex << 2))];
//       int _476 = __3__37__0__0__g_histogramR[(((int)(SV_GroupIndex << 2)) | 1)];
//       int _478 = __3__37__0__0__g_histogramG[(((int)(SV_GroupIndex << 2)) | 1)];
//       int _480 = __3__37__0__0__g_histogramB[(((int)(SV_GroupIndex << 2)) | 1)];
//       int _486 = __3__37__0__0__g_histogramR[(((int)(SV_GroupIndex << 2)) | 2)];
//       int _488 = __3__37__0__0__g_histogramG[(((int)(SV_GroupIndex << 2)) | 2)];
//       int _490 = __3__37__0__0__g_histogramB[(((int)(SV_GroupIndex << 2)) | 2)];
//       int _496 = __3__37__0__0__g_histogramR[(((int)(SV_GroupIndex << 2)) | 3)];
//       int _498 = __3__37__0__0__g_histogramG[(((int)(SV_GroupIndex << 2)) | 3)];
//       int _500 = __3__37__0__0__g_histogramB[(((int)(SV_GroupIndex << 2)) | 3)];
//       g_pyramidRGB[((int)(0u + ((int)(SV_GroupIndex) * 3)))] = (int)(max((uint)((int)(max((uint)((int)(max((uint)(_467), (uint)(_476)))), (uint)(_486)))), (uint)(_496)));
//       g_pyramidRGB[((int)(1u + ((int)(SV_GroupIndex) * 3)))] = (int)(max((uint)((int)(max((uint)((int)(max((uint)(_470), (uint)(_478)))), (uint)(_488)))), (uint)(_498)));
//       g_pyramidRGB[((int)(2u + ((int)(SV_GroupIndex) * 3)))] = (int)(max((uint)((int)(max((uint)((int)(max((uint)(_473), (uint)(_480)))), (uint)(_490)))), (uint)(_500)));
//       GroupMemoryBarrierWithGroupSync();
//       if ((uint)(int)(SV_GroupIndex) < (uint)32) {
//         g_pyramidRGB[((int)(0u + ((int)(SV_GroupIndex) * 3)))] = (int)(max((uint)(g_pyramidRGB[((int)(0u + ((int)(SV_GroupIndex) * 3)))]), (uint)(g_pyramidRGB[((int)(0u + (((int)(SV_GroupIndex + 32u)) * 3)))])));
//         g_pyramidRGB[((int)(1u + ((int)(SV_GroupIndex) * 3)))] = (int)(max((uint)(g_pyramidRGB[((int)(1u + ((int)(SV_GroupIndex) * 3)))]), (uint)(g_pyramidRGB[((int)(1u + (((int)(SV_GroupIndex + 32u)) * 3)))])));
//         g_pyramidRGB[((int)(2u + ((int)(SV_GroupIndex) * 3)))] = (int)(max((uint)(g_pyramidRGB[((int)(2u + ((int)(SV_GroupIndex) * 3)))]), (uint)(g_pyramidRGB[((int)(2u + (((int)(SV_GroupIndex + 32u)) * 3)))])));
//       }
//       GroupMemoryBarrierWithGroupSync();
//       if ((uint)(int)(SV_GroupIndex) < (uint)16) {
//         g_pyramidRGB[((int)(0u + ((int)(SV_GroupIndex) * 3)))] = (int)(max((uint)(g_pyramidRGB[((int)(0u + ((int)(SV_GroupIndex) * 3)))]), (uint)(g_pyramidRGB[((int)(0u + (((int)(SV_GroupIndex + 16u)) * 3)))])));
//         g_pyramidRGB[((int)(1u + ((int)(SV_GroupIndex) * 3)))] = (int)(max((uint)(g_pyramidRGB[((int)(1u + ((int)(SV_GroupIndex) * 3)))]), (uint)(g_pyramidRGB[((int)(1u + (((int)(SV_GroupIndex + 16u)) * 3)))])));
//         g_pyramidRGB[((int)(2u + ((int)(SV_GroupIndex) * 3)))] = (int)(max((uint)(g_pyramidRGB[((int)(2u + ((int)(SV_GroupIndex) * 3)))]), (uint)(g_pyramidRGB[((int)(2u + (((int)(SV_GroupIndex + 16u)) * 3)))])));
//       }
//       GroupMemoryBarrierWithGroupSync();
//       if ((uint)(int)(SV_GroupIndex) < (uint)8) {
//         g_pyramidRGB[((int)(0u + ((int)(SV_GroupIndex) * 3)))] = (int)(max((uint)(g_pyramidRGB[((int)(0u + ((int)(SV_GroupIndex) * 3)))]), (uint)(g_pyramidRGB[((int)(0u + (((int)(SV_GroupIndex + 8u)) * 3)))])));
//         g_pyramidRGB[((int)(1u + ((int)(SV_GroupIndex) * 3)))] = (int)(max((uint)(g_pyramidRGB[((int)(1u + ((int)(SV_GroupIndex) * 3)))]), (uint)(g_pyramidRGB[((int)(1u + (((int)(SV_GroupIndex + 8u)) * 3)))])));
//         g_pyramidRGB[((int)(2u + ((int)(SV_GroupIndex) * 3)))] = (int)(max((uint)(g_pyramidRGB[((int)(2u + ((int)(SV_GroupIndex) * 3)))]), (uint)(g_pyramidRGB[((int)(2u + (((int)(SV_GroupIndex + 8u)) * 3)))])));
//       }
//       GroupMemoryBarrierWithGroupSync();
//       if ((uint)(int)(SV_GroupIndex) < (uint)4) {
//         g_pyramidRGB[((int)(0u + ((int)(SV_GroupIndex) * 3)))] = (int)(max((uint)(g_pyramidRGB[((int)(0u + ((int)(SV_GroupIndex) * 3)))]), (uint)(g_pyramidRGB[((int)(0u + (((int)(SV_GroupIndex + 4u)) * 3)))])));
//         g_pyramidRGB[((int)(1u + ((int)(SV_GroupIndex) * 3)))] = (int)(max((uint)(g_pyramidRGB[((int)(1u + ((int)(SV_GroupIndex) * 3)))]), (uint)(g_pyramidRGB[((int)(1u + (((int)(SV_GroupIndex + 4u)) * 3)))])));
//         g_pyramidRGB[((int)(2u + ((int)(SV_GroupIndex) * 3)))] = (int)(max((uint)(g_pyramidRGB[((int)(2u + ((int)(SV_GroupIndex) * 3)))]), (uint)(g_pyramidRGB[((int)(2u + (((int)(SV_GroupIndex + 4u)) * 3)))])));
//       }
//       GroupMemoryBarrierWithGroupSync();
//       if ((uint)(int)(SV_GroupIndex) < (uint)2) {
//         g_pyramidRGB[((int)(0u + ((int)(SV_GroupIndex) * 3)))] = (int)(max((uint)(g_pyramidRGB[((int)(0u + ((int)(SV_GroupIndex) * 3)))]), (uint)(g_pyramidRGB[((int)(0u + (((int)(SV_GroupIndex + 2u)) * 3)))])));
//         g_pyramidRGB[((int)(1u + ((int)(SV_GroupIndex) * 3)))] = (int)(max((uint)(g_pyramidRGB[((int)(1u + ((int)(SV_GroupIndex) * 3)))]), (uint)(g_pyramidRGB[((int)(1u + (((int)(SV_GroupIndex + 2u)) * 3)))])));
//         g_pyramidRGB[((int)(2u + ((int)(SV_GroupIndex) * 3)))] = (int)(max((uint)(g_pyramidRGB[((int)(2u + ((int)(SV_GroupIndex) * 3)))]), (uint)(g_pyramidRGB[((int)(2u + (((int)(SV_GroupIndex + 2u)) * 3)))])));
//       }
//       GroupMemoryBarrierWithGroupSync();
//       bool _623 = ((int)(SV_GroupIndex) == 0);
//       if (_623) {
//         g_pyramidRGB[0] = (int)(max((uint)(g_pyramidRGB[0]), (uint)(g_pyramidRGB[3])));
//         g_pyramidRGB[1] = (int)(max((uint)(g_pyramidRGB[1]), (uint)(g_pyramidRGB[4])));
//         g_pyramidRGB[2] = (int)(max((uint)(g_pyramidRGB[2]), (uint)(g_pyramidRGB[5])));
//         _635 = _623;
//       } else {
//         _635 = false;
//       }
//       GroupMemoryBarrierWithGroupSync();
//       if (_635) {
//         float _641 = 1.0f / float((uint)((uint)(g_pyramidRGB[0])));
//         _643 = 0;
//         _644 = 0.0f;
//         while(true) {
//           int _647 = __3__37__0__0__g_histogramR[_643];
//           float _650 = (float((uint)(uint)(_647)) * _641) + _644;
//           bool __defer_642_896 = false;
//           if (!((_643 + 1) == 256)) {
//             _643 = (_643 + 1);
//             _644 = _650;
//             continue;
//           }
//           if (__defer_642_896) {
//             _923 = select((_885 < 0.040449999272823334f), (_885 * 0.07739938050508499f), exp2(log2((_885 + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f));
//             _924 = select((_886 < 0.040449999272823334f), (_886 * 0.07739938050508499f), exp2(log2((_886 + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f));
//             _925 = select((_897 < 0.040449999272823334f), (_897 * 0.07739938050508499f), exp2(log2((_897 + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f));
//             _926 = _864;
//             float _930 = saturate(_temporalReprojectionParams.w + 0.10000000149011612f);
//             float _933 = __3__39__0__1__g_autoWhiteBalanceColorUAV[0].x;
//             float _934 = __3__39__0__1__g_autoWhiteBalanceColorUAV[0].y;
//             float _935 = __3__39__0__1__g_autoWhiteBalanceColorUAV[0].z;
//             float _936 = __3__39__0__1__g_autoWhiteBalanceColorUAV[0].w;
//             float _945 = ((_923 - _933) * _930) + _933;
//             float _946 = ((_924 - _934) * _930) + _934;
//             float _947 = ((_925 - _935) * _930) + _935;
//             float _948 = ((1.0f - _936) * _930) + _936;
//             __3__39__0__1__g_autoWhiteBalanceColorUAV[0].x = _945; __3__39__0__1__g_autoWhiteBalanceColorUAV[0].y = _946; __3__39__0__1__g_autoWhiteBalanceColorUAV[0].z = _947; __3__39__0__1__g_autoWhiteBalanceColorUAV[0].w = _948;
//             _950 = 0.0f;
//             _951 = 0.0f;
//             _952 = 0;
//             while(true) {
//               int _955 = __3__37__0__0__g_histogramR[_952];
//               float _957 = float((uint)(uint)(_955)) * _641;
//               float _964 = (_957 * exp2(((float((uint)(uint)(_952)) * 0.00390625f) - _param0.y) / _param0.x)) + _950;
//               float _965 = _957 + _951;
//               if (!((_952 + 1) == 256)) {
//                 _950 = _964;
//                 _951 = _965;
...
//                 continue;
//               }
//               float _970 = _964 / max(_965, 9.999999747378752e-05f);
//               _972 = 0.0f;
//               _973 = 0.0f;
//               _974 = 0;
//               while(true) {
//                 int _977 = __3__37__0__0__g_histogramG[_974];
//                 float _979 = float((uint)(uint)(_977)) * _688;
//                 float _986 = (_979 * exp2(((float((uint)(uint)(_974)) * 0.00390625f) - _param0.y) / _param0.x)) + _972;
//                 float _987 = _979 + _973;
//                 if (!((_974 + 1) == 256)) {
//                   _972 = _986;
//                   _973 = _987;
...
//                   continue;
//                 }
//                 float _992 = _986 / max(_987, 9.999999747378752e-05f);
//                 _994 = 0.0f;
//                 _995 = 0.0f;
//                 _996 = 0;
//                 while(true) {
//                   int _999 = __3__37__0__0__g_histogramB[_996];
//                   float _1001 = float((uint)(uint)(_999)) * _736;
//                   float _1008 = (_1001 * exp2(((float((uint)(uint)(_996)) * 0.00390625f) - _param0.y) / _param0.x)) + _994;
//                   float _1009 = _1001 + _995;
//                   if (!((_996 + 1) == 256)) {
//                     _994 = _1008;
//                     _995 = _1009;
...
//                     continue;
//                   }
//                   float _1014 = _1008 / max(_1009, 9.999999747378752e-05f);
//                   float _1016 = max(max(_970, _992), _1014);
//                   float _1020 = saturate(_970 / _1016);
//                   float _1021 = saturate(_992 / _1016);
//                   float _1022 = saturate(_1014 / _1016);
//                   float _1063 = asfloat((((((int)(uint(saturate(select((_1020 <= 0.0031308000907301903f), (_1020 * 12.920000076293945f), (((pow(_1020, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f))) * 255.0f) << 16)) | (((int)(uint(saturate(select((_1021 <= 0.0031308000907301903f), (_1021 * 12.920000076293945f), (((pow(_1021, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f))) * 255.0f) << 8)) & 65280)) | ((int)(uint(saturate(select((_1022 <= 0.0031308000907301903f), (_1022 * 12.920000076293945f), (((pow(_1022, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f))) * 255.0f)) & 255)) | -16777216));
//                   __3__39__0__1__g_exposureUAV[6] = _1063;
//                   __3__39__0__1__g_exposureUAV[7] = _926;
//                   break;
//                   break;
...
//           while(true) {
//             int _669 = __3__37__0__0__g_histogramR[_657];
//             float _671 = float((uint)(uint)(_669)) * _641;
//             float _672 = min(_660, _671);
//             float _675 = _661 - _672;
//             float _676 = min(_675, (_671 - _672));
//             float _679 = (_676 * exp2(((float((uint)(uint)(_657)) * 0.00390625f) - _param0.y) / _param0.x)) + _658;
//             float _680 = _676 + _659;
//             bool __defer_656_896 = false;
//             if (!((_657 + 1) == 256)) {
//               _657 = (_657 + 1);
//               _658 = _679;
//               _659 = _680;
...
//               }
//             }
//             float _688 = 1.0f / float((uint)((uint)(g_pyramidRGB[1])));
//             _690 = 0;
//             _691 = 0.0f;
//             while(true) {
//               int _694 = __3__37__0__0__g_histogramG[_690];
//               float _697 = (float((uint)(uint)(_694)) * _688) + _691;
//               bool __defer_689_896 = false;
//               if (!((_690 + 1) == 256)) {
//                 _690 = (_690 + 1);
//                 _691 = _697;
//                 continue;
...
//                 }
//               }
//               float _701 = min(max((_679 / max(_680, 9.999999747378752e-05f)), _param1.z), _param1.w);
//               _705 = 0;
//               _706 = 0.0f;
//               _707 = 0.0f;
//               _708 = (_697 * _param1.x);
...
//               while(true) {
//                 int _717 = __3__37__0__0__g_histogramG[_705];
//                 float _719 = float((uint)(uint)(_717)) * _688;
//                 float _720 = min(_708, _719);
//                 float _723 = _709 - _720;
//                 float _724 = min(_723, (_719 - _720));
//                 float _727 = (_724 * exp2(((float((uint)(uint)(_705)) * 0.00390625f) - _param0.y) / _param0.x)) + _706;
//                 float _728 = _724 + _707;
//                 bool __defer_704_896 = false;
//                 if (!((_705 + 1) == 256)) {
//                   _705 = (_705 + 1);
//                   _706 = _727;
//                   _707 = _728;
...
//                   }
//                 }
//                 float _736 = 1.0f / float((uint)((uint)(g_pyramidRGB[2])));
//                 _738 = 0;
//                 _739 = 0.0f;
//                 while(true) {
//                   int _742 = __3__37__0__0__g_histogramB[_738];
//                   float _745 = (float((uint)(uint)(_742)) * _736) + _739;
//                   bool __defer_737_896 = false;
//                   if (!((_738 + 1) == 256)) {
//                     _738 = (_738 + 1);
//                     _739 = _745;
//                     continue;
...
//                     }
//                   }
//                   float _749 = min(max((_727 / max(_728, 9.999999747378752e-05f)), _param1.z), _param1.w);
//                   _753 = 0;
//                   _754 = 0.0f;
//                   _755 = 0.0f;
//                   _756 = (_745 * _param1.x);
...
//                   while(true) {
//                     int _765 = __3__37__0__0__g_histogramB[_753];
//                     float _767 = float((uint)(uint)(_765)) * _736;
//                     float _768 = min(_756, _767);
//                     float _771 = _757 - _768;
//                     float _772 = min(_771, (_767 - _768));
//                     float _775 = (_772 * exp2(((float((uint)(uint)(_753)) * 0.00390625f) - _param0.y) / _param0.x)) + _754;
//                     float _776 = _772 + _755;
//                     bool __defer_752_896 = false;
//                     if (!((_753 + 1) == 256)) {
//                       _753 = (_753 + 1);
//                       _754 = _775;
//                       _755 = _776;
...
//                       }
//                     }
//                     float _783 = min(max((_775 / max(_776, 9.999999747378752e-05f)), _param1.z), _param1.w);
//                     float _789 = max(0.0010000000474974513f, max(max(abs(_701), abs(_749)), abs(_783)));
//                     float _790 = _701 / _789;
//                     float _791 = _749 / _789;
//                     float _792 = _783 / _789;
//                     float _794 = dot(float3(_790, _791, _792), float3(-1.0f, 2.0f, -1.0f));
//                     float _795 = dot(float3(_790, _791, _792), float3(2.0f, 0.0f, -2.0f)) * 0.25f;
//                     float _796 = _794 * 0.25f;
//                     float _798 = (_795 + 1.0f) - _796;
//                     float _799 = _796 + 1.0f;
//                     float _801 = (1.0f - _795) - _796;
//                     float _824 = select((_798 <= 0.0031308000907301903f), (_798 * 12.920000076293945f), (((pow(_798, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
//                     float _825 = select((_799 <= 0.0031308000907301903f), ((_794 * 3.2300000190734863f) + 12.920000076293945f), (((pow(_799, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
//                     float _826 = select((_801 <= 0.0031308000907301903f), (_801 * 12.920000076293945f), (((pow(_801, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
//                     float _831 = ((_825 * 0.10345499962568283f) + (_824 * 0.6499260067939758f)) + (_826 * 0.19710899889469147f);
//                     float _836 = ((_825 * 0.7430750131607056f) + (_824 * 0.23432700335979462f)) + (_826 * 0.02259800024330616f);
//                     float _841 = (((_826 * 1.0357630252838135f) + (_825 * 0.05307700112462044f)) + _836) + _831;
//                     float _846 = ((_831 / _841) + -0.33660000562667847f) / ((_836 / _841) + -0.17350000143051147f);
//                     float _858 = (((exp2(_846 * -1.5654412508010864f) * 6253.80322265625f) + -949.8631591796875f) + (exp2(_846 * -7.199436664581299f) * 28.705989837646484f)) + (exp2(_846 * -20.248350143432617f) * 3.9999998989515007e-05f);
//                     if (((_858 < 5000.0f)) || ((_858 > 6500.0f))) {
//                       float _864 = min(max(_858, 5000.0f), 6500.0f);
//                       float _867 = min(max(_864, 1000.0f), 40000.0f) * 0.009999999776482582f;
//                       if (!(_867 <= 66.0f)) {
//                         float _875 = log2(_867 + -60.0f);
//                         _884 = (exp2(_875 * -0.07551484555006027f) * 1.1298909187316895f);
//                         _885 = saturate(exp2(_875 * -0.13320475816726685f) * 1.2929362058639526f);
//                       } else {
//                         _884 = ((log2(_867) * 0.27038395404815674f) + -0.6318414211273193f);
//                         _885 = 1.0f;
//                       }
//                       float _886 = saturate(_884);
//                       if (!(_867 >= 66.0f)) {
//                         if (!(_867 <= 19.0f)) {
//                           _897 = saturate((log2(_867 + -10.0f) * 0.3765222728252411f) + -1.1962541341781616f);
//                         } else {
//                           _897 = 0.0f;
//                         }
//                       } else {
