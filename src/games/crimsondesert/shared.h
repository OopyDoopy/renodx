...
#define MICRO_SHADOW_QUALITY_MEDIUM            1.f
#define MICRO_SHADOW_QUALITY_LEGACY            2.f
#define MICRO_SHADOW_QUALITY_HIGH              3.f
...
#define CONTACT_SHADOW_DETAIL_PATH             (((MICRO_SHADOW_QUALITY == MICRO_SHADOW_QUALITY_MEDIUM) || (MICRO_SHADOW_QUALITY >= MICRO_SHADOW_QUALITY_HIGH)) ? 1.f : 0.f)
#define CONTACT_SHADOW_MARCH_BLEND             (MICRO_SHADOW_QUALITY == MICRO_SHADOW_QUALITY_MEDIUM ? 0.50f : (MICRO_SHADOW_QUALITY >= MICRO_SHADOW_QUALITY_HIGH ? 1.00f : 0.f))
#define CONTACT_SHADOW_REACH_BLEND             (MICRO_SHADOW_QUALITY == MICRO_SHADOW_QUALITY_MEDIUM ? 0.50f : (MICRO_SHADOW_QUALITY >= MICRO_SHADOW_QUALITY_LEGACY ? 1.00f : 0.f))
#define CONTACT_SHADOW_START_BLEND             (MICRO_SHADOW_QUALITY == MICRO_SHADOW_QUALITY_MEDIUM ? 0.50f : (MICRO_SHADOW_QUALITY >= MICRO_SHADOW_QUALITY_LEGACY ? 1.00f : 0.f))
#define CONTACT_MICRO_DETAIL_STRENGTH          (MICRO_SHADOW_QUALITY == MICRO_SHADOW_QUALITY_MEDIUM ? 0.65f : (MICRO_SHADOW_QUALITY >= MICRO_SHADOW_QUALITY_HIGH ? 1.00f : 0.f))
