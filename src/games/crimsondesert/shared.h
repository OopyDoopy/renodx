...
#define DISABLE_AWB                            (shader_injection.disable_awb_mode > 0.5f ? 1.0f : 0.0f)
#define DISABLE_HERO_LIGHTS                    (shader_injection.disable_awb_mode > 1.5f ? 1.0f : 0.0f)
