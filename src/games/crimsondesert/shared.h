...
#define CONTACT_MICRO_DISTANCE_FADE            saturate(mad((CONTACT_SHADOW_IS_FULL ? -0.022f : -0.025f), MICRO_LINEAR_DEPTH, (CONTACT_SHADOW_IS_FULL ? 3.10f : 3.0f)))
...
#define CONTACT_MICRO_DISTANCE_FADE_RT         saturate(mad((CONTACT_SHADOW_IS_FULL ? CONTACT_MICRO_FADE_SLOPE_RT_FULL : -0.025f), MICRO_LINEAR_DEPTH, (CONTACT_SHADOW_IS_FULL ? CONTACT_MICRO_FADE_OFFSET_RT_FULL : 3.0f)))
