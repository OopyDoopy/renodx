...
#define CUSTOM_FLAGS__CONTACT_SHADOW_QUALITY_BIT1       0b100000000000000000000000000u
...
#define CONTACT_SHADOW_QUALITY                 (RR_ENABLED == 1.f ? ((float)((((CUSTOM_FLAGS_AS_UINT & CUSTOM_FLAGS__CONTACT_SHADOW_QUALITY) != 0u) ? 1u : 0u) | (((CUSTOM_FLAGS_AS_UINT & CUSTOM_FLAGS__CONTACT_SHADOW_QUALITY_BIT1) != 0u) ? 2u : 0u))) : 0.f)
#define CONTACT_SHADOW_DETAIL_PATH             (((CONTACT_SHADOW_QUALITY == 1.f) || (CONTACT_SHADOW_QUALITY >= 3.f)) ? 1.f : 0.f)
#define CONTACT_SHADOW_MARCH_BLEND             (CONTACT_SHADOW_QUALITY == 1.f ? 0.50f : (CONTACT_SHADOW_QUALITY >= 3.f ? 1.00f : 0.f))
#define CONTACT_SHADOW_REACH_BLEND             (CONTACT_SHADOW_QUALITY == 1.f ? 0.50f : (CONTACT_SHADOW_QUALITY >= 2.f ? 1.00f : 0.f))
#define CONTACT_SHADOW_START_BLEND             (CONTACT_SHADOW_QUALITY == 1.f ? 0.50f : (CONTACT_SHADOW_QUALITY >= 2.f ? 1.00f : 0.f))
#define CONTACT_MICRO_DETAIL_STRENGTH          (CONTACT_SHADOW_QUALITY == 1.f ? 0.65f : (CONTACT_SHADOW_QUALITY >= 3.f ? 1.00f : 0.f))
