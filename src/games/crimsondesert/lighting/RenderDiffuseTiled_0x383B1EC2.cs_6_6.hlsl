...
void main(
  ...
  // [sem: _3__36__0__0__g_texNetDensity_sampleLod]
    ...
    // RenoDX: >>> [Patch: PurkinjeDirectLight] [Version: 1.09]
    ...
    // RenoDX: >>> [Patch: MaterialSpecularAA] [Version: 1.09]
    ...
    _3682 = (_3505 == 54);
    _3683 = _3682 || _3681;
    // RenoDX: >>> [Patch: FoliageTransmission] [Version: 1.09]
          ...
          if (_3981) {
            if ((_3672 > 0.0f) || (_3673 > 0.0f)) {
              ...
              if (!(_3506 > 0.9900000095367432f)) {
                ...
                _4173 = 1.0f - _3675;
                _4174 = _4173 * _4173;
                // RenoDX: >>> [Patch: MaterialDiffuseBRDF] [Version: 1.09]
                ...
                // RenoDX: >>> [Patch: MaterialDiffraction] [Patch: MaterialSmoothTerminator] [Patch: FoliageTransmission] [Version: 1.09]
  ...
  // [sem: _3__36__0__0__g_iblBrdfLookup_sampleLod]
    ...
    // RenoDX: >>> [Patch: FoliageFinalAO] [Version: 1.09]
