...
void main(
  ...
  float _3200;
  float _3201;
  if (!(((((_103.x < 1.0000000116860974e-07f)) || ((_103.x == 1.0f)))) || ((_108 == 10)))) {
    ...
    float _3097 = (((QuadReadLaneAt(_3073,1) + QuadReadLaneAt(_3073,0)) + QuadReadLaneAt(_3073,2)) + QuadReadLaneAt(_3073,3)) * 0.25f;
    float _3098 = (((QuadReadLaneAt(_3074,1) + QuadReadLaneAt(_3074,0)) + QuadReadLaneAt(_3074,2)) + QuadReadLaneAt(_3074,3)) * 0.25f;
    float _3099 = (((QuadReadLaneAt(_3075,1) + QuadReadLaneAt(_3075,0)) + QuadReadLaneAt(_3075,2)) + QuadReadLaneAt(_3075,3)) * 0.25f;
    [branch]
