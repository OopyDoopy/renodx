...
Texture3D<float2> __3__36__0__0__g_hairDualScatteringLUT : register(t219, space36);

Texture2D<float4> __3__36__0__0__g_blueNoise : register(t144, space36);

Texture2D<float4> __3__36__0__0__g_bentCone : register(t104, space36);
...
Texture2D<float2> __3__36__0__0__g_hairBrdfLookup : register(t154, space36);
...
cbuffer __3__35__0__0__MaterialParameterPresetTableConstantBuffer : register(b33, space35) {
  struct {
...
void main(
  ...
  // [sem: expr_sat]
    ...
    if (_406) {
      ...
      _456 = (half)(half(_effectiveMetallicForVelvet * _450));
      _457 = _117;
      _458 = _446;
      _459 = _447;
      _460 = _448;
    ...
    if (_457 == 66) {
      ...
      if ((_457 == 54) || ((_457 & 126) == 66)) {
        ...
        _586 = float(_281);
        _587 = float(_282);
        _588 = dot(float3(_540, _541, _542), float3(_556, _557, _558));
        _589 = -0.0f - _399;
        _590 = -0.0f - _400;
        _591 = -0.0f - _401;
        _592 = dot(float3(_540, _541, _542), float3(_589, _590, _591));
  ...
  // [sem: invLength]
        ...
        _734 = saturate(abs(dot(float3(_556, _557, _558), float3(_540, _541, _542))));  // [sem: expr_sat]
  ...
  // [sem: _3__36__0__0__g_hairDualScatteringLUT_sampleLod]
      ...
      if ((_457 == 67) || _466) {
        ...
        if (!(float(_456) > (frac(frac(dot(float2(((_473 * 32.665000915527344f) + _102), ((_473 * 11.8149995803833f) + _103)), float2(0.0671105608344078f, 0.005837149918079376f))) * 52.98291778564453f) * 0.20000000298023224f))) {
          if ((_457 & 126) == 66) {
            _494 = 1.0f;
            _528 = _494;
            _529 = 0.0h;
  ...
  // [sem: _3__36__0__0__g_hairDualScatteringLUT_sampleLod]
    ...
    _991 = select(_988, float(_949), 0.0f);
    ...
    if (_993) {
      ...
      _1022 = _1013;
      _1023 = (half)(select(((_953 == 24) || _995), 0.010002136f, _162));
      _1024 = (half)(select(_1017, 1.0f, _280));
      _1025 = (half)(select(_1017, 1.0f, _281));
      _1026 = (half)(select(_1017, 1.0f, _282));
      _1027 = _1011;
      _1028 = _1000;
    } else {
      _1022 = (half)(select(_988, 0.0f, _949));
      _1023 = _162;
      _1024 = _280;
      _1025 = _281;
      _1026 = _282;
    ...
    // Description: RenderDiffuseTiledCS 0x8D504954 applies AO+ foliage color shaping to foliage stencil materials after vanilla resolves the direct diffuse base color, using g_sceneShadowColor visibility so shadowed foliage does not receive the fully sunlit color-shaping path.
    if (FOLIAGE_COLOR_CORRECT > 0.0f && ((uint)(_117 - 12) < 7u)) {
      float3 _rndx_fcBaseColor = float3(float(_1024), float(_1025), float(_1026));
      ...
      _1024 = half(_rndx_fscColor.x);
      _1025 = half(_rndx_fscColor.y);
      _1026 = half(_rndx_fscColor.z);
    }
    ...
    if ((uint)_1908 > (uint)52) {
      if ((uint)_1908 < (uint)68) {
        if (_2131 == 66) {
          ...
          _2298 = _2292;
          _2299 = _2293;
          _2300 = (half)(max(0.89990234h, _1023));
        } else {
          if (!(_1908 == 54)) {
            _2268 = _2103 * _2103;
            _2269 = _2104 * _2104;
          ...
          if ((_1908 == 54) || (_2131 == 66)) {
            ...
            _2298 = _2283;
            _2299 = _2284;
            _2300 = (half)(max(0.099975586h, _1023));
          }
        }
      } else {
        _2296 = _2103;
  ...
  // [sem: _3__36__0__0__g_stencilPrev_gather]
        ...
        _2453 = max(saturate(min(max(((_1028 / (((_121 * _121) * 0.004999999888241291f) + 1.0f)) + (_2125 * 0.5f)), 0.03125f), 0.5f) + _2257), saturate(1.0f - dot(float4(_2417, _2418, _2419, _2420), float4(1.0f, 1.0f, 1.0f, 1.0f))));
        _2454 = _2380;
        _2455 = _2381;
        _2456 = _2417;
        _2457 = _2418;
  ...
  // [sem: _3__36__0__0__g_texNetDensity_sampleLod]
    ...
    // Description: RenderDiffuseTiledCS 0x8D504954 initializes foliage transmission accumulators once before the preserved direct-light branch fanout; exactly one foliage branch contributes transmission before final diffuse-light add-back.
  ...
  // [sem: invLength]
          ...
          if (_3981) {
            if ((_3672 > 0.0f) || (_3673 > 0.0f)) {
              ...
              if (!(_3506 > 0.9900000095367432f)) {
                ...
                // RenoDX: >>> [Patch: FoliageTransmission] [Version: 1.11-family]
                // Description: RenderDiffuseTiledCS 0x8D504954 adds AO+ foliage transmission to this vanilla direct-light branch without enabling the broader material-table direct-light patches on this sibling.
    ...
    if (_3570) {
      ...
      _4757 = _4390;
      _4758 = _4391;
      _4759 = ((_4460 * ((((((_4425 * 0.10000000149011612f) + (_4420 * 0.2329999953508377f)) + (_4433 * 0.11800000071525574f)) + (_4439 * 0.11299999803304672f)) + (_4446 * 0.3580000102519989f)) + (exp2(_4418 * -0.19469568133354187f) * 0.07800000160932541f))) + _4409);
      _4760 = ((_4460 * (((((_4425 * 0.335999995470047f) + (_4420 * 0.45500001311302185f)) + (_4433 * 0.1979999989271164f)) + _4441) + (_4446 * 0.004000000189989805f))) + _4410);
      _4761 = ((_4460 * (((_4425 * 0.3440000116825104f) + (_4420 * 0.6489999890327454f)) + _4441)) + _4411);
      _4762 = _4759 * _3661;
      _4763 = _4760 * _3662;
      _4764 = _4761 * _3663;
      _4766 = (_4392 * _3661) * _4753;
      _4768 = (_4393 * _3662) * _4754;
      _4770 = (_4394 * _3663) * _4755;
      if (_3599) {
        _4772 = _4766;
        _4773 = _4768;
        _4774 = _4770;
        ...
        if ((_121 < 1000.0f) && (_3152 == 0.0h)) {
          if (!(abs(_224) > 0.9900000095367432f)) {
            _4791 = -0.0f - _225;
            _4793 = rsqrt(dot(float3(_4791, 0.0f, _223), float3(_4791, 0.0f, _223)));  // [sem: invLength]
            _4797 = (_4793 * _4791);
            _4798 = (_4793 * _223);
          } else {
            _4797 = 1.0f;
          ...
          _4800 = -0.0f - (_224 * _4798);
          _4803 = (_4798 * _223) - (_4797 * _225);
          _4804 = _4797 * _224;
          _4806 = rsqrt(dot(float3(_4800, _4803, _4804), float3(_4800, _4803, _4804)));  // [sem: invLength]
          _4812 = _viewPos.x + _394;
          _4813 = _viewPos.z + _396;
  // [sem: _3__36__0__0__g_blueNoise_sampleLod]
          _4818 = __3__36__0__0__g_blueNoise.SampleLevel(__0__4__0__0__g_staticBilinearWrap, float2(dot(float3(_4797, 0.0f, _4798), float3(_4812, _3239, _4813)), dot(float3((_4806 * _4800), (_4803 * _4806), (_4806 * _4804)), float3(_4812, _3239, _4813))), 0.0f);
          _4822 = _4818.x + -0.5f;
          _4823 = _4818.y + -0.5f;
          _4824 = _4818.z + -0.5f;
          _4826 = rsqrt(dot(float3(_4822, _4823, _4824), float3(_4822, _4823, _4824)));  // [sem: invLength]
          _4830 = (_4822 * _4826) + _3539;
          _4831 = (_4823 * _4826) + _3540;
          _4832 = (_4824 * _4826) + _3541;
          _4834 = rsqrt(dot(float3(_4830, _4831, _4832), float3(_4830, _4831, _4832)));  // [sem: invLength]
          _4835 = _4830 * _4834;
          _4836 = _4831 * _4834;
          _4837 = _4832 * _4834;
          _4849 = abs(((_102 * 2.0f) * _bufferSizeAndInvSize.z) + -1.0f);
          _4850 = abs(1.0f - ((_103 * 2.0f) * _bufferSizeAndInvSize.w));
          _4853 = saturate(_4849 * _4849);  // [sem: expr_sat]
          _4854 = saturate(_4850 * _4850);  // [sem: expr_sat]
          _4868 = dot(float3((-0.0f - _4835), (-0.0f - _4836), (-0.0f - _4837)), float3(_3658, _3659, _3660));
          _4870 = saturate(dot(float3(_4835, _4836, _4837), float3(_1033, _1034, _1035)));  // [sem: expr_sat]
          _4872 = saturate(1.0f - _3678);  // [sem: expr_sat]
          _4873 = _4872 * _4872;
          _4875 = (_4873 * _4873) * _4872;
          _4891 = 1.0f - ((_3677 * _3677) * 0.9998999834060669f);
          _4898 = (max((((3.18309866997879e-05f / (_4891 * _4891)) * (0.5f / ((((_4870 * 0.9998999834060669f) + 9.999999747378752e-05f) * _4868) + (_4870 * ((_4868 * 0.9998999834060669f) + 9.999999747378752e-05f))))) * (lerp(_4875, 1.0f, 0.07999999821186066f))), 0.0f) * saturate(_4868)) + (exp2(log2(saturate(dot(float3(_1033, _1034, _1035), float3(_4835, _4836, _4837)))) * 1024.0f) * 50.0f);
  // [sem: expr_sat]
          _4903 = saturate(1.0f - (_121 * 0.0010000000474974513f)) * ((1.0f - ((_4854 * _4854) * (3.0f - (_4854 * 2.0f)))) * (1.0f - ((_4853 * _4853) * (3.0f - (_4853 * 2.0f)))));
          _4917 = _4775;
          _4918 = _4776;
          _4919 = _4777;
          _4920 = _4778;
          _4921 = _4779;
          _4922 = _4780;
          _4923 = ((((_4903 * _3661) * _4781) * _4898) + _4772);
          _4924 = ((((_4903 * _3662) * _4782) * _4898) + _4773);
          _4925 = ((((_4903 * _3663) * _4783) * _4898) + _4774);
        } else {
          _4917 = _4775;
          _4918 = _4776;
          _4919 = _4777;
      ...
      if (_3683) {
        ...
        _4475 = saturate(_121 + -7.0f);  // [sem: expr_sat]
        _4491 = (((pow(_3451, 1.2000000476837158f)) - _3451) * _4475) + _3451;
        _4492 = (((pow(_3452, 1.2000000476837158f)) - _3452) * _4475) + _3452;
        _4493 = (((pow(_3453, 1.2000000476837158f)) - _3453) * _4475) + _3453;
        _4500 = saturate(abs(dot(float3(_3658, _3659, _3660), float3(_950, _951, _952))));  // [sem: expr_sat]
  // [sem: _3__36__0__0__g_hairDualScatteringLUT_sampleLod]
        _4509 = __3__36__0__0__g_hairDualScatteringLUT.SampleLevel(__3__40__0__0__g_samplerClamp, float3(_4500, _3464, saturate(sqrt(sqrt(_3454)))), 0.0f);
  // [sem: _3__36__0__0__g_hairDualScatteringLUT_sampleLod]
        _4512 = __3__36__0__0__g_hairDualScatteringLUT.SampleLevel(__3__40__0__0__g_samplerClamp, float3(_4500, _3464, saturate(sqrt(sqrt(_3455)))), 0.0f);
  // [sem: _3__36__0__0__g_hairDualScatteringLUT_sampleLod]
        _4515 = __3__36__0__0__g_hairDualScatteringLUT.SampleLevel(__3__40__0__0__g_samplerClamp, float3(_4500, _3464, saturate(sqrt(sqrt(_3456)))), 0.0f);
        _4524 = min(0.9900000095367432f, _4509.x);  // [sem: _3__36__0__0__g_hairDualScatteringLUT_sampleLod_derived]
        _4525 = min(0.9900000095367432f, _4512.x);  // [sem: _3__36__0__0__g_hairDualScatteringLUT_sampleLod_derived]
        _4526 = min(0.9900000095367432f, _4515.x);  // [sem: _3__36__0__0__g_hairDualScatteringLUT_sampleLod_derived]
        _4527 = min(0.9900000095367432f, _4509.y);  // [sem: _3__36__0__0__g_hairDualScatteringLUT_sampleLod_derived]
        _4528 = min(0.9900000095367432f, _4512.y);  // [sem: _3__36__0__0__g_hairDualScatteringLUT_sampleLod_derived]
        _4529 = min(0.9900000095367432f, _4515.y);  // [sem: _3__36__0__0__g_hairDualScatteringLUT_sampleLod_derived]
        _4530 = _4524 * _4524;
        _4531 = _4525 * _4525;
        _4532 = _4526 * _4526;
        _4533 = _4527 * _4527;
        ...
        _4555 = _4552 * _4540;
        _4556 = _4553 * _4541;
        _4564 = min(max(_3464, 0.18000000715255737f), 0.6000000238418579f);
        _4565 = _4564 * _4564;
        _4566 = _4565 * 0.25f;
        _4567 = _4565 * 4.0f;
        _4569 = (_4525 + _4524) + _4526;
        _4570 = _4524 / _4569;
        _4571 = _4525 / _4569;
        _4572 = _4526 / _4569;
        _4573 = dot(float3(_4565, _4566, _4567), float3(_4570, _4571, _4572));
        _4574 = _4573 * _4573;
        _4578 = (asin(min(max(dot(float3(_950, _951, _952), float3(_1033, _1034, _1035)), -1.0f), 1.0f)) + asin(min(max(dot(float3(_950, _951, _952), float3(_3658, _3659, _3660)), -1.0f), 1.0f))) * 0.5f;
        _4579 = dot(float3(-0.07000000029802322f, 0.03500000014901161f, 0.14000000059604645f), float3(_4570, _4571, _4572));
        _4589 = _4579 * _4579;
        _4612 = (_4528 + _4527) + _4529;
        _4616 = dot(float3(_4565, _4566, _4567), float3((_4527 / _4612), (_4528 / _4612), (_4529 / _4612)));
        _4620 = sqrt((_4616 * _4616) + (_4574 * 2.0f));
        _4638 = (_4616 * 3.0f) + (_4573 * 2.0f);
        _4645 = (((_4536 + _4527) * ((_4530 * 0.699999988079071f) + 1.0f)) * _4620) / ((_4638 * _4536) + _4527);
        _4646 = (((_4537 + _4528) * ((_4531 * 0.699999988079071f) + 1.0f)) * _4620) / ((_4638 * _4537) + _4528);
        _4647 = (((_4538 + _4529) * ((_4532 * 0.699999988079071f) + 1.0f)) * _4620) / ((_4638 * _4538) + _4529);
        _4651 = _4578 - (((_4589 * (((_4530 * 4.0f) * _4533) + (_4551 * 2.0f))) * (1.0f - ((_4533 * 2.0f) / _4551))) / _4554);
        _4658 = _4578 - (((_4589 * (((_4531 * 4.0f) * _4534) + (_4552 * 2.0f))) * (1.0f - ((_4534 * 2.0f) / _4552))) / _4555);
        _4665 = _4578 - (((_4589 * (((_4532 * 4.0f) * _4535) + (_4553 * 2.0f))) * (1.0f - ((_4535 * 2.0f) / _4553))) / _4556);
        _4675 = ((1.0f - _948) * 2.0999999046325684f) * ((_4475 * 0.75f) + 0.25f);
        _4696 = (_948 * 0.31830987334251404f) * saturate(_3672);
        _4753 = _4491;
        _4754 = _4492;
        _4755 = _4493;
        _4756 = (((_4473 * _3661) * _4491) * ((((((_4536 * _4530) / _4554) + ((_4527 * _4530) / _4539)) * _4675) * exp2((((_4651 * _4651) * -0.5f) / ((_4645 * _4645) + _4574)) * 1.4426950216293335f)) + _4389));
        _4757 = (((_4473 * _3662) * _4492) * ((((((_4537 * _4531) / _4555) + ((_4528 * _4531) / _4540)) * _4675) * exp2((((_4658 * _4658) * -0.5f) / ((_4646 * _4646) + _4574)) * 1.4426950216293335f)) + _4390));
        _4758 = (((_4473 * _3663) * _4493) * ((((((_4538 * _4532) / _4556) + ((_4529 * _4532) / _4541)) * _4675) * exp2((((_4665 * _4665) * -0.5f) / ((_4647 * _4647) + _4574)) * 1.4426950216293335f)) + _4391));
        _4759 = (_4696 * _4491);
        _4760 = (_4696 * _4492);
        _4761 = (_4696 * _4493);
        _4762 = _4759 * _3661;
  ...
  // [sem: expr_sat]
        ...
        if (_3640) {
          if (_3505 == 97) {
            _4772 = ((_4392 * _3661) * _3451);
            _4773 = ((_4393 * _3662) * _3452);
            _4774 = ((_4394 * _3663) * _3453);
            _4775 = (_4409 * _3661);
            _4776 = (_4410 * _3662);
            _4777 = (_4411 * _3663);
            _4778 = _4389;
  ...
  // [sem: expr_sat]
            ...
            if ((uint)(_3505 + -105) < (uint)2) {
              ...
              _4921 = _4390;
              _4922 = _4391;
              _4923 = ((_4392 * _3661) * _3451);
              _4924 = ((_4393 * _3662) * _3452);
              _4925 = ((_4394 * _3663) * _3453);
            } else {
              if (!(_3646 >= 999.9000244140625f)) {
                _4727 = ((max(0.0020000000949949026f, _3646) * 0.4000000059604645f) / ((_3504 * 100.0f) + 0.10000000149011612f));
              } else {
                _4727 = 1000.0f;
              }
              _4728 = _4727 * _4727;
              _4738 = (((_3504 * 0.25f) * (0.022082746028900146f / (_4413 * _4413))) * max(0.0f, (0.30000001192092896f - _3672))) * ((exp2(_4728 * -0.48089835047721863f) * 3.0f) + exp2(_4728 * -1.4426950216293335f));
              _4753 = _3451;
              _4754 = _3452;
              _4755 = _3453;
              _4756 = _4389;
  ...
  // [sem: expr_sat]
    ...
    // RenoDX: >>> [Patch: FoliageTransmission] [Version: 1.11-family]
    // Description: RenderDiffuseTiledCS 0x8D504954 adds the branch-local AO+ foliage transmission contribution into resolved direct diffuse lighting before vanilla AWB sampling and final scene color composition.
    _4932 = _4917 + _3153 + _rndx_foliageTransR;
    _4933 = _4918 + _3154 + _rndx_foliageTransG;
    _4934 = _4919 + _3155 + _rndx_foliageTransB;
    // RenoDX: <<< [Patch: FoliageTransmission]
    _4937 = _frameNumber.x * 13;
    [branch]
    if (((((int)(_4937 + _99)) | ((int)(_4937 + _101))) & 31) == 0) {
      __3__38__0__1__g_sceneColorLightingOnlyForAwbUAV[int2(((int)(_99) >> 5), ((int)(_101) >> 5))] = float4((half)(half(_4932)), (half)(half(_4933)), (half)(half(_4934)), 1.0f);
    }
    _4952 = ((uint)(_3505 & 24) > (uint)23);
    if (_3573) {
      _4969 = saturate(exp2((_3568 * _3568) * (_121 * -0.005770780146121979f)));  // [sem: expr_sat]
    } else {
      _4969 = select((_cavityParams.z > 0.0f), select(_180, 0.0f, _1027), 1.0f);  // [sem: expr_sat]
    }
    _4984 = select(_3570, 1.0f, (select((_cavityParams.x == 0.0f), 1.0f, _4969) * select((_179 && _4952), (1.0f - _1027), 1.0f)));
    _4988 = min(60000.0f, (_4984 * (((_2864 * _2620) * _2869) - min(0.0f, (-0.0f - _4923)))));
    _4989 = min(60000.0f, (_4984 * (((_2865 * _2621) * _2869) - min(0.0f, (-0.0f - _4924)))));
    _4990 = min(60000.0f, (_4984 * (((_2866 * _2622) * _2869) - min(0.0f, (-0.0f - _4925)))));
    _4993 = 1.0f - _renderParams.x;
    _5000 = half((_renderParams.x * _3454) + _4993);
    _5001 = half((_renderParams.x * _3455) + _4993);
    _5002 = half((_renderParams.x * _3456) + _4993);
    if (_3570 && (_renderParams2.x == 0.0f)) {
      _5018 = (half)(exp2((half)((half)(log2(_5000)) * 0.5h)));
      _5019 = (half)(exp2((half)((half)(log2(_5001)) * 0.5h)));
      _5020 = (half)(exp2((half)((half)(log2(_5002)) * 0.5h)));
    } else {
      _5018 = _5000;
      _5019 = _5001;
      _5020 = _5002;
    }
    _5022 = _3604 || (_3505 == 55);
    _5023 = select(_5022, 0.0f, _3152);
    _5024 = float(_5018);
    _5025 = float(_5019);
    _5026 = float(_5020);
    if (_3542) {
      _5033 = saturate(((_5025 + _5024) + _5026) * 1.2000000476837158f);  // [sem: expr_sat]
    } else {
      _5033 = 1.0f;  // [sem: expr_sat]
    }
    _5034 = float(_5023);
    _5040 = (0.699999988079071f / min(max(max(max(_5024, _5025), _5026), 0.009999999776482582f), 0.699999988079071f)) * _5033;
    _5047 = ((_5040 * _5024) + -0.03999999910593033f) * _5034;
    _5048 = ((_5040 * _5025) + -0.03999999910593033f) * _5034;
    _5049 = ((_5040 * _5026) + -0.03999999910593033f) * _5034;
    _5050 = _5047 + 0.03999999910593033f;
    _5051 = _5048 + 0.03999999910593033f;
    _5052 = _5049 + 0.03999999910593033f;
    if (_3599 || (_3682 || (_3681 || _5022))) {
  // [sem: _3__36__0__0__g_iblBrdfLookup_sampleLod]
      _5061 = __3__36__0__0__g_iblBrdfLookup.SampleLevel(__3__40__0__0__g_samplerClamp, float2(min(0.9900000095367432f, _1041), (1.0f - max(0.019999999552965164f, float(_162)))), 0.0f);
      _5065 = _5061.x;
      _5066 = _5061.y;
    } else {
      _5065 = _2862;
    ...
    _5070 = (_5065 * _5050) + _5066;
    _5071 = (_5065 * _5051) + _5066;
    _5072 = (_5065 * _5052) + _5066;
    _5074 = (1.0f - _5065) - _5066;
    _5081 = ((0.9599999785423279f - _5047) * 0.0476190485060215f) + _5050;
    _5082 = ((0.9599999785423279f - _5048) * 0.0476190485060215f) + _5051;
    _5083 = ((0.9599999785423279f - _5049) * 0.0476190485060215f) + _5052;
    _5100 = saturate(1.0f - _3147);  // [sem: expr_sat]
    _5101 = (((_5070 * _5081) / (1.0f - (_5074 * _5081))) * _5074) * _5100;
    _5102 = (((_5071 * _5082) / (1.0f - (_5074 * _5082))) * _5074) * _5100;
    _5103 = (((_5072 * _5083) / (1.0f - (_5074 * _5083))) * _5074) * _5100;
    _5114 = float(1.0h - _5023);
    _5124 = half(((_5024 * _5114) * saturate((1.0f - _5070) - _5101)) + _5101);
    _5125 = half(((_5025 * _5114) * saturate((1.0f - _5071) - _5102)) + _5102);
    _5126 = half(((_5026 * _5114) * saturate((1.0f - _5072) - _5103)) + _5103);
    _5128 = float(_5124);
    _5129 = float(_5125);
    _5130 = float(_5126);
    if (_3505 == 65) {
      _5134 = max(9.999999974752427e-07f, _exposure2.x);
      _5142 = ((pow(_3675, 16.0f)) * 50.26548385620117f) / (((_5134 * _5134) * 1e+06f) + 1.0f);
      _5159 = (((((_5128 * _4932) * _5142) - _4932) * _991) + _4932);
      _5160 = (((((_5129 * _4933) * _5142) - _4933) * _991) + _4933);
      _5161 = (((((_5130 * _4934) * _5142) - _4934) * _991) + _4934);
    } else {
      _5159 = _4932;
      _5160 = _4933;
      _5161 = _4934;
    }
    _5166 = ((__3__36__0__0__g_caustic.SampleLevel(__0__4__0__0__g_staticBilinearClamp, float2(_109, _110), 0.0f)).x) * 0.31830987334251404f;
    _5176 = (min(65535.0f, _4920) + _3156) + (((_5166 * _3442) + _5159) * _5128);
    _5177 = (min(65535.0f, _4921) + _3157) + (((_5166 * _3443) + _5160) * _5129);
    _5178 = (min(65535.0f, _4922) + _3158) + (((_5166 * _3444) + _5161) * _5130);
    _5207 = exp2((saturate(_424) * 20.0f) + -8.0f) + -0.00390625f;
    _5208 = _5207 * select((_421 < 0.040449999272823334f), (_421 * 0.07739938050508499f), exp2(log2((_421 + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f));
    _5209 = _5207 * select((_422 < 0.040449999272823334f), (_422 * 0.07739938050508499f), exp2(log2((_422 + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f));
    _5210 = _5207 * select((_423 < 0.040449999272823334f), (_423 * 0.07739938050508499f), exp2(log2((_423 + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f));
    _5223 = ((_5208 * 0.6131200194358826f) + (_5209 * 0.3395099937915802f)) + (_5210 * 0.047370001673698425f);
    _5224 = ((_5208 * 0.07020000368356705f) + (_5209 * 0.9163600206375122f)) + (_5210 * 0.013450000435113907f);
    _5225 = ((_5208 * 0.02061999961733818f) + (_5209 * 0.10958000272512436f)) + (_5210 * 0.8697999715805054f);
    if (_350) {
      _5231 = (_5223 + _5176);
      _5232 = (_5224 + _5177);
      _5233 = (_5225 + _5178);
    ...
    _5237 = _5231 + (_4988 * _5034);
    _5238 = _5232 + (_4989 * _5034);
    _5239 = _5233 + (_4990 * _5034);
    // RenoDX: >>> [Patch: Native111InvalidLaneParity] [Version: 1.11.0]
    ...
    if (!(((_rndx_quadInvalid0 || _rndx_quadInvalid1) || _rndx_quadInvalid2) || _rndx_quadInvalid3)) {
      _5261 = ((((QuadReadLaneAt(_5237, 1) + QuadReadLaneAt(_5237, 0)) + QuadReadLaneAt(_5237, 2)) + QuadReadLaneAt(_5237, 3)) * 0.25f);
      _5262 = ((((QuadReadLaneAt(_5238, 1) + QuadReadLaneAt(_5238, 0)) + QuadReadLaneAt(_5238, 2)) + QuadReadLaneAt(_5238, 3)) * 0.25f);
      _5263 = ((((QuadReadLaneAt(_5239, 1) + QuadReadLaneAt(_5239, 0)) + QuadReadLaneAt(_5239, 2)) + QuadReadLaneAt(_5239, 3)) * 0.25f);
    } else {
      _5261 = _5237;
      _5262 = _5238;
      _5263 = _5239;
    ...
    [branch]
    if (((_101 | _99) & 1) == 0) {
      _5268 = dot(float3(_5261, _5262, _5263), float3(0.21267099678516388f, 0.7151600122451782f, 0.0721689984202385f));
      __3__38__0__1__g_diffuseHalfPrevUAV[int2(((int)(_99) >> 1), ((int)(_101) >> 1))] = float4(min(60000.0f, _5261), min(60000.0f, _5262), min(60000.0f, _5263), min(60000.0f, select((_1622 != 0), (-0.0f - _5268), _5268)));
    }
    if (_4952) {
      _5290 = ((_5023 == 0.0h) && (!(((!(_5124 == 0.0h)) && (!(_5125 == 0.0h))) && (!(_5126 == 0.0h)))));
    } else {
      _5290 = false;
    }
    if ((_4952 || ((_3505 == 96) || (_3682 || ((_3505 & -4) == 64)))) || ((_121 <= 10.0f) && _3599)) {
      __3__38__0__1__g_sceneSpecularUAV[int2(_99, _101)] = float4(((half)(-0.0h - (half)(half(min(0.0f, (-0.0f - _4988)))))), ((half)(-0.0h - (half)(half(min(0.0f, (-0.0f - _4989)))))), ((half)(-0.0h - (half)(half(min(0.0f, (-0.0f - _4990)))))), ((half)(-0.0h - (half)(half(min(0.0f, (-0.0f - _2630)))))));
      _5323 = _5231;
      _5324 = _5232;
      _5325 = _5233;
    } else {
    ...
    if (!(((uint)(_3505 + -53) < (uint)15) || (!_350))) {
      _5331 = dot(float3(_5223, _5224, _5225), float3(0.21267099678516388f, 0.7151600122451782f, 0.0721689984202385f));
      _5335 = max((max(_5331, 1.0f) / max(_5331, 0.10000000149011612f)), 0.0f);
      _5346 = ((_5323 - _5223) + (_5335 * _5223));
      _5347 = ((_5324 - _5224) + (_5335 * _5224));
      _5348 = ((_5325 - _5225) + (_5335 * _5225));
    } else {
      _5346 = _5323;
      _5347 = _5324;
      _5348 = _5325;
    }
    _5349 = min(60000.0f, _5346);
    _5350 = min(60000.0f, _5347);
    _5351 = min(60000.0f, _5348);
    // RenoDX: >>> [Patch: Native111InvalidLaneParity] [Version: 1.11.0]
    ...
    [branch]
    if (_5290) {
      _5355 = __3__38__0__1__g_sceneColorUAV[int2(_99, _101)].x;
      _5356 = __3__38__0__1__g_sceneColorUAV[int2(_99, _101)].y;
      _5357 = __3__38__0__1__g_sceneColorUAV[int2(_99, _101)].z;
      _5362 = (_5355 + _5349);
      _5363 = (_5356 + _5350);
      _5364 = (_5357 + _5351);
    } else {
    ...
    if (!(_renderParams.y == 0.0f)) {
      _5373 = dot(float3(_5362, _5363, _5364), float3(0.21267099678516388f, 0.7151600122451782f, 0.0721689984202385f));
      _5374 = min((max(0.009999999776482582f, _exposure3.w) * 4096.0f), _5373);
      _5378 = max(9.999999717180685e-10f, _5373);
      _5383 = ((_5374 * _5362) / _5378);
      _5384 = ((_5374 * _5363) / _5378);
      _5385 = ((_5374 * _5364) / _5378);
    } else {
      _5383 = _5362;
      _5384 = _5363;
      _5385 = _5364;
    ...
    // Description: RenderDiffuseTiledCS 0x8D504954 applies RenoDX foliage AO darkening to the final direct-lit scene color for foliage stencil materials, using vanilla scene AO and shadow visibility so direct light remains naturally occluded.
    ...
    __3__38__0__1__g_sceneColorUAV[int2(_99, _101)] = float4(_5383, _5384, _5385, 1.0f);
    }
    // RenoDX: <<< [Patch: Native111InvalidLaneParity]
  }
}
