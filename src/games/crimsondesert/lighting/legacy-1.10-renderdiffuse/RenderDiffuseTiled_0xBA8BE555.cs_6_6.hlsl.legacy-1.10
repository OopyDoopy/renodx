...
void main(
  ...
  if (!(((_102.x < 1.0000000116860974e-07f) || (_102.x == 1.0f)) || (_107 == 10))) {
  ...
  // [sem: expr_sat]
    ...
    // Description: RenderDiffuseTiledCS 0xBA8BE555 adds AO+ foliage transmission to the non-material-table vanilla direct-light path while leaving the sibling's broader direct-light material behavior native.
    ...
    // RenoDX: >>> [Patch: FoliageTransmission] [Version: 1.10-family]
    // Description: RenderDiffuseTiledCS 0xBA8BE555 adds the AO+ foliage transmission contribution into resolved direct diffuse lighting before vanilla AWB sampling and final scene color composition.
    ...
    // Description: RenderDiffuseTiledCS 0xBA8BE555 applies RenoDX foliage AO darkening to the final direct-lit scene color for foliage stencil materials, using vanilla blended scene AO and shadow visibility so direct light remains naturally occluded.
