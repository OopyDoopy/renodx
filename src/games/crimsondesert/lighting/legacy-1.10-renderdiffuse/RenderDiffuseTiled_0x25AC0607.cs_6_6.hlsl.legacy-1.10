...
void main(
  ...
  // [sem: _3__36__0__0__g_hairDualScatteringLUT_sampleLod]
    ...
    // Description: RenderDiffuseTiledCS 0x25AC0607 applies AO+ foliage color shaping to foliage stencil materials after vanilla resolves the direct diffuse base color, using g_sceneShadowColor visibility so shadowed foliage does not receive the fully sunlit color-shaping path.
  ...
  // [sem: _3__36__0__0__g_texNetDensity_sampleLod]
    ...
    // Description: RenderDiffuseTiledCS 0x25AC0607 initializes foliage transmission accumulators once before the preserved direct-light branch fanout; exactly one foliage branch contributes transmission before final diffuse-light add-back.
          ...
          if (_3981) {
            if ((_3672 > 0.0f) || (_3673 > 0.0f)) {
              ...
              if (!(_3506 > 0.9900000095367432f)) {
                ...
                // RenoDX: >>> [Patch: FoliageTransmission] [Version: 1.10-family]
                // Description: RenderDiffuseTiledCS 0x25AC0607 adds AO+ foliage transmission to this vanilla direct-light branch without enabling the broader material-table direct-light patches on this sibling.
  ...
  // [sem: expr_sat]
    ...
    // RenoDX: >>> [Patch: FoliageTransmission] [Version: 1.10-family]
    // Description: RenderDiffuseTiledCS 0x25AC0607 adds the branch-local AO+ foliage transmission contribution into resolved direct diffuse lighting before vanilla AWB sampling and final scene color composition.
  ...
  // [sem: _3__36__0__0__g_iblBrdfLookup_sampleLod]
    ...
    // Description: RenderDiffuseTiledCS 0x25AC0607 applies RenoDX foliage AO darkening to the final direct-lit scene color for foliage stencil materials, using vanilla scene AO and shadow visibility so direct light remains naturally occluded.
