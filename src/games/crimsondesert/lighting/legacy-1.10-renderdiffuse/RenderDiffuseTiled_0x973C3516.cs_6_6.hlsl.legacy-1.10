...
void main(
  ...
  if (!(((_111.x < 1.0000000116860974e-07f) || (_111.x == 1.0f)) || (_116 == 10))) {
  ...
  // [sem: _3__36__0__0__g_iblBrdfLookup_sampleLod]
    ...
    // Description: RenderDiffuseTiledCS 0x973C3516 is a 1.10 direct diffuse sibling that can otherwise leave foliage pixels using vanilla direct-light AO while adjacent RenderDiffuseTiled siblings receive RenoDX foliage AO. Apply the same final direct-lit AO darkening for foliage stencil materials, using vanilla blended scene AO and shadow visibility so direct light remains naturally occluded.
