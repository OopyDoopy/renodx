...
Texture2D<uint> __3__36__0__0__g_depthStencilHalf : register(t114, space36);
    ...
    while(true) {
      ...
      while(true) {
        ...
        while(true) {
          ...
          // Description: SceneAOTiled_CS 0xB4A5A1C0 native global AO strength blend can wash out foliage bent-cone visibility after the AO solve. When foliage AO is enabled, blend foliage stencil pixels back toward the unsoftened bent-cone visibility so downstream diffuse lighting receives stronger leaf and grass occlusion while non-foliage AO remains native.
          if (FOLIAGE_AO_STRENGTH > 0.0f && ((uint)(_64 - 12) < 7u)) {
