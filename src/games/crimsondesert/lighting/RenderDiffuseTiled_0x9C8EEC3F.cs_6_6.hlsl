...
void main(
  ...
  if (!(((((_107.x < 1.0000000116860974e-07f)) || ((_107.x == 1.0f)))) || ((_112 == 10)))) {
    ...
    float _2179 = (saturate((float(saturate(_1860 + (_988 * 2.0h))) * _2073) * (2000.0f - (_2162 * 1500.0f))) * (7.0f - _2173)) + _2173;
    if ((uint)((int)((uint)(_1861) + (uint)(-12))) < (uint)9) {
      _2189 = ((saturate(_116 * 0.004999999888241291f) * (_2179 + -2.0f)) + 2.0f);
    } else {
      _2189 = _2179;
    }
    half _2192 = max(0.040008545h, _988);
    ...
    if (_2302) {
      [branch]
      if (_2086) {
        _2365 = saturate((_2210 + (_2078 * 0.5f)) + min(0.5f, (_986 / (((_116 * _116) * 0.004999999888241291f) + 1.0f))));
        _2366 = _1100;
        _2367 = _1101;
        _2368 = _2297;
        _2369 = _2298;
    ...
    if (_3482) {
      ...
      _4660 = ((_4372 * ((((((_4337 * 0.10000000149011612f) + (_4332 * 0.2329999953508377f)) + (_4345 * 0.11800000071525574f)) + (_4351 * 0.11299999803304672f)) + (_4358 * 0.3580000102519989f)) + (exp2(_4330 * -0.19469568133354187f) * 0.07800000160932541f))) + _4321);
      _4661 = ((_4372 * (((((_4337 * 0.335999995470047f) + (_4332 * 0.45500001311302185f)) + (_4345 * 0.1979999989271164f)) + _4353) + (_4358 * 0.004000000189989805f))) + _4322);
      _4662 = ((_4372 * (((_4337 * 0.3440000116825104f) + (_4332 * 0.6489999890327454f)) + _4353)) + _4323);
      __defer_4320_4659 = true;
    } else {
      bool __defer_4379_4640 = false;
      if (_3595) {
        ...
        float _4392 = (pow(_3363, 1.2000000476837158f));
        float _4393 = (pow(_3364, 1.2000000476837158f));
        float _4394 = (pow(_3365, 1.2000000476837158f));
        float _4400 = saturate(abs(dot(float3(_3570, _3571, _3572), float3(_912, _913, _914))));
        float2 _4409 = __3__36__0__0__g_hairDualScatteringLUT.SampleLevel(__3__40__0__0__g_samplerClamp, float3(_4400, _3376, saturate(sqrt(sqrt(_3366)))), 0.0f);
        float2 _4412 = __3__36__0__0__g_hairDualScatteringLUT.SampleLevel(__3__40__0__0__g_samplerClamp, float3(_4400, _3376, saturate(sqrt(sqrt(_3367)))), 0.0f);
        float2 _4415 = __3__36__0__0__g_hairDualScatteringLUT.SampleLevel(__3__40__0__0__g_samplerClamp, float3(_4400, _3376, saturate(sqrt(sqrt(_3368)))), 0.0f);
        float _4424 = min(0.9900000095367432f, _4409.x);
        float _4425 = min(0.9900000095367432f, _4412.x);
        float _4426 = min(0.9900000095367432f, _4415.x);
        float _4427 = min(0.9900000095367432f, _4409.y);
        float _4428 = min(0.9900000095367432f, _4412.y);
        float _4429 = min(0.9900000095367432f, _4415.y);
        float _4430 = _4424 * _4424;
        float _4431 = _4425 * _4425;
        float _4432 = _4426 * _4426;
        float _4433 = _4427 * _4427;
        float _4434 = _4428 * _4428;
        float _4435 = _4429 * _4429;
        float _4436 = _4433 * _4427;
        float _4437 = _4434 * _4428;
        float _4438 = _4435 * _4429;
        float _4439 = 1.0f - _4430;
        float _4440 = 1.0f - _4431;
        float _4441 = 1.0f - _4432;
        float _4451 = _4439 * _4439;
        float _4452 = _4440 * _4440;
        float _4453 = _4441 * _4441;
        float _4454 = _4451 * _4439;
        float _4455 = _4452 * _4440;
        float _4456 = _4453 * _4441;
        float _4464 = min(max(_3376, 0.18000000715255737f), 0.6000000238418579f);
        float _4465 = _4464 * _4464;
        float _4466 = _4465 * 0.25f;
        float _4467 = _4465 * 4.0f;
        float _4469 = (_4425 + _4424) + _4426;
        float _4470 = _4424 / _4469;
        float _4471 = _4425 / _4469;
        float _4472 = _4426 / _4469;
        float _4473 = dot(float3(_4465, _4466, _4467), float3(_4470, _4471, _4472));
        float _4474 = _4473 * _4473;
        float _4478 = (asin(min(max(dot(float3(_912, _913, _914), float3(_996, _997, _998)), -1.0f), 1.0f)) + asin(min(max(dot(float3(_912, _913, _914), float3(_3570, _3571, _3572)), -1.0f), 1.0f))) * 0.5f;
        float _4479 = dot(float3(-0.07000000029802322f, 0.03500000014901161f, 0.14000000059604645f), float3(_4470, _4471, _4472));
        float _4489 = _4479 * _4479;
        float _4512 = (_4428 + _4427) + _4429;
        float _4516 = dot(float3(_4465, _4466, _4467), float3((_4427 / _4512), (_4428 / _4512), (_4429 / _4512)));
        float _4520 = sqrt((_4516 * _4516) + (_4474 * 2.0f));
        float _4538 = (_4516 * 3.0f) + (_4473 * 2.0f);
        float _4545 = (((_4436 + _4427) * ((_4430 * 0.699999988079071f) + 1.0f)) * _4520) / ((_4538 * _4436) + _4427);
        float _4546 = (((_4437 + _4428) * ((_4431 * 0.699999988079071f) + 1.0f)) * _4520) / ((_4538 * _4437) + _4428);
        float _4547 = (((_4438 + _4429) * ((_4432 * 0.699999988079071f) + 1.0f)) * _4520) / ((_4538 * _4438) + _4429);
        float _4551 = _4478 - (((_4489 * (((_4430 * 4.0f) * _4433) + (_4451 * 2.0f))) * (1.0f - ((_4433 * 2.0f) / _4451))) / _4454);
        float _4558 = _4478 - (((_4489 * (((_4431 * 4.0f) * _4434) + (_4452 * 2.0f))) * (1.0f - ((_4434 * 2.0f) / _4452))) / _4455);
        float _4565 = _4478 - (((_4489 * (((_4432 * 4.0f) * _4435) + (_4453 * 2.0f))) * (1.0f - ((_4435 * 2.0f) / _4453))) / _4456);
        float _4573 = (1.0f - _916) * 2.0999999046325684f;
        float _4594 = (_916 * 0.31830987334251404f) * saturate(_3584);
        _4641 = _4392;
        _4642 = _4393;
        _4643 = _4394;
        _4644 = (((_4385 * _3573) * _4392) * ((((((_4436 * _4430) / _4454) + ((_4427 * _4430) / _4439)) * _4573) * exp2((((_4551 * _4551) * -0.5f) / ((_4545 * _4545) + _4474)) * 1.4426950216293335f)) + _4301));
        _4645 = (((_4385 * _3574) * _4393) * ((((((_4437 * _4431) / _4455) + ((_4428 * _4431) / _4440)) * _4573) * exp2((((_4558 * _4558) * -0.5f) / ((_4546 * _4546) + _4474)) * 1.4426950216293335f)) + _4302));
        _4646 = (((_4385 * _3575) * _4394) * ((((((_4438 * _4432) / _4456) + ((_4429 * _4432) / _4441)) * _4573) * exp2((((_4565 * _4565) * -0.5f) / ((_4547 * _4547) + _4474)) * 1.4426950216293335f)) + _4303));
        _4647 = (_4594 * _4392);
        _4648 = (_4594 * _4393);
        _4649 = (_4594 * _4394);
        __defer_4379_4640 = true;
      } else {
        if (_3552) {
          if (_3417 == 97) {
            _4688 = ((_4304 * _3573) * _3363);
            _4689 = ((_4305 * _3574) * _3364);
            _4690 = ((_4306 * _3575) * _3365);
            _4691 = (_4321 * _3573);
            _4692 = (_4322 * _3574);
            _4693 = (_4323 * _3575);
            _4694 = _4301;
            ...
            if (((_116 < 1000.0f)) && ((_3064 == 0.0h))) {
              if (!(abs(_219) > 0.9900000095367432f)) {
                float _4707 = -0.0f - _220;
                float _4709 = rsqrt(dot(float3(_4707, 0.0f, _218), float3(_4707, 0.0f, _218)));
                _4713 = (_4709 * _4707);
                _4714 = (_4709 * _218);
              } else {
                _4713 = 1.0f;
              ...
              float _4716 = -0.0f - (_219 * _4714);
              float _4719 = (_4714 * _218) - (_4713 * _220);
              float _4720 = _4713 * _219;
              float _4722 = rsqrt(dot(float3(_4716, _4719, _4720), float3(_4716, _4719, _4720)));
              float _4728 = _viewPos.x + _389;
              float _4729 = _viewPos.z + _391;
              float4 _4734 = __3__36__0__0__g_blueNoise.SampleLevel(__0__4__0__0__g_staticBilinearWrap, float2(dot(float3(_4713, 0.0f, _4714), float3(_4728, _3151, _4729)), dot(float3((_4722 * _4716), (_4719 * _4722), (_4722 * _4720)), float3(_4728, _3151, _4729))), 0.0f);
              float _4738 = _4734.x + -0.5f;
              float _4739 = _4734.y + -0.5f;
              float _4740 = _4734.z + -0.5f;
              float _4742 = rsqrt(dot(float3(_4738, _4739, _4740), float3(_4738, _4739, _4740)));
              float _4746 = (_4738 * _4742) + _3451;
              float _4747 = (_4739 * _4742) + _3452;
              float _4748 = (_4740 * _4742) + _3453;
              float _4750 = rsqrt(dot(float3(_4746, _4747, _4748), float3(_4746, _4747, _4748)));
              float _4751 = _4746 * _4750;
              float _4752 = _4747 * _4750;
              float _4753 = _4748 * _4750;
              float _4765 = abs(((_97 * 2.0f) * _bufferSizeAndInvSize.z) + -1.0f);
              float _4766 = abs(1.0f - ((_98 * 2.0f) * _bufferSizeAndInvSize.w));
              float _4769 = saturate(_4765 * _4765);
              float _4770 = saturate(_4766 * _4766);
              float _4784 = dot(float3((-0.0f - _4751), (-0.0f - _4752), (-0.0f - _4753)), float3(_3570, _3571, _3572));
              float _4786 = saturate(dot(float3(_4751, _4752, _4753), float3(_996, _997, _998)));
              float _4788 = saturate(1.0f - _3590);
              float _4789 = _4788 * _4788;
              float _4791 = (_4789 * _4789) * _4788;
              float _4807 = 1.0f - ((_3589 * _3589) * 0.9998999834060669f);
              float _4814 = (max((((3.18309866997879e-05f / (_4807 * _4807)) * (0.5f / ((((_4786 * 0.9998999834060669f) + 9.999999747378752e-05f) * _4784) + (_4786 * ((_4784 * 0.9998999834060669f) + 9.999999747378752e-05f))))) * (lerp(_4791, 1.0f, 0.07999999821186066f))), 0.0f) * saturate(_4784)) + (exp2(log2(saturate(dot(float3(_996, _997, _998), float3(_4751, _4752, _4753)))) * 1024.0f) * 50.0f);
              float _4819 = saturate(1.0f - (_116 * 0.0010000000474974513f)) * ((1.0f - ((_4770 * _4770) * (3.0f - (_4770 * 2.0f)))) * (1.0f - ((_4769 * _4769) * (3.0f - (_4769 * 2.0f)))));
              _4833 = _4691;
              _4834 = _4692;
              _4835 = _4693;
              _4836 = _4694;
              _4837 = _4695;
              _4838 = _4696;
              _4839 = ((((_4819 * _3573) * _4697) * _4814) + _4688);
              _4840 = ((((_4819 * _3574) * _4698) * _4814) + _4689);
              _4841 = ((((_4819 * _3575) * _4699) * _4814) + _4690);
            } else {
              _4833 = _4691;
              _4834 = _4692;
              _4835 = _4693;
            ...
            if ((uint)(_3417 + -105) < (uint)2) {
              ...
              if (!(_3558 >= 999.9000244140625f)) {
                _4625 = ((max(0.0020000000949949026f, _3558) * 0.4000000059604645f) / ((_3416 * 100.0f) + 0.10000000149011612f));
              } else {
                _4625 = 1000.0f;
              }
              float _4626 = _4625 * _4625;
              float _4636 = (((_3416 * 0.25f) * (0.022082746028900146f / (_4325 * _4325))) * max(0.0f, (0.30000001192092896f - _3584))) * ((exp2(_4626 * -0.48089835047721863f) * 3.0f) + exp2(_4626 * -1.4426950216293335f));
              _4660 = (_4636 + _4321);
              _4661 = (_4636 + _4322);
              _4662 = (_4636 + _4323);
              __defer_4320_4659 = true;
      ...
      if (__defer_4379_4640) {
        _4674 = ((_4304 * _3573) * _4641);
        _4675 = ((_4305 * _3574) * _4642);
        _4676 = ((_4306 * _3575) * _4643);
        _4677 = (_4647 * _3573);
        _4678 = (_4648 * _3574);
        _4679 = (_4649 * _3575);
        _4680 = _4644;
    ...
    if (__defer_4320_4659) {
      float _4663 = _4660 * _3573;
      float _4664 = _4661 * _3574;
      float _4665 = _4662 * _3575;
      float _4667 = (_4304 * _3573) * _3363;
      float _4669 = (_4305 * _3574) * _3364;
      float _4671 = (_4306 * _3575) * _3365;
      bool __branch_chain_4659;
      if (_3417 == 97) {
        _4688 = _4667;
        _4689 = _4669;
        _4690 = _4671;
        ...
        if (_3417 == 98) {
          ...
          _4840 = _4675;
          _4841 = _4676;
          __branch_chain_4659 = false;
        }
      }
      if (__branch_chain_4659) {
        if (((_116 < 1000.0f)) && ((_3064 == 0.0h))) {
          if (!(abs(_219) > 0.9900000095367432f)) {
            float _4707 = -0.0f - _220;
            float _4709 = rsqrt(dot(float3(_4707, 0.0f, _218), float3(_4707, 0.0f, _218)));
    ...
    float _4848 = _4833 + _3065 + foliageTransR;
    float _4849 = _4834 + _3066 + foliageTransG;
    float _4850 = _4835 + _3067 + foliageTransB;
    uint _4853 = _frameNumber.x * 13;
    [branch]
    if (((((int)(_4853 + ((((uint)(((int)((uint)(_88) << 5)) & 2097120)) + SV_GroupThreadID.x) + ((uint)((_69 - (_70 << 2)) << 3))))) | ((int)(_4853 + ((((uint)(_70 << 3)) + SV_GroupThreadID.y) + ((uint)(((uint)((uint)(_88)) >> 16) << 5)))))) & 31) == 0) {
      __3__38__0__1__g_sceneColorLightingOnlyForAwbUAV[int2(((int)(((int)((((uint)(((int)((uint)(_88) << 5)) & 2097120)) + SV_GroupThreadID.x) + ((uint)((_69 - (_70 << 2)) << 3)))) >> 5)), ((int)(((int)((((uint)(_70 << 3)) + SV_GroupThreadID.y) + ((uint)(((uint)((uint)(_88)) >> 16) << 5)))) >> 5)))] = half4(half(_4848), half(_4849), half(_4850), 1.0h);
    }
    bool _4868 = ((uint)(_3417 & 24) > (uint)23);
    if (_3485) {
      _4885 = saturate(exp2((_3480 * _3480) * (_116 * -0.005770780146121979f)));
    } else {
      _4885 = select((_cavityParams.z > 0.0f), select(_175, 0.0f, _985), 1.0f);
    }
    float _4900 = select(_3482, 1.0f, (select((_cavityParams.x == 0.0f), 1.0f, _4885) * select(((_174) && (_4868)), (1.0f - _985), 1.0f)));
    float _4904 = min(60000.0f, (_4900 * (((_2776 * _2532) * _2781) - min(0.0f, (-0.0f - _4839)))));
    float _4905 = min(60000.0f, (_4900 * (((_2777 * _2533) * _2781) - min(0.0f, (-0.0f - _4840)))));
    float _4906 = min(60000.0f, (_4900 * (((_2778 * _2534) * _2781) - min(0.0f, (-0.0f - _4841)))));
    float _4909 = 1.0f - _renderParams.x;
    half _4916 = half((_renderParams.x * _3366) + _4909);
    half _4917 = half((_renderParams.x * _3367) + _4909);
    half _4918 = half((_renderParams.x * _3368) + _4909);
    if ((_3482) && ((_renderParams2.x == 0.0f))) {
      _4934 = (pow(_4916, 0.5h));
      _4935 = (pow(_4917, 0.5h));
      _4936 = (pow(_4918, 0.5h));
    } else {
      _4934 = _4916;
      _4935 = _4917;
      _4936 = _4918;
    }
    bool _4938 = (_3516) || ((_3417 == 55));
    half _4939 = select(_4938, 0.0h, _3064);
    float _4940 = float(_4934);
    float _4941 = float(_4935);
    float _4942 = float(_4936);
    if (_3454) {
      _4949 = saturate(((_4941 + _4940) + _4942) * 1.2000000476837158f);
    } else {
      _4949 = 1.0f;
    }
    float _4950 = float(_4939);
    float _4956 = (0.699999988079071f / min(max(max(max(_4940, _4941), _4942), 0.009999999776482582f), 0.699999988079071f)) * _4949;
    float _4963 = ((_4956 * _4940) + -0.03999999910593033f) * _4950;
    float _4964 = ((_4956 * _4941) + -0.03999999910593033f) * _4950;
    float _4965 = ((_4956 * _4942) + -0.03999999910593033f) * _4950;
    float _4966 = _4963 + 0.03999999910593033f;
    float _4967 = _4964 + 0.03999999910593033f;
    float _4968 = _4965 + 0.03999999910593033f;
    if ((_3511) || (((_3594) || (((_3593) || (_4938)))))) {
      float2 _4977 = __3__36__0__0__g_iblBrdfLookup.SampleLevel(__3__40__0__0__g_samplerClamp, float2(min(0.9900000095367432f, _1004), (1.0f - max(0.019999999552965164f, float(_157)))), 0.0f);
      _4981 = _4977.x;
      _4982 = _4977.y;
    } else {
      _4981 = _2774;
    ...
    float _4986 = (_4981 * _4966) + _4982;
    float _4987 = (_4981 * _4967) + _4982;
    float _4988 = (_4981 * _4968) + _4982;
    float _4990 = (1.0f - _4981) - _4982;
    float _4997 = ((0.9599999785423279f - _4963) * 0.0476190485060215f) + _4966;
    float _4998 = ((0.9599999785423279f - _4964) * 0.0476190485060215f) + _4967;
    float _4999 = ((0.9599999785423279f - _4965) * 0.0476190485060215f) + _4968;
    float _5016 = saturate(1.0f - _3059);
    float _5017 = (((_4986 * _4997) / (1.0f - (_4990 * _4997))) * _4990) * _5016;
    float _5018 = (((_4987 * _4998) / (1.0f - (_4990 * _4998))) * _4990) * _5016;
    float _5019 = (((_4988 * _4999) / (1.0f - (_4990 * _4999))) * _4990) * _5016;
    float _5030 = float(1.0h - _4939);
    half _5040 = half(((_4940 * _5030) * saturate((1.0f - _4986) - _5017)) + _5017);
    half _5041 = half(((_4941 * _5030) * saturate((1.0f - _4987) - _5018)) + _5018);
    half _5042 = half(((_4942 * _5030) * saturate((1.0f - _4988) - _5019)) + _5019);
    float _5044 = float(_5040);
    float _5045 = float(_5041);
    float _5046 = float(_5042);
    if (_3417 == 65) {
      float _5050 = max(9.999999974752427e-07f, _exposure2.x);
      float _5058 = ((pow(_3587, 16.0f)) * 50.26548385620117f) / (((_5050 * _5050) * 1e+06f) + 1.0f);
      _5075 = (((((_5044 * _4848) * _5058) - _4848) * _953) + _4848);
      _5076 = (((((_5045 * _4849) * _5058) - _4849) * _953) + _4849);
      _5077 = (((((_5046 * _4850) * _5058) - _4850) * _953) + _4850);
    } else {
      _5075 = _4848;
      _5076 = _4849;
      _5077 = _4850;
    }
    float _5080 = __3__36__0__0__g_caustic.SampleLevel(__0__4__0__0__g_staticBilinearClamp, float2(_104, _105), 0.0f);
    float _5082 = _5080.x * 0.31830987334251404f;
    float _5092 = (min(65535.0f, _4836) + _3068) + (((_5082 * _3354) + _5075) * _5044);
    float _5093 = (min(65535.0f, _4837) + _3069) + (((_5082 * _3355) + _5076) * _5045);
    float _5094 = (min(65535.0f, _4838) + _3070) + (((_5082 * _3356) + _5077) * _5046);
    float _5123 = exp2((saturate(_419) * 20.0f) + -8.0f) + -0.00390625f;
    float _5124 = _5123 * select((_416 < 0.040449999272823334f), (_416 * 0.07739938050508499f), exp2(log2((_416 + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f));
    float _5125 = _5123 * select((_417 < 0.040449999272823334f), (_417 * 0.07739938050508499f), exp2(log2((_417 + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f));
    float _5126 = _5123 * select((_418 < 0.040449999272823334f), (_418 * 0.07739938050508499f), exp2(log2((_418 + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f));
    float _5139 = ((_5124 * 0.6131200194358826f) + (_5125 * 0.3395099937915802f)) + (_5126 * 0.047370001673698425f);
    float _5140 = ((_5124 * 0.07020000368356705f) + (_5125 * 0.9163600206375122f)) + (_5126 * 0.013450000435113907f);
    float _5141 = ((_5124 * 0.02061999961733818f) + (_5125 * 0.10958000272512436f)) + (_5126 * 0.8697999715805054f);
    if (_345) {
      _5147 = (_5139 + _5092);
      _5148 = (_5140 + _5093);
      _5149 = (_5141 + _5094);
    ...
    float _5153 = _5147 + (_4904 * _4950);
    float _5154 = _5148 + (_4905 * _4950);
    float _5155 = _5149 + (_4906 * _4950);
    float _5177 = (((QuadReadLaneAt(_5153,1) + QuadReadLaneAt(_5153,0)) + QuadReadLaneAt(_5153,2)) + QuadReadLaneAt(_5153,3)) * 0.25f;
    float _5178 = (((QuadReadLaneAt(_5154,1) + QuadReadLaneAt(_5154,0)) + QuadReadLaneAt(_5154,2)) + QuadReadLaneAt(_5154,3)) * 0.25f;
    float _5179 = (((QuadReadLaneAt(_5155,1) + QuadReadLaneAt(_5155,0)) + QuadReadLaneAt(_5155,2)) + QuadReadLaneAt(_5155,3)) * 0.25f;
    [branch]
    if (((((int)((((uint)(_70 << 3)) + SV_GroupThreadID.y) + ((uint)(((uint)((uint)(_88)) >> 16) << 5)))) | ((int)((((uint)(((int)((uint)(_88) << 5)) & 2097120)) + SV_GroupThreadID.x) + ((uint)((_69 - (_70 << 2)) << 3))))) & 1) == 0) {
      float _5184 = dot(float3(_5177, _5178, _5179), float3(0.21267099678516388f, 0.7151600122451782f, 0.0721689984202385f));
      __3__38__0__1__g_diffuseHalfPrevUAV[int2(((int)(((int)((((uint)(((int)((uint)(_88) << 5)) & 2097120)) + SV_GroupThreadID.x) + ((uint)((_69 - (_70 << 2)) << 3)))) >> 1)), ((int)(((int)((((uint)(_70 << 3)) + SV_GroupThreadID.y) + ((uint)(((uint)((uint)(_88)) >> 16) << 5)))) >> 1)))] = float4(min(60000.0f, _5177), min(60000.0f, _5178), min(60000.0f, _5179), min(60000.0f, select((_1585 != 0), (-0.0f - _5184), _5184)));
    }
    if (_4868) {
      _5206 = (((_4939 == 0.0h)) && ((!(((((!(_5040 == 0.0h))) && ((!(_5041 == 0.0h))))) && ((!(_5042 == 0.0h)))))));
    } else {
      _5206 = false;
    }
    if ((((_4868) || ((((_3417 == 96)) || (((_3594) || (((_3417 & -4) == 64)))))))) || ((((_116 <= 10.0f)) && (_3511)))) {
      __3__38__0__1__g_sceneSpecularUAV[int2(((int)((((uint)(((int)((uint)(_88) << 5)) & 2097120)) + SV_GroupThreadID.x) + ((uint)((_69 - (_70 << 2)) << 3)))), ((int)((((uint)(_70 << 3)) + SV_GroupThreadID.y) + ((uint)(((uint)((uint)(_88)) >> 16) << 5)))))] = half4((-0.0h - half(min(0.0f, (-0.0f - _4904)))), (-0.0h - half(min(0.0f, (-0.0f - _4905)))), (-0.0h - half(min(0.0f, (-0.0f - _4906)))), (-0.0h - half(min(0.0f, (-0.0f - _2542)))));
      _5239 = _5147;
      _5240 = _5148;
      _5241 = _5149;
    } else {
    ...
    if (!((((uint)(_3417 + -53) < (uint)15)) || ((!_345)))) {
      float _5247 = dot(float3(_5139, _5140, _5141), float3(0.21267099678516388f, 0.7151600122451782f, 0.0721689984202385f));
      float _5251 = max((max(_5247, 1.0f) / max(_5247, 0.10000000149011612f)), 0.0f);
      _5262 = ((_5239 - _5139) + (_5251 * _5139));
      _5263 = ((_5240 - _5140) + (_5251 * _5140));
      _5264 = ((_5241 - _5141) + (_5251 * _5141));
    } else {
      _5262 = _5239;
      _5263 = _5240;
      _5264 = _5241;
    }
    float _5265 = min(60000.0f, _5262);
    float _5266 = min(60000.0f, _5263);
    float _5267 = min(60000.0f, _5264);
    [branch]
    if (_5206) {
      float4 _5270 = __3__38__0__1__g_sceneColorUAV.Load(int2(((int)((((uint)(((int)((uint)(_88) << 5)) & 2097120)) + SV_GroupThreadID.x) + ((uint)((_69 - (_70 << 2)) << 3)))), ((int)((((uint)(_70 << 3)) + SV_GroupThreadID.y) + ((uint)(((uint)((uint)(_88)) >> 16) << 5))))));
      _5278 = (_5270.x + _5265);
      _5279 = (_5270.y + _5266);
      _5280 = (_5270.z + _5267);
    } else {
    ...
    if (!(_renderParams.y == 0.0f)) {
      float _5289 = dot(float3(_5278, _5279, _5280), float3(0.21267099678516388f, 0.7151600122451782f, 0.0721689984202385f));
      float _5290 = min((max(0.009999999776482582f, _exposure3.w) * 4096.0f), _5289);
      float _5294 = max(9.999999717180685e-10f, _5289);
      _5299 = ((_5290 * _5278) / _5294);
      _5300 = ((_5290 * _5279) / _5294);
      _5301 = ((_5290 * _5280) / _5294);
    } else {
      _5299 = _5278;
      _5300 = _5279;
      _5301 = _5280;
    }
    __3__38__0__1__g_sceneColorUAV[int2(((int)((((uint)(((int)((uint)(_88) << 5)) & 2097120)) + SV_GroupThreadID.x) + ((uint)((_69 - (_70 << 2)) << 3)))), ((int)((((uint)(_70 << 3)) + SV_GroupThreadID.y) + ((uint)(((uint)((uint)(_88)) >> 16) << 5)))))] = float4(_5299, _5300, _5301, 1.0f);
  }
}