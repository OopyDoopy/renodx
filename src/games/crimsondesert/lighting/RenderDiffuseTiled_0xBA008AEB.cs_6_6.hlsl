...
void main(
  ...
  // [sem: expr_sat]
    ...
    // Description: RenderDiffuseTiledCS 0xBA008AEB adds AO+ foliage transmission to the non-material-table vanilla direct-light path while leaving the sibling's broader direct-light material behavior native.
    ...
    // RenoDX: >>> [Patch: FoliageTransmission] [Version: 1.11-family]
    // Description: RenderDiffuseTiledCS 0xBA008AEB adds the AO+ foliage transmission contribution into resolved direct diffuse lighting before vanilla AWB sampling and final scene color composition.
    ...
    // Description: RenderDiffuseTiledCS 0xBA008AEB applies RenoDX foliage AO darkening to the final direct-lit scene color for foliage stencil materials, using vanilla blended scene AO and shadow visibility so direct light remains naturally occluded.
