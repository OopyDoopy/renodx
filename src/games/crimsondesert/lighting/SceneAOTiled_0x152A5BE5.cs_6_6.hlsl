  ...
  if (((_59 < 1.0000000116860974e-07f)) || (_93)) {
    ...
    while(true) {
      ...
      while(true) {
        ...
        // Description: SceneAOTiled_CS 0x152A5BE5 native global AO strength blend can wash out foliage bent-cone visibility after the AO solve. When foliage AO is enabled, blend foliage stencil pixels back toward the unsoftened bent-cone visibility so downstream diffuse lighting receives stronger leaf and grass occlusion while non-foliage AO remains native.
        if (FOLIAGE_AO_STRENGTH > 0.0f && ((uint)(_60 - 12) < 7u)) {
