...
Texture3D<float2> __3__36__0__0__g_hairDualScatteringLUT : register(t213, space36);
  ...
  if (!(((bool)((bool)(_108.x < 1.0000000116860974e-07f) || (bool)(_108.x == 1.0f))) || (bool)(_113 == 10))) {
    ...
    if (DAWN_DUSK_IMPROVEMENTS == 1.f) {
      ...
      float3 _corrected = WeatherDirectLightCorrection(
        float3(_3397, _3398, _3399), _ddFactorLight);
      _3397 = _corrected.x;
      _3398 = _corrected.y;
      _3399 = _corrected.z;
    }
    ...
    {
      bool _purk_isMoon = !_3155 && (_sunDirection.y <= _moonDirection.y);
      float3 _purk_light = ApplyPurkinjeShift(
        float3(_3397, _3398, _3399), _sunDirection.y, _purk_isMoon);
      _3397 = _purk_light.x;
      _3398 = _purk_light.y;
      _3399 = _purk_light.z;
    }
