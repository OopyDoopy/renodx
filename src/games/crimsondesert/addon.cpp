...
renodx::utils::settings::Settings settings = {
    new renodx::utils::settings::Setting{
        ...
        .can_reset = false,
        .label = "Settings Mode",
        .labels = {"Basic", "Color Grading", "Graphics"},
        .is_global = true,
    },
    ...
    new renodx::utils::settings::Setting{
        ...
        .binding = &shader_injection.custom_flags,
        .value_type = renodx::utils::settings::SettingValueType::INTEGER,
        .default_value = MICRO_SHADOW_QUALITY_HIGH,
        .packed_values = {0u, CUSTOM_FLAGS__MICRO_SHADOW_QUALITY_BIT1, CUSTOM_FLAGS__MICRO_SHADOW_QUALITY_BIT0, CUSTOM_FLAGS__MICRO_SHADOW_QUALITY_BIT0 | CUSTOM_FLAGS__MICRO_SHADOW_QUALITY_BIT1},
        .can_reset = true,
        .label = "Contact Micro Shadows (WIP)",
        .section = "Rendering",
        .tooltip = "Controls contact micro shadow detail.\n"
                   "Off = stock 1.8 contact shadows.\n"
                   "Legacy = old stronger reach/start/accumulation tuning without extra helper/march/fade paths.\n"
                   "Medium = balanced contact micro shadow tuning.\n"
                   "High = stronger corrected 1.7-style contact shadow tuning.",
        .labels = {"Off", "Legacy", "Medium", "High"},
        .tint = rendering,
        .is_enabled = []() { return RR_ENABLED; },
        .is_visible = []() { return current_settings_mode == rendering_group; },
    },
