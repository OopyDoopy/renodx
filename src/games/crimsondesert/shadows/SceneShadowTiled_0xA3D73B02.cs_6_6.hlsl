      ...
      if (_112 < 8.0f) {
        ...
        while(true) {
          ...
          if (_2552 > 0.949999988079071f) {
            ...
            int _2579 = _2441 + 1;
            if ((uint)_2579 < ((_rndx_contact_shadow_quality > 0.5f) ? (uint)60 : (uint)8)) {
              _2435 = _2551;
              _2436 = _2574;
              _2437 = _2575;
              _2438 = _2576;
        ...
        // RenoDX: scale step sizes so 60 steps cover same distance as vanilla 8
        if (_rndx_contact_shadow_quality > 0.5f) { _2690 *= (8.0f / 60.0f); _2692 *= (8.0f / 60.0f); _2693 *= (8.0f / 60.0f); }
        ...
        while(true) {
              ...
              if (!(((int)((uint)_2732 < (uint)16)) | ((int)(_2732 == 17)))) {
                if (!(_2732 == 16)) {
                  if (!(((int)(_2732 == 18)) | (((int)(((int)(_2732 == 107)) | ((int)((uint)(_2732 + -19) < (uint)2))))))) {
                    ...
                    _2810 = 0.4000000059604645f;
                  }
                } else {
                  _2810 = 0.10000000149011612f;
                }
              } else {
                _2810 = 0.30000001192092896f;
              }
            } else {
              if (!(_2732 == 11)) {
                _2810 = 0.0f;
          ...
          if (_2826 > 0.949999988079071f) {
            ...
            if ((uint)_2709 < ((_rndx_contact_shadow_quality > 0.5f) ? (uint)59 : (uint)7)) {
              _2848 = (_2711 + _2734);
            ...
            int _2853 = _2709 + 1;
            if ((uint)_2853 < ((_rndx_contact_shadow_quality > 0.5f) ? (uint)60 : (uint)8)) {
              _2709 = _2853;
              _2710 = _2734;
              _2711 = _2848;
              _2712 = _2849;
