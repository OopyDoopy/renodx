...
void main(
  ...
  if ((_79 < 1.0000000116860974e-07f) || _107) {
    ...
    if (_2284 > 0.0f) {
      ...
      // Description: SceneShadowTiledCS 0xA5C85C1A uses this native contact ray direction on Lighting High/Ultra Sun/Moon RT lanes; stable direction keeps Contact Micro Shadows from inheriting per-frame random cone wobble when the feature is enabled.
      ...
      // RenoDX: >>> [Patch: ContactMicroShadowsFamily] [Version: 1.10]
      // Description: SceneShadowTiledCS 0xA5C85C1A raises native RT contact-ray samples only while Contact Micro Shadows is enabled, preserving the vanilla sample count when Off.
      ...
      // RenoDX: >>> [Patch: ContactMicroShadowsFamily] [Version: 1.10]
      // Description: SceneShadowTiledCS 0xA5C85C1A extends RT contact reach gradually with Contact Micro Shadows quality; Off evaluates to the vanilla reach.
      ...
      if (_2296 || ((_80 != 15) && ((uint)(_80 + -12) < (uint)7))) {
        // RenoDX: >>> [Patch: ContactMicroShadowsFamily] [Version: 1.10]
        // Description: SceneShadowTiledCS 0xA5C85C1A moves the native RT contact start closer only while Contact Micro Shadows is enabled, preserving vanilla start distance when Off.
        _2621 = (_2608 * lerp(10.0f, CONTACT_SHADOW_RT_START_TARGET, CONTACT_SHADOW_RT_TUNING));
        // RenoDX: <<< [Patch: ContactMicroShadowsFamily]
      } else {
        if (_80 == 15) {
          // RenoDX: >>> [Patch: ContactMicroShadowsFamily] [Version: 1.10]
          // Description: SceneShadowTiledCS 0xA5C85C1A applies the same Contact Micro Shadows RT start-distance blend to the depth-faded material branch.
  ...
  // [sem: _3__36__0__0__g_depthStencil_load]
        ...
        if (!(_2883 == 0)) {
          ...
          if (_172) {
            _2918 = saturate((-0.0f - _2838) / (_2808 * 0.004654859658330679f));  // [sem: expr_sat]
          } else {
            _2918 = 1.0f;  // [sem: expr_sat]
          }
          _2925 = _2828;
          // RenoDX: >>> [Patch: ContactMicroShadowsFamily] [Version: 1.10]
          // Description: SceneShadowTiledCS 0xA5C85C1A boosts native RT contact accumulation with Contact Micro Shadows quality so the helper and native RT contact terms share the same strength curve.
          float _rndxMicroFarAccum = (saturate(1.0f - ((_2907 * _2907) * _2902)) * (1.0f - _2813)) * _2918;
          _2926 = saturate((_rndxMicroFarAccum * lerp(1.0f, CONTACT_SHADOW_RT_ACCUM_STRENGTH, CONTACT_SHADOW_RT_TUNING)) + _2813);  // [sem: expr_sat]
          // RenoDX: <<< [Patch: ContactMicroShadowsFamily]
        } else {
          _2925 = _2811;
          _2926 = _2813;  // [sem: expr_sat]
        }
        [branch]
        if (_2926 > 0.949999988079071f) {
          if (!_2829) {
            _2957 = (saturate(_2812 / (_2812 - _2831)) - min(_2808, _2830));
          } else {
            _2957 = 0.0f;
          }
          _2966 = ((_2957 * _2786) + _2805);
          _2967 = ((_2957 * _2788) + _2806);
          _2968 = ((_2957 * _2789) + _2807);
          _2969 = _2827;
          _2970 = _2828;
        } else {
          if ((uint)_2810 < (uint)(_2410 + -1)) {
            _2949 = ((_2830 * _2786) + _2805);
            _2950 = ((_2830 * _2788) + _2806);
            _2951 = ((_2830 * _2789) + _2807);
            _2952 = (_2830 + _2808);
            _2953 = min(abs(_2789), _2831);
          } else {
            _2949 = _2805;
            _2950 = _2806;
            _2951 = _2807;
        ...
        _2974 = (_2926 > 0.0f);
        if (_2968 > 0.0f) {
          if (_2974 || (((_2966 >= 0.0f) && (_2966 <= 1.0f)) && ((_2967 >= 0.0f) && (_2967 <= 1.0f)))) {
            _2988 = (_2966 * 2.0f) + -1.0f;
            _2989 = 1.0f - (_2967 * 2.0f);
            _3025 = mad((_invViewProjRelative[2].w), _2968, mad((_invViewProjRelative[1].w), _2989, ((_invViewProjRelative[0].w) * _2988))) + (_invViewProjRelative[3].w);
            if (!(_2970 == 2)) {
              if (_2970 == 3) {
                _3049 = 0.0f;
                _3051 = _3049;
            ...
            if (!(_170 || (!(_2926 == 1.0f)))) {
  // [sem: expr_sat]
              _3075 = saturate(((((_2430 * 0.9375f) - max(0.0f, dot(float3(_2401, _2405, _2409), float3((((mad((_invViewProjRelative[2].x), _2968, mad((_invViewProjRelative[1].x), _2989, ((_invViewProjRelative[0].x) * _2988))) + (_invViewProjRelative[3].x)) / _3025) - _2658), (((mad((_invViewProjRelative[2].y), _2968, mad((_invViewProjRelative[1].y), _2989, ((_invViewProjRelative[0].y) * _2988))) + (_invViewProjRelative[3].y)) / _3025) - _2659), (((mad((_invViewProjRelative[2].z), _2968, mad((_invViewProjRelative[1].z), _2989, ((_invViewProjRelative[0].z) * _2988))) + (_invViewProjRelative[3].z)) / _3025) - _2660))))) * ((_115 * 0.015625f) + 1.5f)) / _2430) * 0.9375f);
            } else {
              _3075 = _2926;  // [sem: expr_sat]
            }
            _3076 = _3075 * saturate(exp2(min(0.0f, (((_115 * 0.018666666001081467f) + 0.13333334028720856f) + (_3051 * ((_nearFarProj.x / max(1.0000000116860974e-07f, _2969)) - (_nearFarProj.x / max(1.0000000116860974e-07f, _2968)))))) * 1.4426950216293335f));
            _3077 = _2970 & -2;
            if (!(_3077 == 6)) {
              if ((((_80 == 33) && (_2970 == 33)) || (!(_80 == 33) && ((_80 == 55) && (_2970 == 55))))) {
                _3154 = (_3076 * 0.009999999776482582f);
              } else {
                if (!((_2970 == 54) || (_3077 == 66)) || (((_2970 == 54) || (_3077 == 66)) && (!((_2294 == 66) || (_80 == 54))))) {
                  if (!_172) {
                    if ((uint)((int)(_2970 + (uint)(-53))) < (uint)15) {
                      _3151 = saturate(_115 * 0.03125f);  // [sem: expr_sat]
                    } else {
                      _3151 = 1.0f;  // [sem: expr_sat]
                    }
                    _3154 = (_3151 * _3076);
                  } else {
                    _3154 = _3076;
  ...
  // [sem: _3__36__0__0__g_baseColor_load]
                  _3106 = __3__36__0__0__g_baseColor.Load(int3(int(_bufferSizeAndInvSize.x * _2966), int(_bufferSizeAndInvSize.y * _2967), 0));
                  _3112 = ((float)((uint)((uint)(((uint)((uint)(_3106.x)) >> 8) & 255)))) * 0.003921568859368563f;
                  _3115 = ((float)((uint)((uint)(_3106.x & 255)))) * 0.003921568859368563f;
                  _3119 = ((float)((uint)((uint)(((uint)((uint)(_3106.y)) >> 8) & 255)))) * 0.003921568859368563f;
                  _3120 = _3112 * _3112;
                  _3121 = _3115 * _3115;
                  _3122 = _3119 * _3119;
                  _3154 = (saturate(1.0f - (dot(float3((((_3120 * 0.6131200194358826f) + (_3121 * 0.3395099937915802f)) + (_3122 * 0.047370001673698425f)), (((_3120 * 0.07020000368356705f) + (_3121 * 0.9163600206375122f)) + (_3122 * 0.013450000435113907f)), (((_3120 * 0.02061999961733818f) + (_3121 * 0.10958000272512436f)) + (_3122 * 0.8697999715805054f))), float3(0.21267099678516388f, 0.7151600122451782f, 0.0721689984202385f)) * 0.875f)) * _3076);
                }
              }
            } else {
              _3154 = (_3076 * 0.009999999776482582f);
  ...
  // [sem: _3__36__0__0__g_baseColor_load]
        ...
        _3158 = saturate(1.0f - _3154);  // [sem: expr_sat]
        break;
      }
    } else {
      _3158 = 1.0f;  // [sem: expr_sat]
    }
    // RenoDX: >>> [Patch: ContactMicroShadowsFamily] [Version: 1.10]
    // Description: SceneShadowTiledCS 0xA5C85C1A fills sub-pixel occluders in the Lighting High/Ultra Sun/Moon RT shadow sibling, then applies the existing RT final-strength blend and edge fade.
    float _rndxMicroBaseContact = _3158;
    _3158 = ApplyContactMicroDetailShadow(
        _3158,
        float2(_60, _61),
        _115,
        _76,
    ...
    if (CONTACT_SHADOW_RT_TUNING > 0.f) {
      float _rndxMicroWithHelper = _3158;
      ...
      if (CONTACT_SHADOW_DETAIL_PATH == 1.f && _rndxMicroHelperBoosted < _rndxMicroBaseBoosted) {
        ...
        _3158 = lerp(_rndxMicroBaseBoosted, _rndxMicroHelperBoosted, _rndxMicroEdgeFade);
      } else {
        _3158 = _rndxMicroHelperBoosted;
      }
    }
    // RenoDX: <<< [Patch: ContactMicroShadowsFamily]
    _3159 = min(_2284, _3158);
    _3173 = float(half(_3159 * float(_2260)));
    _3174 = float(half(_3159 * float(_2261)));
    _3175 = float(half(_3159 * float(_2262)));
  // [sem: expr_sat]
    _3176 = saturate((1.0f - _556) + (exp2(log2(saturate(select(_172, (_2269 + 0.9800000190734863f), _2269))) * 0.45454543828964233f) * _556));
  }
  __3__38__0__1__g_shadowColorResultUAV[int2(_58, _59)] = float4((half)(half(_3173)), (half)(half(_3174)), (half)(half(_3175)), (half)(half(_3176)));
}
