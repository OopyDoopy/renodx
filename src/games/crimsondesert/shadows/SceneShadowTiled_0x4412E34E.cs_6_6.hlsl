...
void main(
  ...
  // [sem: _3__36__0__0__g_dynamicShadowColorArray_sampleLod]
    ...
    if (_1272 > 0.0f) {
      ...
      // Description: SceneShadowTiledCS 0x4412E34E uses this native contact ray direction on Lighting High RT-off lanes; stable direction keeps Contact Micro Shadows from inheriting per-frame random cone wobble when the feature is enabled.
      ...
      // RenoDX: >>> [Patch: ContactMicroShadowsFamily] [Version: 1.10]
      // Description: SceneShadowTiledCS 0x4412E34E raises native contact-ray samples only while Contact Micro Shadows is enabled, preserving the vanilla sample count when Off.
      ...
      // RenoDX: >>> [Patch: ContactMicroShadowsFamily] [Version: 1.10]
      // Description: SceneShadowTiledCS 0x4412E34E extends the native non-RT contact reach gradually with the Contact Micro Shadows quality value; Off evaluates to the vanilla reach.
      ...
      if (_1284 || ((_78 != 15) && ((uint)(_78 + -12) < (uint)7))) {
        // RenoDX: >>> [Patch: ContactMicroShadowsFamily] [Version: 1.10]
        // Description: SceneShadowTiledCS 0x4412E34E moves the native contact start closer only while Contact Micro Shadows is enabled, preserving vanilla start distance when Off.
        _1472 = (_1459 * lerp(10.0f, 2.0f, CONTACT_SHADOW_START_BLEND));
        // RenoDX: <<< [Patch: ContactMicroShadowsFamily]
      } else {
        if (_78 == 15) {
          // RenoDX: >>> [Patch: ContactMicroShadowsFamily] [Version: 1.10]
          // Description: SceneShadowTiledCS 0x4412E34E applies the same Contact Micro Shadows start-distance blend to the depth-faded material branch.
  ...
  // [sem: _3__36__0__0__g_depthStencil_load]
        ...
        if (!(_1732 == 0)) {
          ...
          _1766 = _1677;
          // RenoDX: >>> [Patch: ContactMicroShadowsFamily] [Version: 1.10]
          // Description: SceneShadowTiledCS 0x4412E34E softens native contact accumulation with Contact Micro Shadows tuning so the added detail blends with the shipped non-RT contact result.
          float _rndxMicroFarAccum = saturate(1.0f - ((_1756 * _1756) * _1751)) * (1.0f - _1662);
          _1767 = saturate((_rndxMicroFarAccum * lerp(1.0f, 0.7f, CONTACT_SHADOW_BASE_TUNING)) + _1662);  // [sem: expr_sat]
          // RenoDX: <<< [Patch: ContactMicroShadowsFamily]
        } else {
          _1766 = _1660;
          _1767 = _1662;  // [sem: expr_sat]
        }
        [branch]
        if (_1767 > 0.949999988079071f) {
          if (!_1678) {
            _1798 = (saturate(_1661 / (_1661 - _1680)) - min(_1657, _1679));
          } else {
            _1798 = 0.0f;
          }
          _1807 = ((_1798 * _1635) + _1654);
          _1808 = ((_1798 * _1637) + _1655);
          _1809 = ((_1798 * _1638) + _1656);
          _1810 = _1676;
          _1811 = _1677;
        } else {
          if ((uint)_1659 < (uint)(_1396 + -1)) {
            _1790 = ((_1679 * _1635) + _1654);
            _1791 = ((_1679 * _1637) + _1655);
            _1792 = ((_1679 * _1638) + _1656);
            _1793 = (_1679 + _1657);
            _1794 = min(abs(_1638), _1680);
          } else {
            _1790 = _1654;
            _1791 = _1655;
            _1792 = _1656;
        ...
        _1815 = (_1767 > 0.0f);
        if (_1809 > 0.0f) {
          if (_1815 || (((_1807 >= 0.0f) && (_1807 <= 1.0f)) && ((_1808 >= 0.0f) && (_1808 <= 1.0f)))) {
            _1829 = (_1807 * 2.0f) + -1.0f;
            _1830 = 1.0f - (_1808 * 2.0f);
            _1846 = mad((_invViewProjRelative[2].w), _1809, mad((_invViewProjRelative[1].w), _1830, (_1829 * (_invViewProjRelative[0].w)))) + (_invViewProjRelative[3].w);
            if (!(_1811 == 2)) {
              if (_1811 == 3) {
                _1870 = 0.0f;
                _1872 = _1870;
            ...
            if (!(_168 || (!(_1767 == 1.0f)))) {
  // [sem: expr_sat]
              _1896 = saturate(((((_1416 * 0.9375f) - max(0.0f, dot(float3(_1387, _1391, _1395), float3((((mad((_invViewProjRelative[2].x), _1809, mad((_invViewProjRelative[1].x), _1830, (_1829 * (_invViewProjRelative[0].x)))) + (_invViewProjRelative[3].x)) / _1846) - _1509), (((mad((_invViewProjRelative[2].y), _1809, mad((_invViewProjRelative[1].y), _1830, (_1829 * (_invViewProjRelative[0].y)))) + (_invViewProjRelative[3].y)) / _1846) - _1510), (((mad((_invViewProjRelative[2].z), _1809, mad((_invViewProjRelative[1].z), _1830, (_1829 * (_invViewProjRelative[0].z)))) + (_invViewProjRelative[3].z)) / _1846) - _1511))))) * ((_113 * 0.015625f) + 1.5f)) / _1416) * 0.9375f);
            } else {
              _1896 = _1767;  // [sem: expr_sat]
            }
            _1897 = _1896 * saturate(exp2(min(0.0f, (((_113 * 0.018666666001081467f) + 0.13333334028720856f) + (_1872 * ((_nearFarProj.x / max(1.0000000116860974e-07f, _1810)) - (_nearFarProj.x / max(1.0000000116860974e-07f, _1809)))))) * 1.4426950216293335f));
            _1898 = _1811 & -2;
            if (!(_1898 == 6)) {
              if ((((_78 == 33) && (_1811 == 33)) || (!(_78 == 33) && ((_78 == 55) && (_1811 == 55))))) {
                _1972 = (_1897 * 0.009999999776482582f);
              } else {
                if (!((_1811 == 54) || (_1898 == 66)) || (((_1811 == 54) || (_1898 == 66)) && (!((_1282 == 66) || (_78 == 54))))) {
                  if (!_170) {
                    if ((uint)((int)(_1811 + (uint)(-53))) < (uint)15) {
                      _1969 = saturate(_113 * 0.03125f);  // [sem: expr_sat]
                    } else {
                      _1969 = 1.0f;  // [sem: expr_sat]
                    }
                    _1972 = (_1969 * _1897);
                  } else {
                    _1972 = _1897;
  ...
  // [sem: _3__36__0__0__g_baseColor_load]
                  _1924 = __3__36__0__0__g_baseColor.Load(int3(int(_1807 * _bufferSizeAndInvSize.x), int(_1808 * _bufferSizeAndInvSize.y), 0));
                  _1930 = ((float)((uint)((uint)(((uint)((uint)(_1924.x)) >> 8) & 255)))) * 0.003921568859368563f;
                  _1933 = ((float)((uint)((uint)(_1924.x & 255)))) * 0.003921568859368563f;
                  _1937 = ((float)((uint)((uint)(((uint)((uint)(_1924.y)) >> 8) & 255)))) * 0.003921568859368563f;
                  _1938 = _1930 * _1930;
                  _1939 = _1933 * _1933;
                  _1940 = _1937 * _1937;
                  _1972 = (saturate(1.0f - (dot(float3((((_1938 * 0.6131200194358826f) + (_1939 * 0.3395099937915802f)) + (_1940 * 0.047370001673698425f)), (((_1938 * 0.07020000368356705f) + (_1939 * 0.9163600206375122f)) + (_1940 * 0.013450000435113907f)), (((_1938 * 0.02061999961733818f) + (_1939 * 0.10958000272512436f)) + (_1940 * 0.8697999715805054f))), float3(0.21267099678516388f, 0.7151600122451782f, 0.0721689984202385f)) * 0.875f)) * _1897);
                }
              }
            } else {
              _1972 = (_1897 * 0.009999999776482582f);
  ...
  // [sem: _3__36__0__0__g_baseColor_load]
        ...
        _1976 = saturate(1.0f - _1972);  // [sem: expr_sat]
        break;
      }
    } else {
      _1976 = 1.0f;  // [sem: expr_sat]
    }
    // RenoDX: >>> [Patch: ContactMicroShadowsFamily] [Version: 1.10]
    // Description: SceneShadowTiledCS 0x4412E34E fills sub-pixel occluders in the Lighting High RT-off shadow sibling, then fades the helper near screen edges to avoid bright edge artifacts.
    _1976 = ApplyContactMicroDetailShadow(
        _1976,
        float2(_58, _59),
        _113,
        _74,
        ...
        1.0f,
        1.0f);
    if (CONTACT_SHADOW_DETAIL_PATH == 1.f && _1976 < 1.0f) {
      ...
      _1976 = lerp(lerp(1.0f, _1976, 0.5f), _1976, _rndxMicroEdgeFade);
    }
    // RenoDX: <<< [Patch: ContactMicroShadowsFamily]
    _1977 = min(_1272, _1976);
    _1991 = float(half(_1977 * float(_1248)));
    _1992 = float(half(_1977 * float(_1249)));
    _1993 = float(half(_1977 * float(_1250)));
  // [sem: expr_sat]
    _1994 = saturate((1.0f - _554) + (exp2(log2(saturate(select(_170, (_1257 + 0.9800000190734863f), _1257))) * 0.45454543828964233f) * _554));
  }
  __3__38__0__1__g_shadowColorResultUAV[int2(_56, _57)] = float4((half)(half(_1991)), (half)(half(_1992)), (half)(half(_1993)), (half)(half(_1994)));
}
