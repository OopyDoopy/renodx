...
void main(
  ...
  if (((_79 < 1.0000000116860974e-07f)) || (_107)) {
    ...
    if (_5260 > 0.0f) {
      ...
      if (_115 < 8.0f) {
        ...
        while(true) {
          ...
          uint _5799 = __3__36__0__0__g_depthStencil.Load(int3(int(SHADOW_CONTACT_SAMPLE_X(_5783, _5780) * _bufferSizeAndInvSize.x), int(_5784 * _bufferSizeAndInvSize.y), 0));
          ...
          if (!(_5860 == 0)) {
            ...
            if (_172) {
              _5895 = saturate((-0.0f - _5815) / (_5786 * 0.004654859658330679f));
            } else {
              _5895 = 1.0f;
            }
            _5902 = _5805;
            float _microNearAccum = (saturate(1.0f - ((_5884 * _5884) * _5879)) * (1.0f - _5790)) * _5895;
            _5903 = saturate((_microNearAccum * lerp(1.0f, CONTACT_SHADOW_RT_ACCUM_STRENGTH, CONTACT_SHADOW_RT_TUNING)) + _5790);
          } else {
            _5902 = _5782;
            _5903 = _5790;
          }
          [branch]
          if (_5903 > 0.949999988079071f) {
            if (!_5806) {
              _5934 = (saturate(_5789 / (_5789 - _5812)) - min(_5786, _5807));
            } else {
              _5934 = 0.0f;
            }
            _6228 = _5805;
            _6229 = _5903;
            _6230 = ((_5934 * _5763) + _5783);
            _6231 = ((_5934 * _5765) + _5784);
            _6232 = ((_5934 * _5766) + _5785);
            _6233 = _5804;
          } else {
            if ((uint)_5788 < (uint)(_5386 + -1)) {
              _5926 = ((_5807 * _5763) + _5783);
              _5927 = ((_5807 * _5765) + _5784);
              _5928 = ((_5807 * _5766) + _5785);
              _5929 = (_5807 + _5786);
              _5930 = min(abs(_5766), _5812);
            } else {
              _5926 = _5783;
              _5927 = _5784;
              _5928 = _5785;
        ...
        float _5944 = select(_5657, ((_nearFarProj.x - _5649) / _5652), _5406);
        float _5976 = mad((_viewProjRelative[2].z), _5636, mad((_viewProjRelative[2].y), _5635, ((_viewProjRelative[2].x) * _5634))) + (_viewProjRelative[2].w);
        float _5980 = mad((_viewProjRelative[3].z), _5636, mad((_viewProjRelative[3].y), _5635, ((_viewProjRelative[3].x) * _5634))) + (_viewProjRelative[3].w);
        float _5984 = (_5944 * _5377) + _5634;
        float _5985 = (_5944 * _5381) + _5635;
        float _5986 = (_5944 * _5385) + _5636;
        float _6002 = mad((_viewProjRelative[3].z), _5986, mad((_viewProjRelative[3].y), _5985, ((_viewProjRelative[3].x) * _5984))) + (_viewProjRelative[3].w);
        float _6003 = (mad((_viewProjRelative[0].z), _5636, mad((_viewProjRelative[0].y), _5635, ((_viewProjRelative[0].x) * _5634))) + (_viewProjRelative[0].w)) / _5980;
        float _6004 = (mad((_viewProjRelative[1].z), _5636, mad((_viewProjRelative[1].y), _5635, ((_viewProjRelative[1].x) * _5634))) + (_viewProjRelative[1].w)) / _5980;
        float _6005 = _5976 / _5980;
        float _6009 = ((mad((_viewProjRelative[0].z), _5986, mad((_viewProjRelative[0].y), _5985, ((_viewProjRelative[0].x) * _5984))) + (_viewProjRelative[0].w)) / _6002) - _6003;
        float _6010 = ((mad((_viewProjRelative[1].z), _5986, mad((_viewProjRelative[1].y), _5985, ((_viewProjRelative[1].x) * _5984))) + (_viewProjRelative[1].w)) / _6002) - _6004;
        float _6013 = 1.0f / float((uint)(uint)(_5386));
        float _6024 = max(_6013, (1.0f / min(1.0f, (max(((_bufferSizeAndInvSize.x * 0.5f) * abs(_6009)), ((_bufferSizeAndInvSize.y * 0.5f) * abs(_6010))) * _6013))));
        float _6025 = _6024 * (((mad((_viewProjRelative[2].z), _5986, mad((_viewProjRelative[2].y), _5985, ((_viewProjRelative[2].x) * _5984))) + (_viewProjRelative[2].w)) / _6002) - _6005);
        float _6044 = ((_5392 * 0.5f) * max(abs(_6025), (_6005 - ((mad((_proj[2].z), _115, 0.0f) + _5976) / (mad((_proj[3].z), _115, 0.0f) + _5980))))) * max(0.0625f, _6013);
        float _6045 = _6024 * _6013;
        float _6047 = (_6009 * 0.5f) * _6045;
        float _6049 = (_6010 * -0.5f) * _6045;
        float _6050 = _6025 * _6013;
        float _6057 = max(_5597, (1.0f / max((abs(_6047) * _bufferSizeAndInvSize.x), (abs(_6049) * _bufferSizeAndInvSize.y))));
        float _6064 = 0.5f / _bufferSizeAndInvSize.x;
        _6066 = 0;
        _6067 = _5412;
        _6068 = _5597;
        _6069 = (((_6003 * 0.5f) + 0.5f) + (_6057 * _6047));
        _6070 = ((0.5f - (_6004 * 0.5f)) + (_6057 * _6049));
        _6071 = ((_6057 * _6050) + _6005);
        _6072 = 0;
        _6073 = 1.0f;
        _6074 = 0.0f;
        while(true) {
          // RenoDX: >>> [Patch: ShadowEdgeNoiseFix] [Version: 1.09]
          // Description: Replaces the vanilla X clamp at this contact-shadow depth load. When a ray exits left/right, the clamp reuses the last screen column and can stretch or flicker shadows; the macro preserves vanilla when off and passes X through when on.
          uint _6083 = __3__36__0__0__g_depthStencil.Load(int3(int(SHADOW_CONTACT_SAMPLE_X(_6069, _6064) * _bufferSizeAndInvSize.x), int(_6070 * _bufferSizeAndInvSize.y), 0));
          // RenoDX: <<< [Patch: ShadowEdgeNoiseFix]
          int _6085 = (uint)((uint)(_6083.x)) >> 24;
          float _6088 = float((uint)((uint)(_6083.x & 16777215))) * 5.960465188081798e-08f;
          int _6089 = _6085 & 127;
          bool _6090 = (_6066 == 0);
          float _6091 = select(_6090, 1.0f, _6067);
          float _6092 = _6071 - _6088;
          float _6096 = _nearFarProj.x / max(1.0000000116860974e-07f, _6088);
          float _6099 = _6096 - (_nearFarProj.x / max(1.0000000116860974e-07f, _6071));
          bool _6102 = (abs(_6092 + _6044) < _6044);
          int _6103 = (int)(uint)((int)(_6102));
          if (_6102) {
            if (((_6089 == 7)) || ((((_6089 == 54)) || (((((_6085 & 126) == 66)) || (((((uint)(_6089 + -5) < (uint)2)) || ((((_6089 == 107)) || ((((_6089 == 26)) || (((((uint)(_6089 + -27) < (uint)2)) || ((((_6089 == 106)) || (((((_6085 & 125) == 105)) || ((((_6089 == 18)) || (((uint)(_6089 + -19) < (uint)2))))))))))))))))))))) {
              _6137 = true;
              _6144 = ((int)(uint)((int)(((_6099 < 0.0f)) && ((_6099 > select(_6137, -0.07999999821186066f, -1.0f))))));
            } else {
              if ((uint)(_6089 + -53) < (uint)14) {
                _6137 = (_6096 < 32.0f);
                _6144 = ((int)(uint)((int)(((_6099 < 0.0f)) && ((_6099 > select(_6137, -0.07999999821186066f, -1.0f))))));
              } else {
                _6144 = _6103;
          ...
          if (!(_6144 == 0)) {
            if ((uint)_6089 > (uint)11) {
              if (!((uint)_6089 < (uint)18)) {
                if (!(((_6089 == 18)) || ((((_6089 == 107)) || (((uint)(_6089 + -19) < (uint)2)))))) {
                  if (!(_6089 == 66)) {
                    _6163 = 0.0f;
                  } else {
                    _6163 = 0.10000000149011612f;
                  }
                } else {
                  _6163 = 0.15000000596046448f;
                }
              } else {
                _6163 = 0.10000000149011612f;
              }
            ...
            float _6165 = saturate(_6096 * 0.015625f);
            float _6168 = (1.0f - _6165) + (_6165 * _6163);
            if (_172) {
              _6179 = saturate((-0.0f - _6099) / (_6068 * 0.004654859658330679f));
            } else {
              _6179 = 1.0f;
            }
            _6186 = _6089;
            float _microFarAccum = (saturate(1.0f - ((_6168 * _6168) * _6163)) * (1.0f - _6074)) * _6179;
            _6187 = saturate((_microFarAccum * lerp(1.0f, CONTACT_SHADOW_RT_ACCUM_STRENGTH, CONTACT_SHADOW_RT_TUNING)) + _6074);
          } else {
            _6186 = _6072;
            _6187 = _6074;
          }
          [branch]
          if (_6187 > 0.949999988079071f) {
            if (!_6090) {
              _6218 = (saturate(_6073 / (_6073 - _6092)) - min(_6068, _6091));
            } else {
              _6218 = 0.0f;
            }
            _6228 = _6089;
            _6229 = _6187;
            _6230 = ((_6218 * _6047) + _6069);
            _6231 = ((_6218 * _6049) + _6070);
            _6232 = ((_6218 * _6050) + _6071);
            _6233 = _6088;
          } else {
            if ((uint)_6066 < (uint)(_5386 + -1)) {
              _6210 = (_6068 + _6091);
              _6211 = (_6069 + (_6091 * _6047));
              _6212 = (_6070 + (_6091 * _6049));
              _6213 = (_6071 + (_6091 * _6050));
              _6214 = min(abs(_6050), _6092);
            } else {
              _6210 = _6068;
              _6211 = _6069;
              _6212 = _6070;
      ...
      bool _6237 = (_6229 > 0.0f);
      if (_6232 > 0.0f) {
        if ((_6237) || ((((((_6230 >= 0.0f)) && ((_6230 <= 1.0f)))) && ((((_6231 >= 0.0f)) && ((_6231 <= 1.0f))))))) {
          float _6251 = (_6230 * 2.0f) + -1.0f;
          float _6252 = 1.0f - (_6231 * 2.0f);
          float _6288 = mad((_invViewProjRelative[3].z), _6232, mad((_invViewProjRelative[3].y), _6252, ((_invViewProjRelative[3].x) * _6251))) + (_invViewProjRelative[3].w);
          if (!(_6228 == 2)) {
            if (_6228 == 3) {
              _6314 = 0.0f;
              _6316 = _6314;
          ...
          if (!((_170) || ((!(_6229 == 1.0f))))) {
            _6340 = saturate(((((_5406 * 0.9375f) - max(0.0f, dot(float3(_5377, _5381, _5385), float3((((mad((_invViewProjRelative[0].z), _6232, mad((_invViewProjRelative[0].y), _6252, ((_invViewProjRelative[0].x) * _6251))) + (_invViewProjRelative[0].w)) / _6288) - _5634), (((mad((_invViewProjRelative[1].z), _6232, mad((_invViewProjRelative[1].y), _6252, ((_invViewProjRelative[1].x) * _6251))) + (_invViewProjRelative[1].w)) / _6288) - _5635), (((mad((_invViewProjRelative[2].z), _6232, mad((_invViewProjRelative[2].y), _6252, ((_invViewProjRelative[2].x) * _6251))) + (_invViewProjRelative[2].w)) / _6288) - _5636))))) * ((_115 * 0.015625f) + 1.5f)) / _5406) * 0.9375f);
          } else {
            _6340 = _6229;
          }
          float _6341 = _6340 * saturate(exp2(min(0.0f, (((_115 * 0.01899999938905239f) + 0.10000000149011612f) + (_6316 * ((_nearFarProj.x / max(1.0000000116860974e-07f, _6233)) - (_nearFarProj.x / max(1.0000000116860974e-07f, _6232)))))) * 1.4426950216293335f));
          int _6342 = _6228 & -2;
          if (!(_6342 == 6)) {
            bool __defer_6344_6354 = false;
            if ((((_80 == 33) && (_6228 == 33)) || (!(_80 == 33) && (((_80 == 55)) && ((_6228 == 55)))))) {
              _6419 = (_6341 * 0.009999999776482582f);
            } else {
              __defer_6344_6354 = true;
            }
            if (__defer_6344_6354) {
              if (!(((_6228 == 54)) || ((_6342 == 66))) || ((((_6228 == 54)) || ((_6342 == 66))) && (!(((_5270 == 66)) || ((_80 == 54)))))) {
                if (!_172) {
                  if ((uint)((int)((uint)(_6228) + (uint)(-53))) < (uint)15) {
                    _6416 = saturate(_115 * 0.03125f);
                  } else {
                    _6416 = 1.0f;
                  }
                  _6419 = (_6416 * _6341);
                ...
                uint4 _6371 = __3__36__0__0__g_baseColor.Load(int3(int(_bufferSizeAndInvSize.x * _6230), int(_bufferSizeAndInvSize.y * _6231), 0));
                float _6377 = float((uint)((uint)(((uint)((uint)(_6371.x)) >> 8) & 255))) * 0.003921568859368563f;
                float _6380 = float((uint)((uint)(_6371.x & 255))) * 0.003921568859368563f;
                float _6384 = float((uint)((uint)(((uint)((uint)(_6371.y)) >> 8) & 255))) * 0.003921568859368563f;
                float _6385 = _6377 * _6377;
                float _6386 = _6380 * _6380;
                float _6387 = _6384 * _6384;
                _6419 = (saturate(1.0f - (dot(float3((((_6385 * 0.6131200194358826f) + (_6386 * 0.3395099937915802f)) + (_6387 * 0.047370001673698425f)), (((_6385 * 0.07020000368356705f) + (_6386 * 0.9163600206375122f)) + (_6387 * 0.013450000435113907f)), (((_6385 * 0.02061999961733818f) + (_6386 * 0.10958000272512436f)) + (_6387 * 0.8697999715805054f))), float3(0.21267099678516388f, 0.7151600122451782f, 0.0721689984202385f)) * 0.875f)) * _6341);
              }
            }
          } else {
            _6419 = (_6341 * 0.009999999776482582f);
      ...
      _6423 = saturate(1.0f - _6419);
    } else {
      _6423 = 1.0f;
    }
    float _rndxMicroBaseContact = _6423;
    // Contact Micro Shadows: screen-space helper fills missing fine occluders.
    _6423 = ApplyContactMicroDetailShadow(
        _6423,
        float2(_60, _61),
        _115,
        _80,
        float3(_5290, _5291, _5292),
        float3(_5620, _5621, _5622),
    ...
    _6439 = float(half(_6424 * float(_5237)));
    _6440 = float(half(_6424 * float(_5238)));
    _6441 = saturate((1.0f - _556) + (exp2(log2(saturate(select(_172, (_5245 + 0.9800000190734863f), _5245))) * 0.45454543828964233f) * _556));
  }
  __3__38__0__1__g_shadowColorResultUAV[int2(((int)(((uint)(((((int)((uint)(_46) << 2)) & 1020) | ((int)(SV_GroupID.x) & 3)) << 3)) + SV_GroupThreadID.x)), ((int)(((uint)(((((uint)((uint)(_46)) >> 6) & 1020) | (((uint)(SV_GroupID.x) >> 2) & 3)) << 3)) + SV_GroupThreadID.y)))] = half4(half(_6438), half(_6439), half(_6440), half(_6441));
}
