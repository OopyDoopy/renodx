...
#define SHADOW_DBG_OUT_B        _2596
#define SHADOW_DBG_OUT_A        _2597
...
void main(
  ...
  if (((int)(_73 < 1.0000000116860974e-07f)) | (_101)) {
    ...
    if (_1616 > 0.0f) {
      ...
      if (_109 < 8.0f) {
        ...
        while(true) {
          ...
          if (!(_2055 == 0)) {
            ...
            _2093 = _2000;
            _2094 = saturate((saturate(1.0f - ((_2083 * _2083) * _2078)) * (1.0f - _1985)) + _1985);
          } else {
            _2093 = _1977;
            _2094 = _1985;
          }
          [branch]
          if (_2094 > 0.949999988079071f) {
            if (!_2001) {
              _2124 = (saturate(_1984 / (_1984 - _2007)) - min(_1981, _2002));
            } else {
              _2124 = 0.0f;
            }
            _2408 = _2000;
            _2409 = _2094;
            _2410 = ((_2124 * _1958) + _1978);
            _2411 = ((_2124 * _1960) + _1979);
        ...
        float _2134 = select(_1856, ((_nearFarProj.x - _1850) / _1853), _1756);
        float _2166 = mad((float4(_viewProjRelative[0].z, _viewProjRelative[1].z, _viewProjRelative[2].z, _viewProjRelative[3].z).z), _1837, mad((float4(_viewProjRelative[0].y, _viewProjRelative[1].y, _viewProjRelative[2].y, _viewProjRelative[3].y).z), _1836, ((float4(_viewProjRelative[0].x, _viewProjRelative[1].x, _viewProjRelative[2].x, _viewProjRelative[3].x).z) * _1835))) + (float4(_viewProjRelative[0].w, _viewProjRelative[1].w, _viewProjRelative[2].w, _viewProjRelative[3].w).z);
        float _2170 = mad((float4(_viewProjRelative[0].z, _viewProjRelative[1].z, _viewProjRelative[2].z, _viewProjRelative[3].z).w), _1837, mad((float4(_viewProjRelative[0].y, _viewProjRelative[1].y, _viewProjRelative[2].y, _viewProjRelative[3].y).w), _1836, ((float4(_viewProjRelative[0].x, _viewProjRelative[1].x, _viewProjRelative[2].x, _viewProjRelative[3].x).w) * _1835))) + (float4(_viewProjRelative[0].w, _viewProjRelative[1].w, _viewProjRelative[2].w, _viewProjRelative[3].w).w);
        float _2174 = (_2134 * _1731) + _1835;
        float _2175 = (_2134 * _1735) + _1836;
        float _2176 = (_2134 * _1739) + _1837;
        float _2192 = mad((float4(_viewProjRelative[0].z, _viewProjRelative[1].z, _viewProjRelative[2].z, _viewProjRelative[3].z).w), _2176, mad((float4(_viewProjRelative[0].y, _viewProjRelative[1].y, _viewProjRelative[2].y, _viewProjRelative[3].y).w), _2175, ((float4(_viewProjRelative[0].x, _viewProjRelative[1].x, _viewProjRelative[2].x, _viewProjRelative[3].x).w) * _2174))) + (float4(_viewProjRelative[0].w, _viewProjRelative[1].w, _viewProjRelative[2].w, _viewProjRelative[3].w).w);
        float _2193 = (mad((float4(_viewProjRelative[0].z, _viewProjRelative[1].z, _viewProjRelative[2].z, _viewProjRelative[3].z).x), _1837, mad((float4(_viewProjRelative[0].y, _viewProjRelative[1].y, _viewProjRelative[2].y, _viewProjRelative[3].y).x), _1836, ((float4(_viewProjRelative[0].x, _viewProjRelative[1].x, _viewProjRelative[2].x, _viewProjRelative[3].x).x) * _1835))) + (float4(_viewProjRelative[0].w, _viewProjRelative[1].w, _viewProjRelative[2].w, _viewProjRelative[3].w).x)) / _2170;
        float _2194 = (mad((float4(_viewProjRelative[0].z, _viewProjRelative[1].z, _viewProjRelative[2].z, _viewProjRelative[3].z).y), _1837, mad((float4(_viewProjRelative[0].y, _viewProjRelative[1].y, _viewProjRelative[2].y, _viewProjRelative[3].y).y), _1836, ((float4(_viewProjRelative[0].x, _viewProjRelative[1].x, _viewProjRelative[2].x, _viewProjRelative[3].x).y) * _1835))) + (float4(_viewProjRelative[0].w, _viewProjRelative[1].w, _viewProjRelative[2].w, _viewProjRelative[3].w).y)) / _2170;
        float _2195 = _2166 / _2170;
        float _2199 = ((mad((float4(_viewProjRelative[0].z, _viewProjRelative[1].z, _viewProjRelative[2].z, _viewProjRelative[3].z).x), _2176, mad((float4(_viewProjRelative[0].y, _viewProjRelative[1].y, _viewProjRelative[2].y, _viewProjRelative[3].y).x), _2175, ((float4(_viewProjRelative[0].x, _viewProjRelative[1].x, _viewProjRelative[2].x, _viewProjRelative[3].x).x) * _2174))) + (float4(_viewProjRelative[0].w, _viewProjRelative[1].w, _viewProjRelative[2].w, _viewProjRelative[3].w).x)) / _2192) - _2193;
        float _2200 = ((mad((float4(_viewProjRelative[0].z, _viewProjRelative[1].z, _viewProjRelative[2].z, _viewProjRelative[3].z).y), _2176, mad((float4(_viewProjRelative[0].y, _viewProjRelative[1].y, _viewProjRelative[2].y, _viewProjRelative[3].y).y), _2175, ((float4(_viewProjRelative[0].x, _viewProjRelative[1].x, _viewProjRelative[2].x, _viewProjRelative[3].x).y) * _2174))) + (float4(_viewProjRelative[0].w, _viewProjRelative[1].w, _viewProjRelative[2].w, _viewProjRelative[3].w).y)) / _2192) - _2194;
        float _2212 = max(0.125f, (1.0f / min(1.0f, (max(((_bufferSizeAndInvSize.x * 0.5f) * abs(_2199)), ((_bufferSizeAndInvSize.y * 0.5f) * abs(_2200))) * 0.125f))));
        float _2213 = _2212 * (((mad((float4(_viewProjRelative[0].z, _viewProjRelative[1].z, _viewProjRelative[2].z, _viewProjRelative[3].z).z), _2176, mad((float4(_viewProjRelative[0].y, _viewProjRelative[1].y, _viewProjRelative[2].y, _viewProjRelative[3].y).z), _2175, ((float4(_viewProjRelative[0].x, _viewProjRelative[1].x, _viewProjRelative[2].x, _viewProjRelative[3].x).z) * _2174))) + (float4(_viewProjRelative[0].w, _viewProjRelative[1].w, _viewProjRelative[2].w, _viewProjRelative[3].w).z)) / _2192) - _2195);
        float _2230 = (_1742 * 0.0625f) * max(abs(_2213), (_2195 - ((mad((float4(_proj[0].z, _proj[1].z, _proj[2].z, _proj[3].z).z), _109, 0.0f) + _2166) / (mad((float4(_proj[0].z, _proj[1].z, _proj[2].z, _proj[3].z).w), _109, 0.0f) + _2170))));
        float _2232 = (_2199 * 0.0625f) * _2212;
        ...
        _2252 = _1762;
        _2253 = _1812;
        _2254 = (((_2193 * 0.5f) + 0.5f) + (_2242 * _2232));
        _2255 = ((0.5f - (_2194 * 0.5f)) + (_2242 * _2234));
        _2256 = ((_2242 * _2235) + _2195);
        _2257 = 0;
        _2258 = 1.0f;
        _2259 = 0.0f;
        while(true) {
          uint _2268 = __3__36__0__0__g_depthStencil.Load(int3(int(min(max(_2254, _2249), (1.0f - _2249)) * _bufferSizeAndInvSize.x), int(_2255 * _bufferSizeAndInvSize.y), 0));
          int _2270 = (uint)((uint)(_2268.x)) >> 24;
          float _2273 = float((uint)((uint)(_2268.x & 16777215))) * 5.960465188081798e-08f;
          int _2274 = _2270 & 127;
          bool _2275 = (_2251 == 0);
          float _2276 = select(_2275, 1.0f, _2252);
          float _2277 = _2256 - _2273;
          float _2281 = _nearFarProj.x / max(1.0000000116860974e-07f, _2273);
          float _2284 = _2281 - (_nearFarProj.x / max(1.0000000116860974e-07f, _2256));
          bool _2287 = (abs(_2277 + _2230) < _2230);
          int _2288 = (int)(uint)(_2287);
          if (_2287) {
            bool __defer_2289_2321 = false;
            if (!(((int)(_2274 == 7)) | (((int)(((int)(_2274 == 54)) | (((int)(((int)((_2270 & 126) == 66)) | (((int)(((int)((uint)(_2274 + -5) < (uint)2)) | (((int)(((int)(_2274 == 107)) | (((int)(((int)(_2274 == 26)) | (((int)(((int)((uint)(_2274 + -27) < (uint)2)) | (((int)(((int)(_2274 == 106)) | (((int)(((int)((_2270 & 125) == 105)) | (((int)(((int)(_2274 == 18)) | ((int)((uint)(_2274 + -19) < (uint)2))))))))))))))))))))))))))))))) {
              if ((uint)(_2274 + -53) < (uint)14) {
                _2322 = (_2281 < 32.0f);
                __defer_2289_2321 = true;
              } else {
                _2329 = _2288;
              }
            } else {
            ...
            if (__defer_2289_2321) {
              _2329 = ((int)(uint)((int)(((int)(_2284 < 0.0f)) & ((int)(_2284 > select(_2322, -0.07999999821186066f, -1.0f))))));
            }
          } else {
            _2329 = _2288;
          }
          if (!(_2329 == 0)) {
            bool __defer_2331_2350 = false;
            if ((uint)_2274 > (uint)11) {
              if (!(((int)((uint)_2274 < (uint)16)) | ((int)(_2274 == 17)))) {
                if (!(_2274 == 16)) {
                  if (!(((int)(_2274 == 18)) | (((int)(((int)(_2274 == 107)) | ((int)((uint)(_2274 + -19) < (uint)2))))))) {
                    if (!(_2274 == 66)) {
                      __defer_2331_2350 = true;
                    } else {
                      _2352 = 0.10000000149011612f;
                    }
                  } else {
                    _2352 = 0.4000000059604645f;
                  }
                } else {
                  _2352 = 0.10000000149011612f;
                }
              } else {
                _2352 = 0.30000001192092896f;
              }
            } else {
              if (!(_2274 == 11)) {
                __defer_2331_2350 = true;
            ...
            if (__defer_2331_2350) {
              _2352 = 0.0f;
            }
            float _2354 = saturate(_2281 * 0.015625f);
            float _2357 = (1.0f - _2354) + (_2354 * _2352);
            _2367 = _2274;
            _2368 = saturate((saturate(1.0f - ((_2357 * _2357) * _2352)) * (1.0f - _2259)) + _2259);
          } else {
            _2367 = _2257;
            _2368 = _2259;
          }
          [branch]
          if (_2368 > 0.949999988079071f) {
            if (!_2275) {
              _2398 = (saturate(_2258 / (_2258 - _2277)) - min(_2253, _2276));
            } else {
              _2398 = 0.0f;
            }
            _2408 = _2274;
            _2409 = _2368;
            _2410 = ((_2398 * _2232) + _2254);
            _2411 = ((_2398 * _2234) + _2255);
            ...
            if ((uint)_2251 < ((CONTACT_SHADOW_QUALITY > 0.5f) ? (uint)59 : (uint)7)) {
              ...
              _2393 = (_2256 + (_2276 * _2235));
              _2394 = min(abs(_2235), _2277);
            } else {
              _2390 = _2253;
              _2391 = _2254;
              _2392 = _2255;
      ...
      bool _2417 = (_2409 > 0.0f);
      if (_2412 > 0.0f) {
        if ((_2417) | (((int)((((int)(((int)(_2410 >= 0.0f)) & ((int)(_2410 <= 1.0f))))) & (((int)(((int)(_2411 >= 0.0f)) & ((int)(_2411 <= 1.0f))))))))) {
          float _2431 = (_2410 * 2.0f) + -1.0f;
          float _2432 = 1.0f - (_2411 * 2.0f);
          float _2448 = mad((float4(_invViewProjRelative[0].z, _invViewProjRelative[1].z, _invViewProjRelative[2].z, _invViewProjRelative[3].z).w), _2412, mad((float4(_invViewProjRelative[0].y, _invViewProjRelative[1].y, _invViewProjRelative[2].y, _invViewProjRelative[3].y).w), _2432, (_2431 * (float4(_invViewProjRelative[0].x, _invViewProjRelative[1].x, _invViewProjRelative[2].x, _invViewProjRelative[3].x).w)))) + (float4(_invViewProjRelative[0].w, _invViewProjRelative[1].w, _invViewProjRelative[2].w, _invViewProjRelative[3].w).w);
          bool __defer_2428_2473 = false;
          if (!(_2408 == 2)) {
            if (!(_2408 == 3)) {
              if (!(_2408 == 21)) {
                bool _2467 = (_2408 == 22);
                if (!(((int)(_74 == 22)) & (_2467))) {
                  _2474 = select(_2467, 0.0f, 1.0f);
                  __defer_2428_2473 = true;
                } else {
                  _2476 = 20.0f;
                }
              } else {
          ...
          if (__defer_2428_2473) {
            _2476 = _2474;
          }
          if (_2409 == 1.0f) {
            _2499 = saturate(((((_1756 * 0.9375f) - max(0.0f, dot(float3(_1731, _1735, _1739), float3((((mad((float4(_invViewProjRelative[0].z, _invViewProjRelative[1].z, _invViewProjRelative[2].z, _invViewProjRelative[3].z).x), _2412, mad((float4(_invViewProjRelative[0].y, _invViewProjRelative[1].y, _invViewProjRelative[2].y, _invViewProjRelative[3].y).x), _2432, (_2431 * (float4(_invViewProjRelative[0].x, _invViewProjRelative[1].x, _invViewProjRelative[2].x, _invViewProjRelative[3].x).x)))) + (float4(_invViewProjRelative[0].w, _invViewProjRelative[1].w, _invViewProjRelative[2].w, _invViewProjRelative[3].w).x)) / _2448) - _1835), (((mad((float4(_invViewProjRelative[0].z, _invViewProjRelative[1].z, _invViewProjRelative[2].z, _invViewProjRelative[3].z).y), _2412, mad((float4(_invViewProjRelative[0].y, _invViewProjRelative[1].y, _invViewProjRelative[2].y, _invViewProjRelative[3].y).y), _2432, (_2431 * (float4(_invViewProjRelative[0].x, _invViewProjRelative[1].x, _invViewProjRelative[2].x, _invViewProjRelative[3].x).y)))) + (float4(_invViewProjRelative[0].w, _invViewProjRelative[1].w, _invViewProjRelative[2].w, _invViewProjRelative[3].w).y)) / _2448) - _1836), (((mad((float4(_invViewProjRelative[0].z, _invViewProjRelative[1].z, _invViewProjRelative[2].z, _invViewProjRelative[3].z).z), _2412, mad((float4(_invViewProjRelative[0].y, _invViewProjRelative[1].y, _invViewProjRelative[2].y, _invViewProjRelative[3].y).z), _2432, (_2431 * (float4(_invViewProjRelative[0].x, _invViewProjRelative[1].x, _invViewProjRelative[2].x, _invViewProjRelative[3].x).z)))) + (float4(_invViewProjRelative[0].w, _invViewProjRelative[1].w, _invViewProjRelative[2].w, _invViewProjRelative[3].w).z)) / _2448) - _1837))))) * ((_109 * 0.015625f) + 1.5f)) / _1756) * 0.9375f);
          } else {
            _2499 = _2409;
          }
          float _2500 = _2499 * saturate(exp2(min(0.0f, (((_109 * 0.01899999938905239f) + 0.10000000149011612f) + (_2476 * ((_nearFarProj.x / max(1.0000000116860974e-07f, _2413)) - (_nearFarProj.x / max(1.0000000116860974e-07f, _2412)))))) * 1.4426950216293335f));
          int _2501 = _2408 & -2;
          bool __defer_2498_2511 = false;
          if (!(_2501 == 6)) {
            bool __defer_2503_2513 = false;
            if ((((_74 == 33) && (_2408 == 33)) || (!(_74 == 33) && (((int)(_74 == 55)) & ((int)(_2408 == 55)))))) {
              __defer_2498_2511 = true;
            } else {
              __defer_2503_2513 = true;
            }
            if (__defer_2503_2513) {
              bool __defer_2513_2564 = false;
              if (!(((int)(_2408 == 54)) | ((int)(_2501 == 66))) || ((((int)(_2408 == 54)) | ((int)(_2501 == 66))) && (!(((int)(_1626 == 66)) | ((int)(_74 == 54)))))) {
                __defer_2513_2564 = true;
              } else {
                uint4 _2527 = __3__36__0__0__g_baseColor.Load(int3(int(_2410 * _bufferSizeAndInvSize.x), int(_2411 * _bufferSizeAndInvSize.y), 0));
                float _2533 = float((uint)((uint)(((uint)((uint)(_2527.x)) >> 8) & 255))) * 0.003921568859368563f;
                float _2536 = float((uint)((uint)(_2527.x & 255))) * 0.003921568859368563f;
                float _2540 = float((uint)((uint)(((uint)((uint)(_2527.y)) >> 8) & 255))) * 0.003921568859368563f;
                float _2541 = _2533 * _2533;
                float _2542 = _2536 * _2536;
                float _2543 = _2540 * _2540;
                _2575 = (saturate(1.0f - (dot(float3((((_2541 * 0.6131200194358826f) + (_2542 * 0.3395099937915802f)) + (_2543 * 0.047370001673698425f)), (((_2541 * 0.07020000368356705f) + (_2542 * 0.9163600206375122f)) + (_2543 * 0.013450000435113907f)), (((_2541 * 0.02061999961733818f) + (_2542 * 0.10958000272512436f)) + (_2543 * 0.8697999715805054f))), float3(0.21267099678516388f, 0.7151600122451782f, 0.0721689984202385f)) * 0.875f)) * _2500);
              }
              if (__defer_2513_2564) {
                if (!_166) {
                  if ((uint)((int)(_2408 + -53u)) < (uint)15) {
                    _2572 = saturate(_109 * 0.03125f);
                  } else {
                    _2572 = 1.0f;
                  }
                  _2575 = (_2572 * _2500);
          ...
          if (__defer_2498_2511) {
            _2575 = (_2500 * 0.009999999776482582f);
          }
        } else {
          _2575 = 0.0f;
        }
      ...
      _2579 = saturate(1.0f - _2575);
    } else {
      _2579 = 1.0f;
    }
    float _2580 = min(_1616, _2579);
    _2594 = float(half(_2580 * float(_1592)));
    _2595 = float(half(_2580 * float(_1593)));
    _2596 = float(half(_2580 * float(_1594)));
    _2597 = saturate((1.0f - _550) + (exp2(log2(saturate(select(_166, (_1601 + 0.9800000190734863f), _1601))) * 0.45454543828964233f) * _550));
    // ── RenoDX Shadow Debug ──────────────────────────────────────────────
    #include "shadow_debug_night.hlsli"
    // ────────────────────────────────────────────────────────────────────
  }
  __3__38__0__1__g_shadowColorResultUAV[int2(_52, _53)] = half4((float)(half(_2594)), (float)(half(_2595)), (float)(half(_2596)), (float)(half(_2597)));
}
