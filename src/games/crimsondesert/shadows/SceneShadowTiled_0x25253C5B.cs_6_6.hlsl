      ...
      if (_115 < 8.0f) {
        ...
        while(true) {
          ...
          if (!(_3516 == 0)) {
            ...
            _3551 = saturate((_microNearAccum * lerp(1.0f, 1.15f, CONTACT_SHADOW_BASE_TUNING)) + _3446);
          } else {
            _3550 = _3438;
            _3551 = _3446;
          }
        ...
        while(true) {
          ...
          if (!(_3792 == 0)) {
            ...
            _3827 = saturate((_microFarAccum * lerp(1.0f, 1.15f, CONTACT_SHADOW_BASE_TUNING)) + _3722);
          } else {
            _3826 = _3720;
            _3827 = _3722;
          }
