...
#define SHADOW_DBG_CONTACT_INV  _2601
#define SHADOW_DBG_OUT_R        _2616
#define SHADOW_DBG_OUT_G        _2617
#define SHADOW_DBG_OUT_B        _2618
#define SHADOW_DBG_OUT_A        _2619
...
void main(
  ...
  if (((_73 < 1.0000000116860974e-07f)) || (_101)) {
    ...
    if (_694) {
      ...
      float _951 = _25[_808];
      float _952 = _26[_808];
      float _954 = select((_808 == 0), 2.5f, 1.0f);
      if (_946) {
    ...
    if (_1616 > 0.0f) {
      ...
      if (_109 < 8.0f) {
        ...
        while(true) {
          ...
          if (!(_2069 == 0)) {
            ...
            if (_166) {
              _2104 = saturate((-0.0f - _2024) / (_1995 * 0.004654859658330679f));
            } else {
              _2104 = 1.0f;
            }
            _2111 = _2014;
          ...
          [branch]
          if (_2112 > 0.949999988079071f) {
            if (!_2015) {
              _2142 = (saturate(_1998 / (_1998 - _2021)) - min(_1995, _2016));
            } else {
              _2142 = 0.0f;
            }
            _2430 = _2014;
            _2431 = _2112;
            _2432 = ((_2142 * _1972) + _1992);
            _2433 = ((_2142 * _1974) + _1993);
            _2434 = ((_2142 * _1975) + _1994);
            _2435 = _2013;
          } else {
            if ((uint)_1997 < (uint)7) {
              _2134 = ((_2016 * _1972) + _1992);
              _2135 = ((_2016 * _1974) + _1993);
              _2136 = ((_2016 * _1975) + _1994);
              _2137 = (_2016 + _1995);
              _2138 = min(abs(_1975), _2021);
            } else {
              _2134 = _1992;
              _2135 = _1993;
              _2136 = _1994;
        ...
        float _2152 = select(_1870, ((_nearFarProj.x - _1864) / _1867), _1756);
        float _2184 = mad((_viewProjRelative[2].z), _1851, mad((_viewProjRelative[2].y), _1850, ((_viewProjRelative[2].x) * _1849))) + (_viewProjRelative[2].w);
        float _2188 = mad((_viewProjRelative[3].z), _1851, mad((_viewProjRelative[3].y), _1850, ((_viewProjRelative[3].x) * _1849))) + (_viewProjRelative[3].w);
        float _2192 = (_2152 * _1731) + _1849;
        float _2193 = (_2152 * _1735) + _1850;
        float _2194 = (_2152 * _1739) + _1851;
        float _2210 = mad((_viewProjRelative[3].z), _2194, mad((_viewProjRelative[3].y), _2193, ((_viewProjRelative[3].x) * _2192))) + (_viewProjRelative[3].w);
        float _2211 = (mad((_viewProjRelative[0].z), _1851, mad((_viewProjRelative[0].y), _1850, ((_viewProjRelative[0].x) * _1849))) + (_viewProjRelative[0].w)) / _2188;
        float _2212 = (mad((_viewProjRelative[1].z), _1851, mad((_viewProjRelative[1].y), _1850, ((_viewProjRelative[1].x) * _1849))) + (_viewProjRelative[1].w)) / _2188;
        float _2213 = _2184 / _2188;
        float _2217 = ((mad((_viewProjRelative[0].z), _2194, mad((_viewProjRelative[0].y), _2193, ((_viewProjRelative[0].x) * _2192))) + (_viewProjRelative[0].w)) / _2210) - _2211;
        float _2218 = ((mad((_viewProjRelative[1].z), _2194, mad((_viewProjRelative[1].y), _2193, ((_viewProjRelative[1].x) * _2192))) + (_viewProjRelative[1].w)) / _2210) - _2212;
        float _2230 = max(0.125f, (1.0f / min(1.0f, (max(((_bufferSizeAndInvSize.x * 0.5f) * abs(_2217)), ((_bufferSizeAndInvSize.y * 0.5f) * abs(_2218))) * 0.125f))));
        float _2231 = _2230 * (((mad((_viewProjRelative[2].z), _2194, mad((_viewProjRelative[2].y), _2193, ((_viewProjRelative[2].x) * _2192))) + (_viewProjRelative[2].w)) / _2210) - _2213);
        float _2248 = (_1742 * 0.0625f) * max(abs(_2231), (_2213 - ((mad((_proj[2].z), _109, 0.0f) + _2184) / (mad((_proj[3].z), _109, 0.0f) + _2188))));
        float _2250 = (_2217 * 0.0625f) * _2230;
        float _2252 = (_2218 * -0.0625f) * _2230;
        float _2253 = _2231 * 0.125f;
        float _2260 = max(_1812, (1.0f / max((abs(_2250) * _bufferSizeAndInvSize.x), (abs(_2252) * _bufferSizeAndInvSize.y))));
        float _2267 = 0.5f / _bufferSizeAndInvSize.x;
        _2269 = 0;
        _2270 = _1762;
        _2271 = _1812;
        _2272 = (((_2211 * 0.5f) + 0.5f) + (_2260 * _2250));
        _2273 = ((0.5f - (_2212 * 0.5f)) + (_2260 * _2252));
        _2274 = ((_2260 * _2253) + _2213);
        _2275 = 0;
        _2276 = 1.0f;
        _2277 = 0.0f;
        while(true) {
          uint _2286 = __3__36__0__0__g_depthStencil.Load(int3(int(min(max(_2272, _2267), (1.0f - _2267)) * _bufferSizeAndInvSize.x), int(_2273 * _bufferSizeAndInvSize.y), 0));
          int _2288 = (uint)((uint)(_2286.x)) >> 24;
          float _2291 = float((uint)((uint)(_2286.x & 16777215))) * 5.960465188081798e-08f;
          int _2292 = _2288 & 127;
          bool _2293 = (_2269 == 0);
          float _2294 = select(_2293, 1.0f, _2270);
          float _2295 = _2274 - _2291;
          float _2299 = _nearFarProj.x / max(1.0000000116860974e-07f, _2291);
          float _2302 = _2299 - (_nearFarProj.x / max(1.0000000116860974e-07f, _2274));
          bool _2305 = (abs(_2295 + _2248) < _2248);
          int _2306 = (int)(uint)((int)(_2305));
          if (_2305) {
            if (((_2292 == 7)) || ((((_2292 == 54)) || (((((_2288 & 126) == 66)) || (((((uint)(_2292 + -5) < (uint)2)) || ((((_2292 == 107)) || ((((_2292 == 26)) || (((((uint)(_2292 + -27) < (uint)2)) || ((((_2292 == 106)) || (((((_2288 & 125) == 105)) || ((((_2292 == 18)) || (((uint)(_2292 + -19) < (uint)2))))))))))))))))))))) {
              _2340 = true;
              _2347 = ((int)(uint)((int)(((_2302 < 0.0f)) && ((_2302 > select(_2340, -0.07999999821186066f, -1.0f))))));
            } else {
              if ((uint)(_2292 + -53) < (uint)14) {
                _2340 = (_2299 < 32.0f);
                _2347 = ((int)(uint)((int)(((_2302 < 0.0f)) && ((_2302 > select(_2340, -0.07999999821186066f, -1.0f))))));
              } else {
                _2347 = _2306;
          ...
          if (!(_2347 == 0)) {
            if ((uint)_2292 > (uint)11) {
              if (!((uint)_2292 < (uint)18)) {
                if (!(((_2292 == 18)) || ((((_2292 == 107)) || (((uint)(_2292 + -19) < (uint)2)))))) {
                  if (!(_2292 == 66)) {
                    _2366 = 0.0f;
                  } else {
            ...
            if (_166) {
              _2382 = saturate((-0.0f - _2302) / (_2271 * 0.004654859658330679f));
            } else {
              _2382 = 1.0f;
            }
            _2389 = _2292;
          ...
          [branch]
          if (_2390 > 0.949999988079071f) {
            if (!_2293) {
              _2420 = (saturate(_2276 / (_2276 - _2295)) - min(_2271, _2294));
            } else {
              _2420 = 0.0f;
            }
            _2430 = _2292;
            _2431 = _2390;
            _2432 = ((_2420 * _2250) + _2272);
            _2433 = ((_2420 * _2252) + _2273);
            _2434 = ((_2420 * _2253) + _2274);
            _2435 = _2291;
          } else {
            if ((uint)_2269 < (uint)7) {
              _2412 = (_2271 + _2294);
              _2413 = (_2272 + (_2294 * _2250));
              _2414 = (_2273 + (_2294 * _2252));
              _2415 = (_2274 + (_2294 * _2253));
              _2416 = min(abs(_2253), _2295);
            } else {
              _2412 = _2271;
              _2413 = _2272;
              _2414 = _2273;
      ...
      if (_2434 > 0.0f) {
        if ((_2439) || ((((((_2432 >= 0.0f)) && ((_2432 <= 1.0f)))) && ((((_2433 >= 0.0f)) && ((_2433 <= 1.0f))))))) {
          float _2453 = (_2432 * 2.0f) + -1.0f;
          float _2454 = 1.0f - (_2433 * 2.0f);
          float _2470 = mad((_invViewProjRelative[3].z), _2434, mad((_invViewProjRelative[3].y), _2454, (_2453 * (_invViewProjRelative[3].x)))) + (_invViewProjRelative[3].w);
          if (!(_2430 == 2)) {
            if (_2430 == 3) {
              _2496 = 0.0f;
              _2498 = _2496;
          ...
          if (_2431 == 1.0f) {
            _2521 = saturate(((((_1756 * 0.9375f) - max(0.0f, dot(float3(_1731, _1735, _1739), float3((((mad((_invViewProjRelative[0].z), _2434, mad((_invViewProjRelative[0].y), _2454, (_2453 * (_invViewProjRelative[0].x)))) + (_invViewProjRelative[0].w)) / _2470) - _1849), (((mad((_invViewProjRelative[1].z), _2434, mad((_invViewProjRelative[1].y), _2454, (_2453 * (_invViewProjRelative[1].x)))) + (_invViewProjRelative[1].w)) / _2470) - _1850), (((mad((_invViewProjRelative[2].z), _2434, mad((_invViewProjRelative[2].y), _2454, (_2453 * (_invViewProjRelative[2].x)))) + (_invViewProjRelative[2].w)) / _2470) - _1851))))) * ((_109 * 0.015625f) + 1.5f)) / _1756) * 0.9375f);
          } else {
            _2521 = _2431;
          }
          float _2522 = _2521 * saturate(exp2(min(0.0f, (((_109 * 0.01899999938905239f) + 0.10000000149011612f) + (_2498 * ((_nearFarProj.x / max(1.0000000116860974e-07f, _2435)) - (_nearFarProj.x / max(1.0000000116860974e-07f, _2434)))))) * 1.4426950216293335f));
          int _2523 = _2430 & -2;
          if (!(_2523 == 6)) {
            bool __defer_2525_2535 = false;
            if ((((_74 == 33) && (_2430 == 33)) || (!(_74 == 33) && (((_74 == 55)) && ((_2430 == 55)))))) {
              _2597 = (_2522 * 0.009999999776482582f);
            } else {
              __defer_2525_2535 = true;
            }
            if (__defer_2525_2535) {
              if (!(((_2430 == 54)) || ((_2523 == 66))) || ((((_2430 == 54)) || ((_2523 == 66))) && (!(((_1626 == 66)) || ((_74 == 54)))))) {
                if (!_166) {
                  if ((uint)((int)((uint)(_2430) + (uint)(-53))) < (uint)15) {
                    _2594 = saturate(_109 * 0.03125f);
                  } else {
                    _2594 = 1.0f;
                  }
                  _2597 = (_2594 * _2522);
                ...
                uint4 _2549 = __3__36__0__0__g_baseColor.Load(int3(int(_2432 * _bufferSizeAndInvSize.x), int(_2433 * _bufferSizeAndInvSize.y), 0));
                float _2555 = float((uint)((uint)(((uint)((uint)(_2549.x)) >> 8) & 255))) * 0.003921568859368563f;
                float _2558 = float((uint)((uint)(_2549.x & 255))) * 0.003921568859368563f;
                float _2562 = float((uint)((uint)(((uint)((uint)(_2549.y)) >> 8) & 255))) * 0.003921568859368563f;
                float _2563 = _2555 * _2555;
                float _2564 = _2558 * _2558;
                float _2565 = _2562 * _2562;
                _2597 = (saturate(1.0f - (dot(float3((((_2563 * 0.6131200194358826f) + (_2564 * 0.3395099937915802f)) + (_2565 * 0.047370001673698425f)), (((_2563 * 0.07020000368356705f) + (_2564 * 0.9163600206375122f)) + (_2565 * 0.013450000435113907f)), (((_2563 * 0.02061999961733818f) + (_2564 * 0.10958000272512436f)) + (_2565 * 0.8697999715805054f))), float3(0.21267099678516388f, 0.7151600122451782f, 0.0721689984202385f)) * 0.875f)) * _2522);
              }
            }
          } else {
            _2597 = (_2522 * 0.009999999776482582f);
    ...
    _2619 = saturate((1.0f - _550) + (exp2(log2(saturate(select(_166, (_1601 + 0.9800000190734863f), _1601))) * 0.45454543828964233f) * _550));
    // ── RenoDX Shadow Debug ──────────────────────────────────────────────
    #include "shadow_debug_night.hlsli"
    // ────────────────────────────────────────────────────────────────────
  }
  __3__38__0__1__g_shadowColorResultUAV[int2(((int)(((uint)(((((int)((uint)(_40) << 2)) & 262140) | ((int)(SV_GroupID.x) & 3)) << 3)) + SV_GroupThreadID.x)), ((int)(((uint)(((((uint)((uint)(_40)) >> 16) << 2) | (((uint)(SV_GroupID.x) >> 2) & 3)) << 3)) + SV_GroupThreadID.y)))] = half4(half(_2616), half(_2617), half(_2618), half(_2619));
}