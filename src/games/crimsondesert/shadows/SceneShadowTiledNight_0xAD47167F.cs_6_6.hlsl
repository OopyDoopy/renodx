...
void main(
  ...
  if (((_77 < 1.0000000116860974e-07f)) || (_105)) {
    ...
    if (_1620 > 0.0f) {
      ...
      if (_113 < 8.0f) {
        ...
        while(true) {
          ...
          uint _2020 = __3__36__0__0__g_depthStencil.Load(int3(int(SHADOW_CONTACT_SAMPLE_X(_2004, _2001) * _bufferSizeAndInvSize.x), int(_2005 * _bufferSizeAndInvSize.y), 0));
          ...
          if (!(_2081 == 0)) {
            ...
            _2116 = saturate((_rndx_microNearAccum * lerp(1.0f, 0.7f, CONTACT_SHADOW_BASE_TUNING) * (1.0f - _2011)) + _2011);
          } else {
            _2115 = _2003;
            _2116 = _2011;
          }
          [branch]
          if (_2116 > 0.949999988079071f) {
            if (!_2027) {
              _2147 = (saturate(_2010 / (_2010 - _2033)) - min(_2007, _2028));
            } else {
              _2147 = 0.0f;
            }
            _2433 = _2026;
            _2434 = _2116;
            _2435 = ((_2147 * _1984) + _2004);
            _2436 = ((_2147 * _1986) + _2005);
            _2437 = ((_2147 * _1987) + _2006);
            _2438 = _2025;
          } else {
            if ((uint)_2009 < (uint)(_1744 + -1)) {
              _2139 = ((_2028 * _1984) + _2004);
              _2140 = ((_2028 * _1986) + _2005);
              _2141 = ((_2028 * _1987) + _2006);
              _2142 = (_2028 + _2007);
              _2143 = min(abs(_1987), _2033);
            } else {
              _2139 = _2004;
              _2140 = _2005;
              _2141 = _2006;
        ...
        float _2157 = select(_1878, ((_nearFarProj.x - _1872) / _1875), _1764);
        float _2189 = mad((_viewProjRelative[2].z), _1859, mad((_viewProjRelative[2].y), _1858, ((_viewProjRelative[2].x) * _1857))) + (_viewProjRelative[2].w);
        float _2193 = mad((_viewProjRelative[3].z), _1859, mad((_viewProjRelative[3].y), _1858, ((_viewProjRelative[3].x) * _1857))) + (_viewProjRelative[3].w);
        float _2197 = (_2157 * _1735) + _1857;
        float _2198 = (_2157 * _1739) + _1858;
        float _2199 = (_2157 * _1743) + _1859;
        float _2215 = mad((_viewProjRelative[3].z), _2199, mad((_viewProjRelative[3].y), _2198, ((_viewProjRelative[3].x) * _2197))) + (_viewProjRelative[3].w);
        float _2216 = (mad((_viewProjRelative[0].z), _1859, mad((_viewProjRelative[0].y), _1858, ((_viewProjRelative[0].x) * _1857))) + (_viewProjRelative[0].w)) / _2193;
        float _2217 = (mad((_viewProjRelative[1].z), _1859, mad((_viewProjRelative[1].y), _1858, ((_viewProjRelative[1].x) * _1857))) + (_viewProjRelative[1].w)) / _2193;
        float _2218 = _2189 / _2193;
        float _2222 = ((mad((_viewProjRelative[0].z), _2199, mad((_viewProjRelative[0].y), _2198, ((_viewProjRelative[0].x) * _2197))) + (_viewProjRelative[0].w)) / _2215) - _2216;
        float _2223 = ((mad((_viewProjRelative[1].z), _2199, mad((_viewProjRelative[1].y), _2198, ((_viewProjRelative[1].x) * _2197))) + (_viewProjRelative[1].w)) / _2215) - _2217;
        float _2226 = 1.0f / float((uint)(uint)(_1744));
        float _2237 = max(_2226, (1.0f / min(1.0f, (max(((_bufferSizeAndInvSize.x * 0.5f) * abs(_2222)), ((_bufferSizeAndInvSize.y * 0.5f) * abs(_2223))) * _2226))));
        float _2238 = _2237 * (((mad((_viewProjRelative[2].z), _2199, mad((_viewProjRelative[2].y), _2198, ((_viewProjRelative[2].x) * _2197))) + (_viewProjRelative[2].w)) / _2215) - _2218);
        float _2257 = ((_1750 * 0.5f) * max(abs(_2238), (_2218 - ((mad((_proj[2].z), _113, 0.0f) + _2189) / (mad((_proj[3].z), _113, 0.0f) + _2193))))) * max(0.0625f, _2226);
        float _2258 = _2237 * _2226;
        float _2260 = (_2222 * 0.5f) * _2258;
        float _2262 = (_2223 * -0.5f) * _2258;
        float _2263 = _2238 * _2226;
        float _2270 = max(_1820, (1.0f / max((abs(_2260) * _bufferSizeAndInvSize.x), (abs(_2262) * _bufferSizeAndInvSize.y))));
        float _2277 = 0.5f / _bufferSizeAndInvSize.x;
        _2279 = 0;
        _2280 = _1770;
        _2281 = _1820;
        _2282 = (((_2216 * 0.5f) + 0.5f) + (_2270 * _2260));
        _2283 = ((0.5f - (_2217 * 0.5f)) + (_2270 * _2262));
        _2284 = ((_2270 * _2263) + _2218);
        _2285 = 0;
        _2286 = 1.0f;
        _2287 = 0.0f;
        while(true) {
          // RenoDX: >>> [Patch: ShadowEdgeNoiseFix] [Version: 1.09]
          // Description: Replaces the vanilla X clamp at this contact-shadow depth load. When a ray exits left/right, the clamp reuses the last screen column and can stretch or flicker shadows; the macro preserves vanilla when off and passes X through when on.
          uint _2296 = __3__36__0__0__g_depthStencil.Load(int3(int(SHADOW_CONTACT_SAMPLE_X(_2282, _2277) * _bufferSizeAndInvSize.x), int(_2283 * _bufferSizeAndInvSize.y), 0));
          // RenoDX: <<< [Patch: ShadowEdgeNoiseFix]
          int _2298 = (uint)((uint)(_2296.x)) >> 24;
          float _2301 = float((uint)((uint)(_2296.x & 16777215))) * 5.960465188081798e-08f;
          int _2302 = _2298 & 127;
          bool _2303 = (_2279 == 0);
          float _2304 = select(_2303, 1.0f, _2280);
          float _2305 = _2284 - _2301;
          float _2309 = _nearFarProj.x / max(1.0000000116860974e-07f, _2301);
          float _2312 = _2309 - (_nearFarProj.x / max(1.0000000116860974e-07f, _2284));
          bool _2315 = (abs(_2305 + _2257) < _2257);
          int _2316 = (int)(uint)((int)(_2315));
          if (_2315) {
            if (((_2302 == 7)) || ((((_2302 == 54)) || (((((_2298 & 126) == 66)) || (((((uint)(_2302 + -5) < (uint)2)) || ((((_2302 == 107)) || ((((_2302 == 26)) || (((((uint)(_2302 + -27) < (uint)2)) || ((((_2302 == 106)) || (((((_2298 & 125) == 105)) || ((((_2302 == 18)) || (((uint)(_2302 + -19) < (uint)2))))))))))))))))))))) {
              _2350 = true;
              _2357 = ((int)(uint)((int)(((_2312 < 0.0f)) && ((_2312 > select(_2350, -0.07999999821186066f, -1.0f))))));
            } else {
              if ((uint)(_2302 + -53) < (uint)14) {
                _2350 = (_2309 < 32.0f);
                _2357 = ((int)(uint)((int)(((_2312 < 0.0f)) && ((_2312 > select(_2350, -0.07999999821186066f, -1.0f))))));
              } else {
                _2357 = _2316;
          ...
          if (!(_2357 == 0)) {
            if ((uint)_2302 > (uint)11) {
              if (!((uint)_2302 < (uint)18)) {
                if (!(((_2302 == 18)) || ((((_2302 == 107)) || (((uint)(_2302 + -19) < (uint)2)))))) {
                  if (!(_2302 == 66)) {
                    _2376 = 0.0f;
                  } else {
                    _2376 = 0.10000000149011612f;
                  }
                } else {
                  _2376 = 0.15000000596046448f;
                }
              } else {
                _2376 = 0.10000000149011612f;
              }
            ...
            float _2378 = saturate(_2309 * 0.015625f);
            float _2381 = (1.0f - _2378) + (_2378 * _2376);
            _2391 = _2302;
            float _rndx_microFarAccum = saturate(1.0f - ((_2381 * _2381) * _2376));
            _2392 = saturate((_rndx_microFarAccum * lerp(1.0f, 0.7f, CONTACT_SHADOW_BASE_TUNING) * (1.0f - _2287)) + _2287);
          } else {
            _2391 = _2285;
            _2392 = _2287;
          }
          [branch]
          if (_2392 > 0.949999988079071f) {
            if (!_2303) {
              _2423 = (saturate(_2286 / (_2286 - _2305)) - min(_2281, _2304));
            } else {
              _2423 = 0.0f;
            }
            _2433 = _2302;
            _2434 = _2392;
            _2435 = ((_2423 * _2260) + _2282);
            _2436 = ((_2423 * _2262) + _2283);
            _2437 = ((_2423 * _2263) + _2284);
            _2438 = _2301;
          } else {
            if ((uint)_2279 < (uint)(_1744 + -1)) {
              _2415 = (_2281 + _2304);
              _2416 = (_2282 + (_2304 * _2260));
              _2417 = (_2283 + (_2304 * _2262));
              _2418 = (_2284 + (_2304 * _2263));
              _2419 = min(abs(_2263), _2305);
            } else {
              _2415 = _2281;
              _2416 = _2282;
              _2417 = _2283;
      ...
      bool _2442 = (_2434 > 0.0f);
      if (_2437 > 0.0f) {
        if ((_2442) || ((((((_2435 >= 0.0f)) && ((_2435 <= 1.0f)))) && ((((_2436 >= 0.0f)) && ((_2436 <= 1.0f))))))) {
          float _2456 = (_2435 * 2.0f) + -1.0f;
          float _2457 = 1.0f - (_2436 * 2.0f);
          float _2473 = mad((_invViewProjRelative[3].z), _2437, mad((_invViewProjRelative[3].y), _2457, (_2456 * (_invViewProjRelative[3].x)))) + (_invViewProjRelative[3].w);
          if (!(_2433 == 2)) {
            if (_2433 == 3) {
              _2499 = 0.0f;
              _2501 = _2499;
          ...
          if (!((_168) || ((!(_2434 == 1.0f))))) {
            _2525 = saturate(((((_1764 * 0.9375f) - max(0.0f, dot(float3(_1735, _1739, _1743), float3((((mad((_invViewProjRelative[0].z), _2437, mad((_invViewProjRelative[0].y), _2457, (_2456 * (_invViewProjRelative[0].x)))) + (_invViewProjRelative[0].w)) / _2473) - _1857), (((mad((_invViewProjRelative[1].z), _2437, mad((_invViewProjRelative[1].y), _2457, (_2456 * (_invViewProjRelative[1].x)))) + (_invViewProjRelative[1].w)) / _2473) - _1858), (((mad((_invViewProjRelative[2].z), _2437, mad((_invViewProjRelative[2].y), _2457, (_2456 * (_invViewProjRelative[2].x)))) + (_invViewProjRelative[2].w)) / _2473) - _1859))))) * ((_113 * 0.015625f) + 1.5f)) / _1764) * 0.9375f);
          } else {
            _2525 = _2434;
          }
          float _2526 = _2525 * saturate(exp2(min(0.0f, (((_113 * 0.01899999938905239f) + 0.10000000149011612f) + (_2501 * ((_nearFarProj.x / max(1.0000000116860974e-07f, _2438)) - (_nearFarProj.x / max(1.0000000116860974e-07f, _2437)))))) * 1.4426950216293335f));
          int _2527 = _2433 & -2;
          if (!(_2527 == 6)) {
            bool __defer_2529_2539 = false;
            if ((((_78 == 33) && (_2433 == 33)) || (!(_78 == 33) && (((_78 == 55)) && ((_2433 == 55)))))) {
              _2601 = (_2526 * 0.009999999776482582f);
            } else {
              __defer_2529_2539 = true;
            }
            if (__defer_2529_2539) {
              if (!(((_2433 == 54)) || ((_2527 == 66))) || ((((_2433 == 54)) || ((_2527 == 66))) && (!(((_1630 == 66)) || ((_78 == 54)))))) {
                if (!_170) {
                  if ((uint)((int)((uint)(_2433) + (uint)(-53))) < (uint)15) {
                    _2598 = saturate(_113 * 0.03125f);
                  } else {
                    _2598 = 1.0f;
                  }
                  _2601 = (_2598 * _2526);
                ...
                uint4 _2553 = __3__36__0__0__g_baseColor.Load(int3(int(_2435 * _bufferSizeAndInvSize.x), int(_2436 * _bufferSizeAndInvSize.y), 0));
                float _2559 = float((uint)((uint)(((uint)((uint)(_2553.x)) >> 8) & 255))) * 0.003921568859368563f;
                float _2562 = float((uint)((uint)(_2553.x & 255))) * 0.003921568859368563f;
                float _2566 = float((uint)((uint)(((uint)((uint)(_2553.y)) >> 8) & 255))) * 0.003921568859368563f;
                float _2567 = _2559 * _2559;
                float _2568 = _2562 * _2562;
                float _2569 = _2566 * _2566;
                _2601 = (saturate(1.0f - (dot(float3((((_2567 * 0.6131200194358826f) + (_2568 * 0.3395099937915802f)) + (_2569 * 0.047370001673698425f)), (((_2567 * 0.07020000368356705f) + (_2568 * 0.9163600206375122f)) + (_2569 * 0.013450000435113907f)), (((_2567 * 0.02061999961733818f) + (_2568 * 0.10958000272512436f)) + (_2569 * 0.8697999715805054f))), float3(0.21267099678516388f, 0.7151600122451782f, 0.0721689984202385f)) * 0.875f)) * _2526);
              }
            }
          } else {
            _2601 = (_2526 * 0.009999999776482582f);
    ...
    if (CONTACT_SHADOW_DETAIL_PATH == 1.f && _2605 < 1.0f) {
      ...
      _2605 = lerp(lerp(1.0f, _2605, 0.5f), _2605, _edgeFade);
    }

    float _2606 = min(_1620, _2605);
    _2620 = float(half(_2606 * float(_1596)));
    _2621 = float(half(_2606 * float(_1597)));
    _2622 = float(half(_2606 * float(_1598)));
    _2623 = saturate((1.0f - _554) + (exp2(log2(saturate(select(_170, (_1605 + 0.9800000190734863f), _1605))) * 0.45454543828964233f) * _554));
  }
  __3__38__0__1__g_shadowColorResultUAV[int2(((int)(((uint)(((((int)((uint)(_44) << 2)) & 1020) | ((int)(SV_GroupID.x) & 3)) << 3)) + SV_GroupThreadID.x)), ((int)(((uint)(((((uint)((uint)(_44)) >> 6) & 1020) | (((uint)(SV_GroupID.x) >> 2) & 3)) << 3)) + SV_GroupThreadID.y)))] = half4(half(_2620), half(_2621), half(_2622), half(_2623));
}
