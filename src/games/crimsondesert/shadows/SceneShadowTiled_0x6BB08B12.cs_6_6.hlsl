...
#define SHADOW_DBG_CONTACT_INV  _3076
#define SHADOW_DBG_OUT_R        _3091
#define SHADOW_DBG_OUT_G        _3092
#define SHADOW_DBG_OUT_B        _3093
#define SHADOW_DBG_OUT_A        _3094
...
void main(
  ...
  if (((int)(_76 < 1.0000000116860974e-07f)) | (_104)) {
    ...
    // RenoDX: Terrain shadow boundary fade — eliminates hard pop-in at shadow map edge (doesnt seem to help much)
    if (SHADOW_QUALITY > 0.5f && _553 < 1.0f) {
    ...
    if (_1935 > 0.0f) {
      ...
      float _2052 = mad(_2028, _1965, mad(_2035, _2042, ((((_2043 * _1965) * _2040) + 1.0f) * _2034)));
      float _2056 = mad(_2028, _1966, mad(_2035, (_2037 + (_2041 * _1966)), ((_2034 * _2037) * _2042)));
      float _2060 = mad(_2028, _1967, mad(_2035, (-0.0f - _1966), (-0.0f - (_2043 * _2034))));
      ...
      if ((_1947) | (((int)(((int)(_77 != 15)) & ((int)((uint)(_77 + -12) < (uint)7)))))) {
        ...
        if (_77 == 15) {
          _2268 = ((10.0f - (saturate(_112 * 0.0010000000474974513f) * 9.0f)) * _2255);
        } else {
          _2268 = _2255;
        }
      }
      ...
      if (_112 < 8.0f) {
        ...
        if (CONTACT_SHADOW_QUALITY > 0.5f) { _2416 *= (8.0f / 60.0f); _2418 *= (8.0f / 60.0f); _2419 *= (8.0f / 60.0f); }
        ...
        while(true) {
          ...
          if (!(_2513 == 0)) {
              ...
              if (!(((int)((uint)_2458 < (uint)16)) | ((int)(_2458 == 17)))) {
                if (!(_2458 == 16)) {
                  if (!(((int)(_2458 == 18)) | (((int)(((int)(_2458 == 107)) | ((int)((uint)(_2458 + -19) < (uint)2))))))) {
                    ...
                    _2536 = 0.4000000059604645f;
                  }
                } else {
                  _2536 = 0.10000000149011612f;
                }
              } else {
                _2536 = 0.30000001192092896f;
              }
            } else {
              if (!(_2458 == 11)) {
                _2536 = 0.0f;
            ...
            if (_169) {
              _2552 = saturate((-0.0f - _2468) / (_2439 * 0.004654859658330679f));
            } else {
              _2552 = 1.0f;
            }
            _2559 = _2458;
            _2560 = saturate(((saturate(1.0f - ((_2541 * _2541) * _2536)) * (1.0f - _2443)) * _2552) + _2443);
          } else {
            _2559 = _2435;
            _2560 = _2443;
          }
          [branch]
          if (_2560 > 0.949999988079071f) {
            if (!_2459) {
              _2590 = (saturate(_2442 / (_2442 - _2465)) - min(_2439, _2460));
            } else {
              _2590 = 0.0f;
            }
            _2882 = _2458;
            _2883 = _2560;
            _2884 = ((_2590 * _2416) + _2436);
            _2885 = ((_2590 * _2418) + _2437);
            _2886 = ((_2590 * _2419) + _2438);
            _2887 = _2457;
          } else {
            if ((uint)_2441 < ((CONTACT_SHADOW_QUALITY > 0.5f) ? (uint)59 : (uint)7)) {
              _2582 = ((_2460 * _2416) + _2436);
              _2583 = ((_2460 * _2418) + _2437);
              _2584 = ((_2460 * _2419) + _2438);
              _2585 = (_2460 + _2439);
              _2586 = min(abs(_2419), _2465);
            } else {
              _2582 = _2436;
              _2583 = _2437;
              _2584 = _2438;
            ...
            int _2587 = _2441 + 1;
            if ((uint)_2587 < ((CONTACT_SHADOW_QUALITY > 0.5f) ? (uint)60 : (uint)8)) {
              _2435 = _2559;
              _2436 = _2582;
              _2437 = _2583;
              _2438 = _2584;
        ...
        float _2600 = select(_2314, ((_nearFarProj.x - _2306) / _2309), _2077);
        float _2632 = mad((float4(_viewProjRelative[0].z, _viewProjRelative[1].z, _viewProjRelative[2].z, _viewProjRelative[3].z).z), _2293, mad((float4(_viewProjRelative[0].y, _viewProjRelative[1].y, _viewProjRelative[2].y, _viewProjRelative[3].y).z), _2292, ((float4(_viewProjRelative[0].x, _viewProjRelative[1].x, _viewProjRelative[2].x, _viewProjRelative[3].x).z) * _2291))) + (float4(_viewProjRelative[0].w, _viewProjRelative[1].w, _viewProjRelative[2].w, _viewProjRelative[3].w).z);
        float _2636 = mad((float4(_viewProjRelative[0].z, _viewProjRelative[1].z, _viewProjRelative[2].z, _viewProjRelative[3].z).w), _2293, mad((float4(_viewProjRelative[0].y, _viewProjRelative[1].y, _viewProjRelative[2].y, _viewProjRelative[3].y).w), _2292, ((float4(_viewProjRelative[0].x, _viewProjRelative[1].x, _viewProjRelative[2].x, _viewProjRelative[3].x).w) * _2291))) + (float4(_viewProjRelative[0].w, _viewProjRelative[1].w, _viewProjRelative[2].w, _viewProjRelative[3].w).w);
        float _2640 = (_2600 * _2052) + _2291;
        float _2641 = (_2600 * _2056) + _2292;
        float _2642 = (_2600 * _2060) + _2293;
        float _2658 = mad((float4(_viewProjRelative[0].z, _viewProjRelative[1].z, _viewProjRelative[2].z, _viewProjRelative[3].z).w), _2642, mad((float4(_viewProjRelative[0].y, _viewProjRelative[1].y, _viewProjRelative[2].y, _viewProjRelative[3].y).w), _2641, ((float4(_viewProjRelative[0].x, _viewProjRelative[1].x, _viewProjRelative[2].x, _viewProjRelative[3].x).w) * _2640))) + (float4(_viewProjRelative[0].w, _viewProjRelative[1].w, _viewProjRelative[2].w, _viewProjRelative[3].w).w);
        float _2659 = (mad((float4(_viewProjRelative[0].z, _viewProjRelative[1].z, _viewProjRelative[2].z, _viewProjRelative[3].z).x), _2293, mad((float4(_viewProjRelative[0].y, _viewProjRelative[1].y, _viewProjRelative[2].y, _viewProjRelative[3].y).x), _2292, ((float4(_viewProjRelative[0].x, _viewProjRelative[1].x, _viewProjRelative[2].x, _viewProjRelative[3].x).x) * _2291))) + (float4(_viewProjRelative[0].w, _viewProjRelative[1].w, _viewProjRelative[2].w, _viewProjRelative[3].w).x)) / _2636;
        float _2660 = (mad((float4(_viewProjRelative[0].z, _viewProjRelative[1].z, _viewProjRelative[2].z, _viewProjRelative[3].z).y), _2293, mad((float4(_viewProjRelative[0].y, _viewProjRelative[1].y, _viewProjRelative[2].y, _viewProjRelative[3].y).y), _2292, ((float4(_viewProjRelative[0].x, _viewProjRelative[1].x, _viewProjRelative[2].x, _viewProjRelative[3].x).y) * _2291))) + (float4(_viewProjRelative[0].w, _viewProjRelative[1].w, _viewProjRelative[2].w, _viewProjRelative[3].w).y)) / _2636;
        float _2661 = _2632 / _2636;
        float _2665 = ((mad((float4(_viewProjRelative[0].z, _viewProjRelative[1].z, _viewProjRelative[2].z, _viewProjRelative[3].z).x), _2642, mad((float4(_viewProjRelative[0].y, _viewProjRelative[1].y, _viewProjRelative[2].y, _viewProjRelative[3].y).x), _2641, ((float4(_viewProjRelative[0].x, _viewProjRelative[1].x, _viewProjRelative[2].x, _viewProjRelative[3].x).x) * _2640))) + (float4(_viewProjRelative[0].w, _viewProjRelative[1].w, _viewProjRelative[2].w, _viewProjRelative[3].w).x)) / _2658) - _2659;
        float _2666 = ((mad((float4(_viewProjRelative[0].z, _viewProjRelative[1].z, _viewProjRelative[2].z, _viewProjRelative[3].z).y), _2642, mad((float4(_viewProjRelative[0].y, _viewProjRelative[1].y, _viewProjRelative[2].y, _viewProjRelative[3].y).y), _2641, ((float4(_viewProjRelative[0].x, _viewProjRelative[1].x, _viewProjRelative[2].x, _viewProjRelative[3].x).y) * _2640))) + (float4(_viewProjRelative[0].w, _viewProjRelative[1].w, _viewProjRelative[2].w, _viewProjRelative[3].w).y)) / _2658) - _2660;
        float _2678 = max(0.125f, (1.0f / min(1.0f, (max(((_bufferSizeAndInvSize.x * 0.5f) * abs(_2665)), ((_bufferSizeAndInvSize.y * 0.5f) * abs(_2666))) * 0.125f))));
        float _2679 = _2678 * (((mad((float4(_viewProjRelative[0].z, _viewProjRelative[1].z, _viewProjRelative[2].z, _viewProjRelative[3].z).z), _2642, mad((float4(_viewProjRelative[0].y, _viewProjRelative[1].y, _viewProjRelative[2].y, _viewProjRelative[3].y).z), _2641, ((float4(_viewProjRelative[0].x, _viewProjRelative[1].x, _viewProjRelative[2].x, _viewProjRelative[3].x).z) * _2640))) + (float4(_viewProjRelative[0].w, _viewProjRelative[1].w, _viewProjRelative[2].w, _viewProjRelative[3].w).z)) / _2658) - _2661);
        float _2696 = (_2063 * 0.0625f) * max(abs(_2679), (_2661 - ((mad((float4(_proj[0].z, _proj[1].z, _proj[2].z, _proj[3].z).z), _112, 0.0f) + _2632) / (mad((float4(_proj[0].z, _proj[1].z, _proj[2].z, _proj[3].z).w), _112, 0.0f) + _2636))));
        float _2698 = (_2665 * 0.0625f) * _2678;
        float _2700 = (_2666 * -0.0625f) * _2678;
        float _2701 = _2679 * 0.125f;
        // RenoDX: scale step sizes so 60 steps cover same distance as vanilla 8
        if (CONTACT_SHADOW_QUALITY > 0.5f) { _2698 *= (8.0f / 60.0f); _2700 *= (8.0f / 60.0f); _2701 *= (8.0f / 60.0f); }
        float _2708 = max(_2268, (1.0f / max((abs(_2698) * _bufferSizeAndInvSize.x), (abs(_2700) * _bufferSizeAndInvSize.y))));
        float _2715 = 0.5f / _bufferSizeAndInvSize.x;
        _2717 = 0;
        _2718 = _2083;
        _2719 = _2268;
        _2720 = (((_2659 * 0.5f) + 0.5f) + (_2708 * _2698));
        _2721 = ((0.5f - (_2660 * 0.5f)) + (_2708 * _2700));
        _2722 = ((_2708 * _2701) + _2661);
        _2723 = 0;
        _2724 = 1.0f;
        _2725 = 0.0f;
        while(true) {
          uint _2734 = __3__36__0__0__g_depthStencil.Load(int3(int(min(max(_2720, _2715), (1.0f - _2715)) * _bufferSizeAndInvSize.x), int(_2721 * _bufferSizeAndInvSize.y), 0));
          int _2736 = (uint)((uint)(_2734.x)) >> 24;
          float _2739 = float((uint)((uint)(_2734.x & 16777215))) * 5.960465188081798e-08f;
          int _2740 = _2736 & 127;
          bool _2741 = (_2717 == 0);
          float _2742 = select(_2741, 1.0f, _2718);
          float _2743 = _2722 - _2739;
          float _2747 = _nearFarProj.x / max(1.0000000116860974e-07f, _2739);
          float _2750 = _2747 - (_nearFarProj.x / max(1.0000000116860974e-07f, _2722));
          bool _2753 = (abs(_2743 + _2696) < _2696);
          int _2754 = (int)(uint)(_2753);
          if (_2753) {
            if (!(((int)(_2740 == 7)) | (((int)(((int)(_2740 == 54)) | (((int)(((int)((_2736 & 126) == 66)) | (((int)(((int)((uint)(_2740 + -5) < (uint)2)) | (((int)(((int)(_2740 == 107)) | (((int)(((int)(_2740 == 26)) | (((int)(((int)((uint)(_2740 + -27) < (uint)2)) | (((int)(((int)(_2740 == 106)) | (((int)(((int)((_2736 & 125) == 105)) | (((int)(((int)(_2740 == 18)) | ((int)((uint)(_2740 + -19) < (uint)2))))))))))))))))))))))))))))))) {
              if ((uint)(_2740 + -53) < (uint)14) {
                _2788 = (_2747 < 32.0f);
                _2795 = ((int)(uint)((int)(((int)(_2750 < 0.0f)) & ((int)(_2750 > select(_2788, -0.07999999821186066f, -1.0f))))));
              } else {
                _2795 = _2754;
              }
            } else {
          ...
          if (!(_2795 == 0)) {
            if ((uint)_2740 > (uint)11) {
              if (!(((int)((uint)_2740 < (uint)16)) | ((int)(_2740 == 17)))) {
                if (!(_2740 == 16)) {
                  if (!(((int)(_2740 == 18)) | (((int)(((int)(_2740 == 107)) | ((int)((uint)(_2740 + -19) < (uint)2))))))) {
                    if (!(_2740 == 66)) {
                      _2818 = 0.0f;
                    } else {
                      _2818 = 0.10000000149011612f;
                    }
                  } else {
                    _2818 = 0.4000000059604645f;
                  }
                } else {
                  _2818 = 0.10000000149011612f;
                }
              } else {
                _2818 = 0.30000001192092896f;
              }
            } else {
              if (!(_2740 == 11)) {
                _2818 = 0.0f;
            ...
            float _2820 = saturate(_2747 * 0.015625f);
            float _2823 = (1.0f - _2820) + (_2820 * _2818);
            if (_169) {
              _2834 = saturate((-0.0f - _2750) / (_2719 * 0.004654859658330679f));
            } else {
              _2834 = 1.0f;
            }
            _2841 = _2740;
            _2842 = saturate(((saturate(1.0f - ((_2823 * _2823) * _2818)) * (1.0f - _2725)) * _2834) + _2725);
          } else {
            _2841 = _2723;
            _2842 = _2725;
          }
          [branch]
          if (_2842 > 0.949999988079071f) {
            if (!_2741) {
              _2872 = (saturate(_2724 / (_2724 - _2743)) - min(_2719, _2742));
            } else {
              _2872 = 0.0f;
            }
            _2882 = _2740;
            _2883 = _2842;
            _2884 = ((_2872 * _2698) + _2720);
            _2885 = ((_2872 * _2700) + _2721);
            _2886 = ((_2872 * _2701) + _2722);
            _2887 = _2739;
          } else {
            if ((uint)_2717 < ((CONTACT_SHADOW_QUALITY > 0.5f) ? (uint)59 : (uint)7)) {
              _2864 = (_2719 + _2742);
              _2865 = (_2720 + (_2742 * _2698));
              _2866 = (_2721 + (_2742 * _2700));
              _2867 = (_2722 + (_2742 * _2701));
              _2868 = min(abs(_2701), _2743);
            } else {
              _2864 = _2719;
              _2865 = _2720;
              _2866 = _2721;
            ...
            int _2869 = _2717 + 1;
            if ((uint)_2869 < ((CONTACT_SHADOW_QUALITY > 0.5f) ? (uint)60 : (uint)8)) {
              _2717 = _2869;
              _2718 = _2742;
              _2719 = _2864;
              _2720 = _2865;
      ...
      bool _2891 = (_2883 > 0.0f);
      if (_2886 > 0.0f) {
        if ((_2891) | (((int)((((int)(((int)(_2884 >= 0.0f)) & ((int)(_2884 <= 1.0f))))) & (((int)(((int)(_2885 >= 0.0f)) & ((int)(_2885 <= 1.0f))))))))) {
          float _2905 = (_2884 * 2.0f) + -1.0f;
          float _2906 = 1.0f - (_2885 * 2.0f);
          float _2942 = mad((float4(_invViewProjRelative[0].z, _invViewProjRelative[1].z, _invViewProjRelative[2].z, _invViewProjRelative[3].z).w), _2886, mad((float4(_invViewProjRelative[0].y, _invViewProjRelative[1].y, _invViewProjRelative[2].y, _invViewProjRelative[3].y).w), _2906, ((float4(_invViewProjRelative[0].x, _invViewProjRelative[1].x, _invViewProjRelative[2].x, _invViewProjRelative[3].x).w) * _2905))) + (float4(_invViewProjRelative[0].w, _invViewProjRelative[1].w, _invViewProjRelative[2].w, _invViewProjRelative[3].w).w);
          if (!(_2882 == 2)) {
            if (!(_2882 == 3)) {
              if (!(_2882 == 21)) {
                bool _2961 = (_2882 == 22);
                if (!(((int)(_77 == 22)) & (_2961))) {
                  _2968 = select(_2961, 0.0f, 1.0f);
                  _2970 = _2968;
                } else {
                  _2970 = 20.0f;
                }
          ...
          if (_2883 == 1.0f) {
            _2993 = saturate(((((_2077 * 0.9375f) - max(0.0f, dot(float3(_2052, _2056, _2060), float3((((mad((float4(_invViewProjRelative[0].z, _invViewProjRelative[1].z, _invViewProjRelative[2].z, _invViewProjRelative[3].z).x), _2886, mad((float4(_invViewProjRelative[0].y, _invViewProjRelative[1].y, _invViewProjRelative[2].y, _invViewProjRelative[3].y).x), _2906, ((float4(_invViewProjRelative[0].x, _invViewProjRelative[1].x, _invViewProjRelative[2].x, _invViewProjRelative[3].x).x) * _2905))) + (float4(_invViewProjRelative[0].w, _invViewProjRelative[1].w, _invViewProjRelative[2].w, _invViewProjRelative[3].w).x)) / _2942) - _2291), (((mad((float4(_invViewProjRelative[0].z, _invViewProjRelative[1].z, _invViewProjRelative[2].z, _invViewProjRelative[3].z).y), _2886, mad((float4(_invViewProjRelative[0].y, _invViewProjRelative[1].y, _invViewProjRelative[2].y, _invViewProjRelative[3].y).y), _2906, ((float4(_invViewProjRelative[0].x, _invViewProjRelative[1].x, _invViewProjRelative[2].x, _invViewProjRelative[3].x).y) * _2905))) + (float4(_invViewProjRelative[0].w, _invViewProjRelative[1].w, _invViewProjRelative[2].w, _invViewProjRelative[3].w).y)) / _2942) - _2292), (((mad((float4(_invViewProjRelative[0].z, _invViewProjRelative[1].z, _invViewProjRelative[2].z, _invViewProjRelative[3].z).z), _2886, mad((float4(_invViewProjRelative[0].y, _invViewProjRelative[1].y, _invViewProjRelative[2].y, _invViewProjRelative[3].y).z), _2906, ((float4(_invViewProjRelative[0].x, _invViewProjRelative[1].x, _invViewProjRelative[2].x, _invViewProjRelative[3].x).z) * _2905))) + (float4(_invViewProjRelative[0].w, _invViewProjRelative[1].w, _invViewProjRelative[2].w, _invViewProjRelative[3].w).z)) / _2942) - _2293))))) * ((_112 * 0.015625f) + 1.5f)) / _2077) * 0.9375f);
          } else {
            _2993 = _2883;
          }
          float _2994 = _2993 * saturate(exp2(min(0.0f, (((_112 * 0.01899999938905239f) + 0.10000000149011612f) + (_2970 * ((_nearFarProj.x / max(1.0000000116860974e-07f, _2887)) - (_nearFarProj.x / max(1.0000000116860974e-07f, _2886)))))) * 1.4426950216293335f));
          int _2995 = _2882 & -2;
          if (!(_2995 == 6)) {
            if ((((_77 == 33) && (_2882 == 33)) || (!(_77 == 33) && (((int)(_77 == 55)) & ((int)(_2882 == 55)))))) {
              _3072 = (_2994 * 0.009999999776482582f);
            } else {
              if (!(((int)(_2882 == 54)) | ((int)(_2995 == 66))) || ((((int)(_2882 == 54)) | ((int)(_2995 == 66))) && (!(((int)(_1945 == 66)) | ((int)(_77 == 54)))))) {
                if (!_169) {
                  if ((uint)((int)(_2882 + -53u)) < (uint)15) {
                    _3069 = saturate(_112 * 0.03125f);
                  } else {
                    _3069 = 1.0f;
                  }
                  _3072 = (_3069 * _2994);
                ...
                uint4 _3024 = __3__36__0__0__g_baseColor.Load(int3(int(_bufferSizeAndInvSize.x * _2884), int(_bufferSizeAndInvSize.y * _2885), 0));
                float _3030 = float((uint)((uint)(((uint)((uint)(_3024.x)) >> 8) & 255))) * 0.003921568859368563f;
                float _3033 = float((uint)((uint)(_3024.x & 255))) * 0.003921568859368563f;
                float _3037 = float((uint)((uint)(((uint)((uint)(_3024.y)) >> 8) & 255))) * 0.003921568859368563f;
                float _3038 = _3030 * _3030;
                float _3039 = _3033 * _3033;
                float _3040 = _3037 * _3037;
                _3072 = (saturate(1.0f - (dot(float3((((_3038 * 0.6131200194358826f) + (_3039 * 0.3395099937915802f)) + (_3040 * 0.047370001673698425f)), (((_3038 * 0.07020000368356705f) + (_3039 * 0.9163600206375122f)) + (_3040 * 0.013450000435113907f)), (((_3038 * 0.02061999961733818f) + (_3039 * 0.10958000272512436f)) + (_3040 * 0.8697999715805054f))), float3(0.21267099678516388f, 0.7151600122451782f, 0.0721689984202385f)) * 0.875f)) * _2994);
              }
            }
          } else {
            _3072 = (_2994 * 0.009999999776482582f);
      ...
      _3076 = saturate(1.0f - _3072);
    } else {
      _3076 = 1.0f;
    }
    float _3077 = min(_1935, _3076);
    _3091 = float(half(_3077 * float(_1595)));
    _3092 = float(half(_3077 * float(_1596)));
    _3093 = float(half(_3077 * float(_1597)));
    _3094 = saturate((1.0f - _553) + (exp2(log2(saturate(_1922)) * 0.45454543828964233f) * _553));
    // ── RenoDX Shadow Debug ──────────────────────────────────────────────
    #include "shadow_debug.hlsli"
    // ────────────────────────────────────────────────────────────────────
  }
  __3__38__0__1__g_shadowColorResultUAV[int2(_55, _56)] = half4((float)(half(_3091)), (float)(half(_3092)), (float)(half(_3093)), (float)(half(_3094)));
}
