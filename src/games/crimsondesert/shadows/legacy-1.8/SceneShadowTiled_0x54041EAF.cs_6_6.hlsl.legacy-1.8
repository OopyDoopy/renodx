...
void main(
  ...
  if (((_79 < 1.0000000116860974e-07f)) || (_107)) {
    ...
    if (_3178 > 0.0f) {
      ...
      if (_115 < 8.0f) {
        ...
        while(true) {
          ...
          if (!(_3778 == 0)) {
            ...
            if (_172) {
              _3813 = saturate((-0.0f - _3733) / (_3704 * 0.004654859658330679f));
            } else {
              _3813 = 1.0f;
            }
            _3820 = _3723;
            float _microNearAccum = (saturate(1.0f - ((_3802 * _3802) * _3797)) * (1.0f - _3708)) * _3813;
            _3821 = saturate((_microNearAccum * lerp(1.0f, CONTACT_SHADOW_RT_ACCUM_STRENGTH, CONTACT_SHADOW_RT_TUNING)) + _3708);
          } else {
            _3820 = _3700;
            _3821 = _3708;
          }
          [branch]
          if (_3821 > 0.949999988079071f) {
            if (!_3724) {
              _3852 = (saturate(_3707 / (_3707 - _3730)) - min(_3704, _3725));
            } else {
              _3852 = 0.0f;
            }
            _4146 = _3723;
            _4147 = _3821;
            _4148 = ((_3852 * _3681) + _3701);
            _4149 = ((_3852 * _3683) + _3702);
            _4150 = ((_3852 * _3684) + _3703);
            _4151 = _3722;
          } else {
            if ((uint)_3706 < (uint)(_3304 + -1)) {
              _3844 = ((_3725 * _3681) + _3701);
              _3845 = ((_3725 * _3683) + _3702);
              _3846 = ((_3725 * _3684) + _3703);
              _3847 = (_3725 + _3704);
              _3848 = min(abs(_3684), _3730);
            } else {
              _3844 = _3701;
              _3845 = _3702;
              _3846 = _3703;
        ...
        float _3862 = select(_3575, ((_nearFarProj.x - _3567) / _3570), _3324);
        float _3894 = mad((_viewProjRelative[2].z), _3554, mad((_viewProjRelative[2].y), _3553, ((_viewProjRelative[2].x) * _3552))) + (_viewProjRelative[2].w);
        float _3898 = mad((_viewProjRelative[3].z), _3554, mad((_viewProjRelative[3].y), _3553, ((_viewProjRelative[3].x) * _3552))) + (_viewProjRelative[3].w);
        float _3902 = (_3862 * _3295) + _3552;
        float _3903 = (_3862 * _3299) + _3553;
        float _3904 = (_3862 * _3303) + _3554;
        float _3920 = mad((_viewProjRelative[3].z), _3904, mad((_viewProjRelative[3].y), _3903, ((_viewProjRelative[3].x) * _3902))) + (_viewProjRelative[3].w);
        float _3921 = (mad((_viewProjRelative[0].z), _3554, mad((_viewProjRelative[0].y), _3553, ((_viewProjRelative[0].x) * _3552))) + (_viewProjRelative[0].w)) / _3898;
        float _3922 = (mad((_viewProjRelative[1].z), _3554, mad((_viewProjRelative[1].y), _3553, ((_viewProjRelative[1].x) * _3552))) + (_viewProjRelative[1].w)) / _3898;
        float _3923 = _3894 / _3898;
        float _3927 = ((mad((_viewProjRelative[0].z), _3904, mad((_viewProjRelative[0].y), _3903, ((_viewProjRelative[0].x) * _3902))) + (_viewProjRelative[0].w)) / _3920) - _3921;
        float _3928 = ((mad((_viewProjRelative[1].z), _3904, mad((_viewProjRelative[1].y), _3903, ((_viewProjRelative[1].x) * _3902))) + (_viewProjRelative[1].w)) / _3920) - _3922;
        float _3931 = 1.0f / float((uint)(uint)(_3304));
        float _3942 = max(_3931, (1.0f / min(1.0f, (max(((_bufferSizeAndInvSize.x * 0.5f) * abs(_3927)), ((_bufferSizeAndInvSize.y * 0.5f) * abs(_3928))) * _3931))));
        float _3943 = _3942 * (((mad((_viewProjRelative[2].z), _3904, mad((_viewProjRelative[2].y), _3903, ((_viewProjRelative[2].x) * _3902))) + (_viewProjRelative[2].w)) / _3920) - _3923);
        float _3962 = ((_3310 * 0.5f) * max(abs(_3943), (_3923 - ((mad((_proj[2].z), _115, 0.0f) + _3894) / (mad((_proj[3].z), _115, 0.0f) + _3898))))) * max(0.0625f, _3931);
        float _3963 = _3942 * _3931;
        float _3965 = (_3927 * 0.5f) * _3963;
        float _3967 = (_3928 * -0.5f) * _3963;
        float _3968 = _3943 * _3931;
        float _3975 = max(_3515, (1.0f / max((abs(_3965) * _bufferSizeAndInvSize.x), (abs(_3967) * _bufferSizeAndInvSize.y))));
        float _3982 = 0.5f / _bufferSizeAndInvSize.x;
        _3984 = 0;
        _3985 = _3330;
        _3986 = _3515;
        _3987 = (((_3921 * 0.5f) + 0.5f) + (_3975 * _3965));
        _3988 = ((0.5f - (_3922 * 0.5f)) + (_3975 * _3967));
        _3989 = ((_3975 * _3968) + _3923);
        _3990 = 0;
        _3991 = 1.0f;
        _3992 = 0.0f;
        while(true) {
          uint _4001 = __3__36__0__0__g_depthStencil.Load(int3(int(min(max(_3987, _3982), (1.0f - _3982)) * _bufferSizeAndInvSize.x), int(_3988 * _bufferSizeAndInvSize.y), 0));
          int _4003 = (uint)((uint)(_4001.x)) >> 24;
          float _4006 = float((uint)((uint)(_4001.x & 16777215))) * 5.960465188081798e-08f;
          int _4007 = _4003 & 127;
          bool _4008 = (_3984 == 0);
          float _4009 = select(_4008, 1.0f, _3985);
          float _4010 = _3989 - _4006;
          float _4014 = _nearFarProj.x / max(1.0000000116860974e-07f, _4006);
          float _4017 = _4014 - (_nearFarProj.x / max(1.0000000116860974e-07f, _3989));
          bool _4020 = (abs(_4010 + _3962) < _3962);
          int _4021 = (int)(uint)((int)(_4020));
          if (_4020) {
            if (((_4007 == 7)) || ((((_4007 == 54)) || (((((_4003 & 126) == 66)) || (((((uint)(_4007 + -5) < (uint)2)) || ((((_4007 == 107)) || ((((_4007 == 26)) || (((((uint)(_4007 + -27) < (uint)2)) || ((((_4007 == 106)) || (((((_4003 & 125) == 105)) || ((((_4007 == 18)) || (((uint)(_4007 + -19) < (uint)2))))))))))))))))))))) {
              _4055 = true;
              _4062 = ((int)(uint)((int)(((_4017 < 0.0f)) && ((_4017 > select(_4055, -0.07999999821186066f, -1.0f))))));
            } else {
              if ((uint)(_4007 + -53) < (uint)14) {
                _4055 = (_4014 < 32.0f);
                _4062 = ((int)(uint)((int)(((_4017 < 0.0f)) && ((_4017 > select(_4055, -0.07999999821186066f, -1.0f))))));
              } else {
                _4062 = _4021;
          ...
          if (!(_4062 == 0)) {
            if ((uint)_4007 > (uint)11) {
              if (!((uint)_4007 < (uint)18)) {
                if (!(((_4007 == 18)) || ((((_4007 == 107)) || (((uint)(_4007 + -19) < (uint)2)))))) {
                  if (!(_4007 == 66)) {
                    _4081 = 0.0f;
                  } else {
                    _4081 = 0.10000000149011612f;
                  }
                } else {
                  _4081 = 0.15000000596046448f;
                }
              } else {
                _4081 = 0.10000000149011612f;
              }
            ...
            float _4083 = saturate(_4014 * 0.015625f);
            float _4086 = (1.0f - _4083) + (_4083 * _4081);
            if (_172) {
              _4097 = saturate((-0.0f - _4017) / (_3986 * 0.004654859658330679f));
            } else {
              _4097 = 1.0f;
            }
            _4104 = _4007;
            float _microFarAccum = (saturate(1.0f - ((_4086 * _4086) * _4081)) * (1.0f - _3992)) * _4097;
            _4105 = saturate((_microFarAccum * lerp(1.0f, CONTACT_SHADOW_RT_ACCUM_STRENGTH, CONTACT_SHADOW_RT_TUNING)) + _3992);
          } else {
            _4104 = _3990;
            _4105 = _3992;
          }
          [branch]
          if (_4105 > 0.949999988079071f) {
            if (!_4008) {
              _4136 = (saturate(_3991 / (_3991 - _4010)) - min(_3986, _4009));
            } else {
              _4136 = 0.0f;
            }
            _4146 = _4007;
            _4147 = _4105;
            _4148 = ((_4136 * _3965) + _3987);
            _4149 = ((_4136 * _3967) + _3988);
            _4150 = ((_4136 * _3968) + _3989);
            _4151 = _4006;
          } else {
            if ((uint)_3984 < (uint)(_3304 + -1)) {
              _4128 = (_3986 + _4009);
              _4129 = (_3987 + (_4009 * _3965));
              _4130 = (_3988 + (_4009 * _3967));
              _4131 = (_3989 + (_4009 * _3968));
              _4132 = min(abs(_3968), _4010);
            } else {
              _4128 = _3986;
              _4129 = _3987;
              _4130 = _3988;
      ...
      bool _4155 = (_4147 > 0.0f);
      if (_4150 > 0.0f) {
        if ((_4155) || ((((((_4148 >= 0.0f)) && ((_4148 <= 1.0f)))) && ((((_4149 >= 0.0f)) && ((_4149 <= 1.0f))))))) {
          float _4169 = (_4148 * 2.0f) + -1.0f;
          float _4170 = 1.0f - (_4149 * 2.0f);
          float _4206 = mad((_invViewProjRelative[3].z), _4150, mad((_invViewProjRelative[3].y), _4170, ((_invViewProjRelative[3].x) * _4169))) + (_invViewProjRelative[3].w);
          if (!(_4146 == 2)) {
            if (_4146 == 3) {
              _4232 = 0.0f;
              _4234 = _4232;
          ...
          if (!((_170) || ((!(_4147 == 1.0f))))) {
            _4258 = saturate(((((_3324 * 0.9375f) - max(0.0f, dot(float3(_3295, _3299, _3303), float3((((mad((_invViewProjRelative[0].z), _4150, mad((_invViewProjRelative[0].y), _4170, ((_invViewProjRelative[0].x) * _4169))) + (_invViewProjRelative[0].w)) / _4206) - _3552), (((mad((_invViewProjRelative[1].z), _4150, mad((_invViewProjRelative[1].y), _4170, ((_invViewProjRelative[1].x) * _4169))) + (_invViewProjRelative[1].w)) / _4206) - _3553), (((mad((_invViewProjRelative[2].z), _4150, mad((_invViewProjRelative[2].y), _4170, ((_invViewProjRelative[2].x) * _4169))) + (_invViewProjRelative[2].w)) / _4206) - _3554))))) * ((_115 * 0.015625f) + 1.5f)) / _3324) * 0.9375f);
          } else {
            _4258 = _4147;
          }
          float _4259 = _4258 * saturate(exp2(min(0.0f, (((_115 * 0.01899999938905239f) + 0.10000000149011612f) + (_4234 * ((_nearFarProj.x / max(1.0000000116860974e-07f, _4151)) - (_nearFarProj.x / max(1.0000000116860974e-07f, _4150)))))) * 1.4426950216293335f));
          int _4260 = _4146 & -2;
          if (!(_4260 == 6)) {
            bool __defer_4262_4272 = false;
            if ((((_80 == 33) && (_4146 == 33)) || (!(_80 == 33) && (((_80 == 55)) && ((_4146 == 55)))))) {
              _4337 = (_4259 * 0.009999999776482582f);
            } else {
              __defer_4262_4272 = true;
            }
            if (__defer_4262_4272) {
              if (!(((_4146 == 54)) || ((_4260 == 66))) || ((((_4146 == 54)) || ((_4260 == 66))) && (!(((_3188 == 66)) || ((_80 == 54)))))) {
                if (!_172) {
                  if ((uint)((int)((uint)(_4146) + (uint)(-53))) < (uint)15) {
                    _4334 = saturate(_115 * 0.03125f);
                  } else {
                    _4334 = 1.0f;
                  }
                  _4337 = (_4334 * _4259);
                ...
                uint4 _4289 = __3__36__0__0__g_baseColor.Load(int3(int(_bufferSizeAndInvSize.x * _4148), int(_bufferSizeAndInvSize.y * _4149), 0));
                float _4295 = float((uint)((uint)(((uint)((uint)(_4289.x)) >> 8) & 255))) * 0.003921568859368563f;
                float _4298 = float((uint)((uint)(_4289.x & 255))) * 0.003921568859368563f;
                float _4302 = float((uint)((uint)(((uint)((uint)(_4289.y)) >> 8) & 255))) * 0.003921568859368563f;
                float _4303 = _4295 * _4295;
                float _4304 = _4298 * _4298;
                float _4305 = _4302 * _4302;
                _4337 = (saturate(1.0f - (dot(float3((((_4303 * 0.6131200194358826f) + (_4304 * 0.3395099937915802f)) + (_4305 * 0.047370001673698425f)), (((_4303 * 0.07020000368356705f) + (_4304 * 0.9163600206375122f)) + (_4305 * 0.013450000435113907f)), (((_4303 * 0.02061999961733818f) + (_4304 * 0.10958000272512436f)) + (_4305 * 0.8697999715805054f))), float3(0.21267099678516388f, 0.7151600122451782f, 0.0721689984202385f)) * 0.875f)) * _4259);
              }
            }
          } else {
            _4337 = (_4259 * 0.009999999776482582f);
    ...
    #define MICRO_CONTACT_SHADOW  _4341
    ...
    if (CONTACT_SHADOW_RT_TUNING > 0.f && _4341 < 1.0f) {
      _4341 = saturate(1.0f - ((1.0f - _4341) * lerp(1.0f, CONTACT_SHADOW_RT_FINAL_STRENGTH, CONTACT_SHADOW_RT_TUNING)));
    }
    if (CONTACT_SHADOW_DETAIL_PATH == 1.f && _4341 < 1.0f) {
      ...
      _4341 = lerp(lerp(1.0f, _4341, 0.5f), _4341, _edgeFade);
    }
    float _4342 = min(_3178, _4341);
    _4356 = float(half(_4342 * float(_3154)));
    _4357 = float(half(_4342 * float(_3155)));
    _4358 = float(half(_4342 * float(_3156)));
    _4359 = saturate((1.0f - _556) + (exp2(log2(saturate(select(_172, (_3163 + 0.9800000190734863f), _3163))) * 0.45454543828964233f) * _556));
  }
  __3__38__0__1__g_shadowColorResultUAV[int2(((int)(((uint)(((((int)((uint)(_46) << 2)) & 1020) | ((int)(SV_GroupID.x) & 3)) << 3)) + SV_GroupThreadID.x)), ((int)(((uint)(((((uint)((uint)(_46)) >> 6) & 1020) | (((uint)(SV_GroupID.x) >> 2) & 3)) << 3)) + SV_GroupThreadID.y)))] = half4(half(_4356), half(_4357), half(_4358), half(_4359));
}
