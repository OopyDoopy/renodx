...
void main(
  ...
  if (((_79 < 1.0000000116860974e-07f)) || (_107)) {
    ...
    if (_5137 > 0.0f) {
      ...
      if (_115 < 8.0f) {
        ...
        while(true) {
          ...
          if (!(_5598 == 0)) {
            ...
            if (_172) {
              _5633 = saturate((-0.0f - _5553) / (_5524 * 0.004654859658330679f));
            } else {
              _5633 = 1.0f;
            }
            _5640 = _5543;
            float _microNearAccum = (saturate(1.0f - ((_5622 * _5622) * _5617)) * (1.0f - _5528)) * _5633;
            _5641 = saturate((_microNearAccum * lerp(1.0f, CONTACT_SHADOW_RT_ACCUM_STRENGTH, CONTACT_SHADOW_RT_TUNING)) + _5528);
          } else {
            _5640 = _5520;
            _5641 = _5528;
          }
          [branch]
          if (_5641 > 0.949999988079071f) {
            if (!_5544) {
              _5672 = (saturate(_5527 / (_5527 - _5550)) - min(_5524, _5545));
            } else {
              _5672 = 0.0f;
            }
            _5966 = _5543;
            _5967 = _5641;
            _5968 = ((_5672 * _5501) + _5521);
            _5969 = ((_5672 * _5503) + _5522);
            _5970 = ((_5672 * _5504) + _5523);
            _5971 = _5542;
          } else {
            if ((uint)_5526 < (uint)(_5261 + -1)) {
              _5664 = ((_5545 * _5501) + _5521);
              _5665 = ((_5545 * _5503) + _5522);
              _5666 = ((_5545 * _5504) + _5523);
              _5667 = (_5545 + _5524);
              _5668 = min(abs(_5504), _5550);
            } else {
              _5664 = _5521;
              _5665 = _5522;
              _5666 = _5523;
        ...
        float _5682 = select(_5395, ((_nearFarProj.x - _5389) / _5392), _5281);
        float _5714 = mad((_viewProjRelative[2].z), _5376, mad((_viewProjRelative[2].y), _5375, ((_viewProjRelative[2].x) * _5374))) + (_viewProjRelative[2].w);
        float _5718 = mad((_viewProjRelative[3].z), _5376, mad((_viewProjRelative[3].y), _5375, ((_viewProjRelative[3].x) * _5374))) + (_viewProjRelative[3].w);
        float _5722 = (_5682 * _5252) + _5374;
        float _5723 = (_5682 * _5256) + _5375;
        float _5724 = (_5682 * _5260) + _5376;
        float _5740 = mad((_viewProjRelative[3].z), _5724, mad((_viewProjRelative[3].y), _5723, ((_viewProjRelative[3].x) * _5722))) + (_viewProjRelative[3].w);
        float _5741 = (mad((_viewProjRelative[0].z), _5376, mad((_viewProjRelative[0].y), _5375, ((_viewProjRelative[0].x) * _5374))) + (_viewProjRelative[0].w)) / _5718;
        float _5742 = (mad((_viewProjRelative[1].z), _5376, mad((_viewProjRelative[1].y), _5375, ((_viewProjRelative[1].x) * _5374))) + (_viewProjRelative[1].w)) / _5718;
        float _5743 = _5714 / _5718;
        float _5747 = ((mad((_viewProjRelative[0].z), _5724, mad((_viewProjRelative[0].y), _5723, ((_viewProjRelative[0].x) * _5722))) + (_viewProjRelative[0].w)) / _5740) - _5741;
        float _5748 = ((mad((_viewProjRelative[1].z), _5724, mad((_viewProjRelative[1].y), _5723, ((_viewProjRelative[1].x) * _5722))) + (_viewProjRelative[1].w)) / _5740) - _5742;
        float _5751 = 1.0f / float((uint)(uint)(_5261));
        float _5762 = max(_5751, (1.0f / min(1.0f, (max(((_bufferSizeAndInvSize.x * 0.5f) * abs(_5747)), ((_bufferSizeAndInvSize.y * 0.5f) * abs(_5748))) * _5751))));
        float _5763 = _5762 * (((mad((_viewProjRelative[2].z), _5724, mad((_viewProjRelative[2].y), _5723, ((_viewProjRelative[2].x) * _5722))) + (_viewProjRelative[2].w)) / _5740) - _5743);
        float _5782 = ((_5267 * 0.5f) * max(abs(_5763), (_5743 - ((mad((_proj[2].z), _115, 0.0f) + _5714) / (mad((_proj[3].z), _115, 0.0f) + _5718))))) * max(0.0625f, _5751);
        float _5783 = _5762 * _5751;
        float _5785 = (_5747 * 0.5f) * _5783;
        float _5787 = (_5748 * -0.5f) * _5783;
        float _5788 = _5763 * _5751;
        float _5795 = max(_5337, (1.0f / max((abs(_5785) * _bufferSizeAndInvSize.x), (abs(_5787) * _bufferSizeAndInvSize.y))));
        float _5802 = 0.5f / _bufferSizeAndInvSize.x;
        _5804 = 0;
        _5805 = _5287;
        _5806 = _5337;
        _5807 = (((_5741 * 0.5f) + 0.5f) + (_5795 * _5785));
        _5808 = ((0.5f - (_5742 * 0.5f)) + (_5795 * _5787));
        _5809 = ((_5795 * _5788) + _5743);
        _5810 = 0;
        _5811 = 1.0f;
        _5812 = 0.0f;
        while(true) {
          uint _5821 = __3__36__0__0__g_depthStencil.Load(int3(int(min(max(_5807, _5802), (1.0f - _5802)) * _bufferSizeAndInvSize.x), int(_5808 * _bufferSizeAndInvSize.y), 0));
          int _5823 = (uint)((uint)(_5821.x)) >> 24;
          float _5826 = float((uint)((uint)(_5821.x & 16777215))) * 5.960465188081798e-08f;
          int _5827 = _5823 & 127;
          bool _5828 = (_5804 == 0);
          float _5829 = select(_5828, 1.0f, _5805);
          float _5830 = _5809 - _5826;
          float _5834 = _nearFarProj.x / max(1.0000000116860974e-07f, _5826);
          float _5837 = _5834 - (_nearFarProj.x / max(1.0000000116860974e-07f, _5809));
          bool _5840 = (abs(_5830 + _5782) < _5782);
          int _5841 = (int)(uint)((int)(_5840));
          if (_5840) {
            if (((_5827 == 7)) || ((((_5827 == 54)) || (((((_5823 & 126) == 66)) || (((((uint)(_5827 + -5) < (uint)2)) || ((((_5827 == 107)) || ((((_5827 == 26)) || (((((uint)(_5827 + -27) < (uint)2)) || ((((_5827 == 106)) || (((((_5823 & 125) == 105)) || ((((_5827 == 18)) || (((uint)(_5827 + -19) < (uint)2))))))))))))))))))))) {
              _5875 = true;
              _5882 = ((int)(uint)((int)(((_5837 < 0.0f)) && ((_5837 > select(_5875, -0.07999999821186066f, -1.0f))))));
            } else {
              if ((uint)(_5827 + -53) < (uint)14) {
                _5875 = (_5834 < 32.0f);
                _5882 = ((int)(uint)((int)(((_5837 < 0.0f)) && ((_5837 > select(_5875, -0.07999999821186066f, -1.0f))))));
              } else {
                _5882 = _5841;
          ...
          if (!(_5882 == 0)) {
            if ((uint)_5827 > (uint)11) {
              if (!((uint)_5827 < (uint)18)) {
                if (!(((_5827 == 18)) || ((((_5827 == 107)) || (((uint)(_5827 + -19) < (uint)2)))))) {
                  if (!(_5827 == 66)) {
                    _5901 = 0.0f;
                  } else {
                    _5901 = 0.10000000149011612f;
                  }
                } else {
                  _5901 = 0.15000000596046448f;
                }
              } else {
                _5901 = 0.10000000149011612f;
              }
            ...
            float _5903 = saturate(_5834 * 0.015625f);
            float _5906 = (1.0f - _5903) + (_5903 * _5901);
            if (_172) {
              _5917 = saturate((-0.0f - _5837) / (_5806 * 0.004654859658330679f));
            } else {
              _5917 = 1.0f;
            }
            _5924 = _5827;
            float _microFarAccum = (saturate(1.0f - ((_5906 * _5906) * _5901)) * (1.0f - _5812)) * _5917;
            _5925 = saturate((_microFarAccum * lerp(1.0f, CONTACT_SHADOW_RT_ACCUM_STRENGTH, CONTACT_SHADOW_RT_TUNING)) + _5812);
          } else {
            _5924 = _5810;
            _5925 = _5812;
          }
          [branch]
          if (_5925 > 0.949999988079071f) {
            if (!_5828) {
              _5956 = (saturate(_5811 / (_5811 - _5830)) - min(_5806, _5829));
            } else {
              _5956 = 0.0f;
            }
            _5966 = _5827;
            _5967 = _5925;
            _5968 = ((_5956 * _5785) + _5807);
            _5969 = ((_5956 * _5787) + _5808);
            _5970 = ((_5956 * _5788) + _5809);
            _5971 = _5826;
          } else {
            if ((uint)_5804 < (uint)(_5261 + -1)) {
              _5948 = (_5806 + _5829);
              _5949 = (_5807 + (_5829 * _5785));
              _5950 = (_5808 + (_5829 * _5787));
              _5951 = (_5809 + (_5829 * _5788));
              _5952 = min(abs(_5788), _5830);
            } else {
              _5948 = _5806;
              _5949 = _5807;
              _5950 = _5808;
      ...
      bool _5975 = (_5967 > 0.0f);
      if (_5970 > 0.0f) {
        if ((_5975) || ((((((_5968 >= 0.0f)) && ((_5968 <= 1.0f)))) && ((((_5969 >= 0.0f)) && ((_5969 <= 1.0f))))))) {
          float _5989 = (_5968 * 2.0f) + -1.0f;
          float _5990 = 1.0f - (_5969 * 2.0f);
          float _6006 = mad((_invViewProjRelative[3].z), _5970, mad((_invViewProjRelative[3].y), _5990, (_5989 * (_invViewProjRelative[3].x)))) + (_invViewProjRelative[3].w);
          if (!(_5966 == 2)) {
            if (_5966 == 3) {
              _6032 = 0.0f;
              _6034 = _6032;
          ...
          if (!((_170) || ((!(_5967 == 1.0f))))) {
            _6058 = saturate(((((_5281 * 0.9375f) - max(0.0f, dot(float3(_5252, _5256, _5260), float3((((mad((_invViewProjRelative[0].z), _5970, mad((_invViewProjRelative[0].y), _5990, (_5989 * (_invViewProjRelative[0].x)))) + (_invViewProjRelative[0].w)) / _6006) - _5374), (((mad((_invViewProjRelative[1].z), _5970, mad((_invViewProjRelative[1].y), _5990, (_5989 * (_invViewProjRelative[1].x)))) + (_invViewProjRelative[1].w)) / _6006) - _5375), (((mad((_invViewProjRelative[2].z), _5970, mad((_invViewProjRelative[2].y), _5990, (_5989 * (_invViewProjRelative[2].x)))) + (_invViewProjRelative[2].w)) / _6006) - _5376))))) * ((_115 * 0.015625f) + 1.5f)) / _5281) * 0.9375f);
          } else {
            _6058 = _5967;
          }
          float _6059 = _6058 * saturate(exp2(min(0.0f, (((_115 * 0.01899999938905239f) + 0.10000000149011612f) + (_6034 * ((_nearFarProj.x / max(1.0000000116860974e-07f, _5971)) - (_nearFarProj.x / max(1.0000000116860974e-07f, _5970)))))) * 1.4426950216293335f));
          int _6060 = _5966 & -2;
          if (!(_6060 == 6)) {
            bool __defer_6062_6072 = false;
            if ((((_80 == 33) && (_5966 == 33)) || (!(_80 == 33) && (((_80 == 55)) && ((_5966 == 55)))))) {
              _6134 = (_6059 * 0.009999999776482582f);
            } else {
              __defer_6062_6072 = true;
            }
            if (__defer_6062_6072) {
              if (!(((_5966 == 54)) || ((_6060 == 66))) || ((((_5966 == 54)) || ((_6060 == 66))) && (!(((_5147 == 66)) || ((_80 == 54)))))) {
                if (!_172) {
                  if ((uint)((int)((uint)(_5966) + (uint)(-53))) < (uint)15) {
                    _6131 = saturate(_115 * 0.03125f);
                  } else {
                    _6131 = 1.0f;
                  }
                  _6134 = (_6131 * _6059);
                ...
                uint4 _6086 = __3__36__0__0__g_baseColor.Load(int3(int(_5968 * _bufferSizeAndInvSize.x), int(_5969 * _bufferSizeAndInvSize.y), 0));
                float _6092 = float((uint)((uint)(((uint)((uint)(_6086.x)) >> 8) & 255))) * 0.003921568859368563f;
                float _6095 = float((uint)((uint)(_6086.x & 255))) * 0.003921568859368563f;
                float _6099 = float((uint)((uint)(((uint)((uint)(_6086.y)) >> 8) & 255))) * 0.003921568859368563f;
                float _6100 = _6092 * _6092;
                float _6101 = _6095 * _6095;
                float _6102 = _6099 * _6099;
                _6134 = (saturate(1.0f - (dot(float3((((_6100 * 0.6131200194358826f) + (_6101 * 0.3395099937915802f)) + (_6102 * 0.047370001673698425f)), (((_6100 * 0.07020000368356705f) + (_6101 * 0.9163600206375122f)) + (_6102 * 0.013450000435113907f)), (((_6100 * 0.02061999961733818f) + (_6101 * 0.10958000272512436f)) + (_6102 * 0.8697999715805054f))), float3(0.21267099678516388f, 0.7151600122451782f, 0.0721689984202385f)) * 0.875f)) * _6059);
              }
            }
          } else {
            _6134 = (_6059 * 0.009999999776482582f);
    ...
    #define MICRO_LIGHT_DIR_X     _5167
    #define MICRO_LIGHT_DIR_Y     _5168
    #define MICRO_LIGHT_DIR_Z     _5169
    #define MICRO_WORLD_POS_X     _5360
    #define MICRO_WORLD_POS_Y     _5361
    #define MICRO_WORLD_POS_Z     _5362
    ...
    if (CONTACT_SHADOW_RT_TUNING > 0.f && _6138 < 1.0f) {
      _6138 = saturate(1.0f - ((1.0f - _6138) * lerp(1.0f, CONTACT_SHADOW_RT_FINAL_STRENGTH, CONTACT_SHADOW_RT_TUNING)));
    }
    if (CONTACT_SHADOW_DETAIL_PATH == 1.f && _6138 < 1.0f) {
      ...
      _6138 = lerp(lerp(1.0f, _6138, 0.5f), _6138, _edgeFade);
    }
    float _6139 = min(_5137, _6138);
    _6153 = float(half(_6139 * float(_5113)));
    _6154 = float(half(_6139 * float(_5114)));
    _6155 = float(half(_6139 * float(_5115)));
    _6156 = saturate((1.0f - _556) + (exp2(log2(saturate(select(_172, (_5122 + 0.9800000190734863f), _5122))) * 0.45454543828964233f) * _556));
  }
  __3__38__0__1__g_shadowColorResultUAV[int2(((int)(((uint)(((((int)((uint)(_46) << 2)) & 1020) | ((int)(SV_GroupID.x) & 3)) << 3)) + SV_GroupThreadID.x)), ((int)(((uint)(((((uint)((uint)(_46)) >> 6) & 1020) | (((uint)(SV_GroupID.x) >> 2) & 3)) << 3)) + SV_GroupThreadID.y)))] = half4(half(_6153), half(_6154), half(_6155), half(_6156));
}
