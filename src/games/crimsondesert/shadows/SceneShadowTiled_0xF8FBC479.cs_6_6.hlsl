...
void main(
  ...
  // [sem: _3__36__0__0__g_dynamicShadowColorArray_sampleLod]
    ...
    if (_1591 > 0.0f) {
      ...
      // Description: SceneShadowTiledCS 0xF8FBC479 uses this native contact ray direction on the near-field shadow sibling; stable direction keeps Contact Micro Shadows from inheriting per-frame random cone wobble when the feature is enabled.
      ...
      // RenoDX: >>> [Patch: ContactMicroShadowsFamily] [Version: 1.10]
      // Description: SceneShadowTiledCS 0xF8FBC479 raises native contact-ray samples only while Contact Micro Shadows is enabled, preserving the vanilla sample count when Off.
      ...
      // RenoDX: >>> [Patch: ContactMicroShadowsFamily] [Version: 1.10]
      // Description: SceneShadowTiledCS 0xF8FBC479 extends the native non-RT contact reach gradually with the Contact Micro Shadows quality value; Off evaluates to the vanilla reach.
      ...
      if (_1603 || ((_81 != 15) && ((uint)(_81 + -12) < (uint)7))) {
        // RenoDX: >>> [Patch: ContactMicroShadowsFamily] [Version: 1.10]
        // Description: SceneShadowTiledCS 0xF8FBC479 moves the native contact start closer only while Contact Micro Shadows is enabled, preserving vanilla start distance when Off.
        _1928 = (_1915 * lerp(10.0f, 2.0f, CONTACT_SHADOW_START_BLEND));
        // RenoDX: <<< [Patch: ContactMicroShadowsFamily]
      } else {
        if (_81 == 15) {
          // RenoDX: >>> [Patch: ContactMicroShadowsFamily] [Version: 1.10]
          // Description: SceneShadowTiledCS 0xF8FBC479 applies the same Contact Micro Shadows start-distance blend to the depth-faded material branch.
  ...
  // [sem: _3__36__0__0__g_depthStencil_load]
        ...
        if (!(_2190 == 0)) {
          ...
          if (_173) {
            _2225 = saturate((-0.0f - _2145) / (_2115 * 0.004654859658330679f));  // [sem: expr_sat]
          } else {
            _2225 = 1.0f;  // [sem: expr_sat]
          }
          _2232 = _2135;
          // RenoDX: >>> [Patch: ContactMicroShadowsFamily] [Version: 1.10]
          // Description: SceneShadowTiledCS 0xF8FBC479 softens native contact accumulation with Contact Micro Shadows tuning so the added detail blends with the shipped non-RT contact result.
          float _rndxMicroFarAccum = (saturate(1.0f - ((_2214 * _2214) * _2209)) * (1.0f - _2120)) * _2225;
          _2233 = saturate((_rndxMicroFarAccum * lerp(1.0f, 0.7f, CONTACT_SHADOW_BASE_TUNING)) + _2120);  // [sem: expr_sat]
          // RenoDX: <<< [Patch: ContactMicroShadowsFamily]
        } else {
          _2232 = _2118;
          _2233 = _2120;  // [sem: expr_sat]
        }
        [branch]
        if (_2233 > 0.949999988079071f) {
          if (!_2136) {
            _2264 = (saturate(_2119 / (_2119 - _2138)) - min(_2115, _2137));
          } else {
            _2264 = 0.0f;
          }
          _2273 = ((_2264 * _2093) + _2112);
          _2274 = ((_2264 * _2095) + _2113);
          _2275 = ((_2264 * _2096) + _2114);
          _2276 = _2134;
          _2277 = _2135;
        } else {
          if ((uint)_2117 < (uint)(_1717 + -1)) {
            _2256 = ((_2137 * _2093) + _2112);
            _2257 = ((_2137 * _2095) + _2113);
            _2258 = ((_2137 * _2096) + _2114);
            _2259 = (_2137 + _2115);
            _2260 = min(abs(_2096), _2138);
          } else {
            _2256 = _2112;
            _2257 = _2113;
            _2258 = _2114;
        ...
        _2281 = (_2233 > 0.0f);
        if (_2275 > 0.0f) {
          if (_2281 || (((_2273 >= 0.0f) && (_2273 <= 1.0f)) && ((_2274 >= 0.0f) && (_2274 <= 1.0f)))) {
            _2295 = (_2273 * 2.0f) + -1.0f;
            _2296 = 1.0f - (_2274 * 2.0f);
            _2332 = mad((_invViewProjRelative[2].w), _2275, mad((_invViewProjRelative[1].w), _2296, ((_invViewProjRelative[0].w) * _2295))) + (_invViewProjRelative[3].w);
            if (!(_2277 == 2)) {
              if (_2277 == 3) {
                _2356 = 0.0f;
                _2358 = _2356;
            ...
            if (!(_171 || (!(_2233 == 1.0f)))) {
  // [sem: expr_sat]
              _2382 = saturate(((((_1737 * 0.9375f) - max(0.0f, dot(float3(_1708, _1712, _1716), float3((((mad((_invViewProjRelative[2].x), _2275, mad((_invViewProjRelative[1].x), _2296, ((_invViewProjRelative[0].x) * _2295))) + (_invViewProjRelative[3].x)) / _2332) - _1965), (((mad((_invViewProjRelative[2].y), _2275, mad((_invViewProjRelative[1].y), _2296, ((_invViewProjRelative[0].y) * _2295))) + (_invViewProjRelative[3].y)) / _2332) - _1966), (((mad((_invViewProjRelative[2].z), _2275, mad((_invViewProjRelative[1].z), _2296, ((_invViewProjRelative[0].z) * _2295))) + (_invViewProjRelative[3].z)) / _2332) - _1967))))) * ((_116 * 0.015625f) + 1.5f)) / _1737) * 0.9375f);
            } else {
              _2382 = _2233;  // [sem: expr_sat]
            }
            _2383 = _2382 * saturate(exp2(min(0.0f, (((_116 * 0.018666666001081467f) + 0.13333334028720856f) + (_2358 * ((_nearFarProj.x / max(1.0000000116860974e-07f, _2276)) - (_nearFarProj.x / max(1.0000000116860974e-07f, _2275)))))) * 1.4426950216293335f));
            _2384 = _2277 & -2;
            if (!(_2384 == 6)) {
              if ((((_81 == 33) && (_2277 == 33)) || (!(_81 == 33) && ((_81 == 55) && (_2277 == 55))))) {
                _2461 = (_2383 * 0.009999999776482582f);
              } else {
                if (!((_2277 == 54) || (_2384 == 66)) || (((_2277 == 54) || (_2384 == 66)) && (!((_1601 == 66) || (_81 == 54))))) {
                  if (!_173) {
                    if ((uint)((int)(_2277 + (uint)(-53))) < (uint)15) {
                      _2458 = saturate(_116 * 0.03125f);  // [sem: expr_sat]
                    } else {
                      _2458 = 1.0f;  // [sem: expr_sat]
                    }
                    _2461 = (_2458 * _2383);
                  } else {
                    _2461 = _2383;
  ...
  // [sem: _3__36__0__0__g_baseColor_load]
                  _2413 = __3__36__0__0__g_baseColor.Load(int3(int(_bufferSizeAndInvSize.x * _2273), int(_bufferSizeAndInvSize.y * _2274), 0));
                  _2419 = ((float)((uint)((uint)(((uint)((uint)(_2413.x)) >> 8) & 255)))) * 0.003921568859368563f;
                  _2422 = ((float)((uint)((uint)(_2413.x & 255)))) * 0.003921568859368563f;
                  _2426 = ((float)((uint)((uint)(((uint)((uint)(_2413.y)) >> 8) & 255)))) * 0.003921568859368563f;
                  _2427 = _2419 * _2419;
                  _2428 = _2422 * _2422;
                  _2429 = _2426 * _2426;
                  _2461 = (saturate(1.0f - (dot(float3((((_2427 * 0.6131200194358826f) + (_2428 * 0.3395099937915802f)) + (_2429 * 0.047370001673698425f)), (((_2427 * 0.07020000368356705f) + (_2428 * 0.9163600206375122f)) + (_2429 * 0.013450000435113907f)), (((_2427 * 0.02061999961733818f) + (_2428 * 0.10958000272512436f)) + (_2429 * 0.8697999715805054f))), float3(0.21267099678516388f, 0.7151600122451782f, 0.0721689984202385f)) * 0.875f)) * _2383);
                }
              }
            } else {
              _2461 = (_2383 * 0.009999999776482582f);
  ...
  // [sem: _3__36__0__0__g_baseColor_load]
        ...
        _2465 = saturate(1.0f - _2461);  // [sem: expr_sat]
        break;
      }
    } else {
      _2465 = 1.0f;  // [sem: expr_sat]
    }
    // RenoDX: >>> [Patch: ContactMicroShadowsFamily] [Version: 1.10]
    // Description: SceneShadowTiledCS 0xF8FBC479 fills sub-pixel occluders in the near-field shadow sibling, then fades the helper near screen edges to avoid bright edge artifacts.
    _2465 = ApplyContactMicroDetailShadow(
        _2465,
        float2(_61, _62),
        _116,
        _77,
        ...
        1.0f,
        1.0f);
    if (CONTACT_SHADOW_DETAIL_PATH == 1.f && _2465 < 1.0f) {
      ...
      _2465 = lerp(lerp(1.0f, _2465, 0.5f), _2465, _rndxMicroEdgeFade);
    }
    // RenoDX: <<< [Patch: ContactMicroShadowsFamily]
    _2466 = min(_1591, _2465);
    _2480 = float(half(_2466 * float(_1251)));
    _2481 = float(half(_2466 * float(_1252)));
    _2482 = float(half(_2466 * float(_1253)));
    _2483 = saturate((1.0f - _557) + (exp2(log2(saturate(_1578)) * 0.45454543828964233f) * _557));  // [sem: expr_sat]
  }
  __3__38__0__1__g_shadowColorResultUAV[int2(_59, _60)] = float4((half)(half(_2480)), (half)(half(_2481)), (half)(half(_2482)), (half)(half(_2483)));
}
