...
float4 main(
  ...
  float4 _303 = __3__36__0__0__g_sceneColor.Sample(__0__4__0__0__g_staticPointClamp, float2(TEXCOORD.x, TEXCOORD.y));
  float4 _305 = __3__36__0__0__g_sceneColor.Sample(__0__4__0__0__g_staticPointClamp, float2((((_279 + _284) * _276) + TEXCOORD.x), (((_280 + _286) * _276) + TEXCOORD.y)));
  float _310 = 1.0f / max(0.0010000000474974513f, _exposure0.x);
  float _311 = _310 * (1.0f - saturate(exp2(log2(_25.x) * WaveReadLaneFirst(BindlessParameters_PostProcessAbyssCommon_CD[((int)((uint)(select(((uint)_71 < (uint)170000), _71, 0)) + 0u))]._fogDepth)) * 4.0f));
  float _312 = _311 * 0.08000000566244125f;
  float _313 = _311 * 0.08999999612569809f;
  float _314 = _311 * 0.11000000685453415f;
  float _327 = ((saturate(_312) * 0.05999999865889549f) * (_301.x - _312)) + _312;
  float _328 = ((saturate(_313) * 0.05999999865889549f) * (_303.y - _313)) + _313;
  float _329 = (((_305.z - _314) * 0.05999999865889549f) * saturate(_314)) + _314;
  uint _330 = uint(SV_Position.y);
  float _344;
  float _588;
  float _589;
  float _590;
  ...
  if (_etcParams.y == 1.0f) {
    uint2 _338 = __3__36__0__0__g_stencil.Load(int3((int)(uint(SV_Position.x)), (int)(_330), 0));
    _344 = (float((uint)((uint)(_338.x & 127))) + 0.5f);
  } else {
    _344 = _310;
  }
  ...
  if (_etcParams.y > 1.0f) {
    float _720 = abs(_28);
    float _721 = abs(_29 + -1.0f);
    float _725 = saturate(1.0f - (dot(float2(_720, _721), float2(_720, _721)) * saturate(_etcParams.y + -1.0f)));
    _730 = (_725 * _710);
    _731 = (_725 * _711);
    _732 = (_725 * _712);
  } else {
  ...
  if (!(!(_etcParams.y >= 1.0f))) {
    float _772 = float((uint)_330);
    if (!(_772 < _viewDir.w)) {
      if (!(_772 >= (_screenSizeAndInvSize.y - _viewDir.w))) {
        _781 = _765;
        _782 = _766;
        _783 = _767;
      } else {
