...
float4 main(
  ...
  float4 _67 = __3__36__0__0__g_sceneColor.Sample(__0__4__0__0__g_staticBilinearClamp, float2(TEXCOORD.x, TEXCOORD.y));
  float4 _69 = __3__36__0__0__g_sceneColor.Sample(__0__4__0__0__g_staticBilinearClamp, float2((_57 + TEXCOORD.x), (_59 + TEXCOORD.y)));
  uint _71 = uint(SV_Position.y);
  float _85;
  float _331;
  float _332;
  float _333;
  ...
  if (_etcParams.y == 1.0f) {
    uint2 _79 = __3__36__0__0__g_stencil.Load(int3((int)(uint(SV_Position.x)), (int)(_71), 0));
    _85 = (float((uint)((uint)(_79.x & 127))) + 0.5f);
  } else {
  ...
  if (((_localToneMappingParams.w > 0.0f)) && ((_etcParams.z > 0.0f))) {
    ...
    _513 = select((_478 <= 0.0031308000907301903f), (_478 * 12.920000076293945f), (((pow(_478, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _511 = _476;
    _512 = _477;
    _513 = _478;
  ...
  if (!(!(_etcParams.y >= 1.0f))) {
    float _518 = float((uint)_71);
    if (!(_518 < _viewDir.w)) {
      if (!(_518 >= (_screenSizeAndInvSize.y - _viewDir.w))) {
        _527 = _511;
        _528 = _512;
        _529 = _513;
      } else {
