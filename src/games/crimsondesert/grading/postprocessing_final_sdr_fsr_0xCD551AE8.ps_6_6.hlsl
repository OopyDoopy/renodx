...
float4 main(
  ...
  float _179 = (TEXCOORD.x * 2.0f) + -1.0f;
  float _180 = TEXCOORD.y * 2.0f;
  float _181 = 1.0f - _180;
  float _209 = mad((_projToPrevProj[3].z), 1.0000000116860974e-07f, mad((_projToPrevProj[3].y), _181, ((_projToPrevProj[3].x) * _179))) + (_projToPrevProj[3].w);
  float _212 = ((mad((_projToPrevProj[0].z), 1.0000000116860974e-07f, mad((_projToPrevProj[0].y), _181, ((_projToPrevProj[0].x) * _179))) + (_projToPrevProj[0].w)) / _209) - _179;
  float _213 = ((mad((_projToPrevProj[1].z), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _181, ((_projToPrevProj[1].x) * _179))) + (_projToPrevProj[1].w)) / _209) - _181;
  if (_localToneMappingParams.w > 0.0f) {
    _227 = saturate(1.0f - (sqrt((_213 * _213) + (_212 * _212)) * 2.0f));
  } else {
    _227 = 1.0f;
  }
  float _230 = abs(_179);
  float _231 = abs(_180 + -1.0f);
  float _235 = saturate(1.0f - ((_227 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_230, _231), float2(_230, _231))));
  if (!(SV_Position.y < _viewDir.w)) {
    if (!(SV_Position.y >= (_screenSizeAndInvSize.y - _viewDir.w))) {
      _249 = (_235 * exp2(log2(saturate((_152 * (_143 + -0.5f)) + _156)) * _168));
      _250 = (_235 * exp2(log2(saturate((_152 * (_144 + -0.5f)) + _156)) * _168));
      _251 = (_235 * exp2(log2(saturate((_152 * (_145 + -0.5f)) + _156)) * _168));
    } else {
      _249 = 0.0f;
      _250 = 0.0f;
      _251 = 0.0f;
