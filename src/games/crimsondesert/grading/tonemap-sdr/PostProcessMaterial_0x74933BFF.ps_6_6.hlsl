...
float4 main(
  ...
  _538 = exp2(log2(_526 * 9.999999747378752e-05f) * 0.1593017578125f);
  _539 = exp2(log2(_527 * 9.999999747378752e-05f) * 0.1593017578125f);
  _540 = exp2(log2(_528 * 9.999999747378752e-05f) * 0.1593017578125f);
  SV_Target.x = exp2(log2((1.0f / ((_538 * 18.6875f) + 1.0f)) * ((_538 * 18.8515625f) + 0.8359375f)) * 78.84375f);
  SV_Target.y = exp2(log2((1.0f / ((_539 * 18.6875f) + 1.0f)) * ((_539 * 18.8515625f) + 0.8359375f)) * 78.84375f);
  SV_Target.z = exp2(log2((1.0f / ((_540 * 18.6875f) + 1.0f)) * ((_540 * 18.8515625f) + 0.8359375f)) * 78.84375f);
  SV_Target.w = _43;
  return SV_Target;
}