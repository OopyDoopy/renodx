...
float4 main(
  ...
  while(true) {
    ...
    _1793 = 1.0f - (saturate(_353 * 7.0f) * 0.9950000047683716f);
    _1794 = _1793 * _1786.x;
    _1795 = _1793 * _1786.y;
    _1796 = _1793 * _1786.z;
    if (!_1784) {
      _1800 = saturate(_1022);
    } else {
      _1800 = 0.0f;
    }
    _1807 = (_1800 * (max(0.0f, (_1733 * (((_1221 * saturate(_1207)) + ((_321 * 0.5f) * _332)) + (_1723 * exp2(log2(((((_1687 + (_1425 * 0.033104754984378815f)) + (((_1621 * 0.16689524054527283f) + 0.033104754984378815f) * _1621)) + _1675) + (_1685 * 0.07323896884918213f)) * 2.0f)))))) - _1794)) + _1794;
    _1808 = (_1800 * (max(0.0f, (_1733 * (((_1221 * saturate(_1208)) + ((_322 * 0.699999988079071f) * _332)) + (_1723 * exp2(log2(((((_1687 + (_1693 * 0.033104754984378815f)) + ((0.07323896884918213f - (_1621 * 0.02323896810412407f)) * _1621)) + _1675) + (_1685 * 0.21404112875461578f)) * 2.0f)))))) - _1795)) + _1795;
    _1809 = (_1800 * (max(0.0f, (_1733 * (((_1221 * saturate(_1209)) + ((_323 * 0.8999999761581421f) * _332)) + (_1723 * exp2(log2((((((((_1693 * 0.07323896884918213f) + (_1389 * 0.033104754984378815f)) + ((0.13286834955215454f - (_1621 * 0.08286835253238678f)) * _1621)) + (_1664 * 0.06370936334133148f)) + (_1661 * 0.1098584532737732f)) + (_1670 * 0.6038274168968201f)) + _1675) * 2.0f)))))) - _1796)) + _1796;
    if (!_1784) {
      _1813 = saturate(_1022);
    } else {
      _1813 = 1.0f;
    }
    _1814 = uint(SV_Position.y);
    if (_etcParams.y == 1.0f) {
      _1827 = (float((uint)((uint)((((uint2)(__3__36__0__0__g_stencil.Load(int3((int)(uint(SV_Position.x)), _1814, 0)))).x) & 127))) + 0.5f);
    } else {
      _1827 = _1813;
    }
    if (_localToneMappingParams.w > 0.0f) {
      float3 output_color = TonemapReplacer(float3(_1807, _1808, _1809));
      _2247 = output_color.x;
      _2248 = output_color.y;
      _2249 = output_color.z;
    } else {
      _2247 = _1807;
      _2248 = _1808;
      _2249 = _1809;
    ...
    if (_etcParams.y > 1.0f) {
      _2258 = abs(_79);
      _2259 = abs((TEXCOORD.y * 2.0f) + -1.0f);
      _2263 = saturate(1.0f - (dot(float2(_2258, _2259), float2(_2258, _2259)) * saturate(_etcParams.y + -1.0f)));
      _2268 = (_2263 * _2247);
      _2269 = (_2263 * _2248);
      _2270 = (_2263 * _2249);
    } else {
    ...
    if ((_localToneMappingParams.w > 0.0f) && (_etcParams.z > 0.0f)) {
      _2303 = select((_2268 <= 0.0031308000907301903f), (_2268 * 12.920000076293945f), (((pow(_2268, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
      _2304 = select((_2269 <= 0.0031308000907301903f), (_2269 * 12.920000076293945f), (((pow(_2269, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
      _2305 = select((_2270 <= 0.0031308000907301903f), (_2270 * 12.920000076293945f), (((pow(_2270, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
    } else {
      _2303 = _2268;
      _2304 = _2269;
      _2305 = _2270;
    ...
    if (!(_etcParams.y < 1.0f)) {
      _2310 = float((uint)_1814);
      if (!(_2310 < asfloat(__3__35__0__0__SceneConstantBuffer_raw[9u].w))) {
        if (_2310 < (asfloat(__3__35__0__0__SceneConstantBuffer_raw[3u].y) - asfloat(__3__35__0__0__SceneConstantBuffer_raw[9u].w))) {
          _2319 = _2303;
          _2320 = _2304;
          _2321 = _2305;
        } else {
