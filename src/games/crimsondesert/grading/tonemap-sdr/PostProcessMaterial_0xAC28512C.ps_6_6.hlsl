...
float4 main(
  ...
  while(true) {
    ...
    uint _192 = uint(SV_Position.y);
    if (_etcParams.y == 1.0f) {
      uint2 _199 = __3__36__0__0__g_stencil.Load(int3((int)(uint(SV_Position.x)), (int)(_192), 0));
      _205 = (float((uint)((uint)(_199.x & 127))) + 0.5f);
    } else {
      _205 = _postProcessParams.x;
    }
    bool _208 = (_localToneMappingParams.w > 0.0f);
    if (_208) {
    ...
    if (_etcParams.y > 1.0f) {
      float _572 = abs((TEXCOORD.x * 2.0f) + -1.0f);
      float _573 = abs((TEXCOORD.y * 2.0f) + -1.0f);
      float _577 = saturate(1.0f - (dot(float2(_572, _573), float2(_572, _573)) * saturate(_etcParams.y + -1.0f)));
      _582 = (_577 * _561);
      _583 = (_577 * _562);
      _584 = (_577 * _563);
    } else {
