...
float4 main(
  ...
  while(true) {
    ...
    while(true) {
      ...
      _72 = __3__36__0__0__g_postProcessSizeColor.Sample(__3__40__0__0__g_sampler, float2((((_44 * _srcTargetSizeAndInv.z) * float((int)(_49))) + TEXCOORD.x), (((_44 * _srcTargetSizeAndInv.w) * float((int)(_54))) + TEXCOORD.y)));
      _79 = (_72.x * _61) + _51;
      _80 = (_72.y * _61) + _52;
      _81 = (_72.z * _61) + _53;
      _82 = _54 + 1;
