...
float4 main(
  ...
  float _468 = exp2(log2(_456 * 9.999999747378752e-05f) * 0.1593017578125f);
  float _469 = exp2(log2(_457 * 9.999999747378752e-05f) * 0.1593017578125f);
  float _470 = exp2(log2(_458 * 9.999999747378752e-05f) * 0.1593017578125f);
  SV_Target.x = exp2(log2((1.0f / ((_468 * 18.6875f) + 1.0f)) * ((_468 * 18.8515625f) + 0.8359375f)) * 78.84375f);
  SV_Target.y = exp2(log2((1.0f / ((_469 * 18.6875f) + 1.0f)) * ((_469 * 18.8515625f) + 0.8359375f)) * 78.84375f);
  SV_Target.z = exp2(log2((1.0f / ((_470 * 18.6875f) + 1.0f)) * ((_470 * 18.8515625f) + 0.8359375f)) * 78.84375f);
  SV_Target.w = _44;
  return SV_Target;
}