...
float4 main(
  ...
  float _1008 = exp2(log2(_996 * 9.999999747378752e-05f) * 0.1593017578125f);
  float _1009 = exp2(log2(_997 * 9.999999747378752e-05f) * 0.1593017578125f);
  float _1010 = exp2(log2(_998 * 9.999999747378752e-05f) * 0.1593017578125f);
