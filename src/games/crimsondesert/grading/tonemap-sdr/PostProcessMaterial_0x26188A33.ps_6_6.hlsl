...
float4 main(
  ...
  float _42 = WaveReadLaneFirst(BindlessParameters_PostProcessLearningHolo_CD[((int)((uint)(select(((uint)_34 < (uint)170000), _34, 0)) + 0u))]._learningEffectRatio);
  int _47 = WaveReadLaneFirst(_materialIndex);
  int _55 = WaveReadLaneFirst(BindlessParameters_PostProcessLearningHolo_CD[((int)((uint)(select(((uint)_47 < (uint)170000), _47, 0)) + 0u))]._noiseTexture);
  float4 _62 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_55 < (uint)65000), _55, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((_42 + (TEXCOORD.x * 5.0f)), (_42 + (TEXCOORD.y * 0.10000000149011612f))));
  int2 _71; __3__36__0__0__g_CustomRenderPassValue.GetDimensions(_71.x, _71.y);
  uint _86 = __3__36__0__0__g_CustomRenderPassValue.Load(int3(int((float((int)(int(float((int)(_71.x))))) + 0.5f) * TEXCOORD.x), int((float((int)(int(float((int)(_71.y))))) + 0.5f) * ((((_62.y * 0.01600000075995922f) + -0.007968627847731113f) * saturate(1.0f - _42)) + TEXCOORD.y)), 0));
  int _88 = _86.x & 255;
  ...
  bool _127 = (_42 > 0.0010000000474974513f);
  if (_88 == _renderPassLearning) {
    if (_127) {
      ...
      float _319 = dot(float3(_30.x, _30.y, _30.z), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
      ...
      float _365 = (saturate(1.0f - abs((_42 * 2.0f) + -1.0f)) * 199.0f) + 1.0f;
      if (_358 < 1.0f) {
        ...
        _414 = saturate(exp2(_369 * 3.0f) * _42);
      } else {
  ...
  bool _454 = (_localToneMappingParams.w > 0.0f);
  if (_454) {
  ...
  if (_etcParams.y > 1.0f) {
    float _818 = abs((TEXCOORD.x * 2.0f) + -1.0f);
    float _819 = abs((TEXCOORD.y * 2.0f) + -1.0f);
    float _823 = saturate(1.0f - (dot(float2(_818, _819), float2(_818, _819)) * saturate(_etcParams.y + -1.0f)));
    _828 = (_823 * _807);
    _829 = (_823 * _808);
    _830 = (_823 * _809);
  } else {
  ...
  if ((_454) && ((_etcParams.z > 0.0f))) {
    ...
    _861 = select((_829 <= 0.0031308000907301903f), (_829 * 12.920000076293945f), (((pow(_829, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
  ...
  if (!(!(_etcParams.y >= 1.0f))) {
    float _867 = float((uint)_438);
    if (!(_867 < _viewDir.w)) {
      if (!(_867 >= (_screenSizeAndInvSize.y - _viewDir.w))) {
        _876 = _860;
        _877 = _861;
        _878 = _862;
      } else {
