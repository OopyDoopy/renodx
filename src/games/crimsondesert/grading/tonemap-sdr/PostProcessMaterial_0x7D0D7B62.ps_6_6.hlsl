...
float4 main(
  ...
  if (_etcParams.y == 1.0f) {
    uint2 _83 = __3__36__0__0__g_stencil.Load(int3((int)(uint(SV_Position.x)), (int)(_75), 0));
    _89 = (float((uint)((uint)(_83.x & 127))) + 0.5f);
  } else {
    _89 = _postProcessParams.x;
  }
  bool _92 = (_localToneMappingParams.w > 0.0f);
  if (_92) {
    float3 output_color = TonemapReplacer(float3(_69, _70, _71));
    _445 = output_color.x;
    _446 = output_color.y;
    _447 = output_color.z;
  } else {
  ...
  if (_etcParams.y > 1.0f) {
    float _456 = abs((TEXCOORD.x * 2.0f) + -1.0f);
    float _457 = abs((TEXCOORD.y * 2.0f) + -1.0f);
    float _461 = saturate(1.0f - (dot(float2(_456, _457), float2(_456, _457)) * saturate(_etcParams.y + -1.0f)));
    _466 = (_461 * _445);
    _467 = (_461 * _446);
    _468 = (_461 * _447);
  } else {
  ...
  float _527 = exp2(log2(_515 * 9.999999747378752e-05f) * 0.1593017578125f);
  float _528 = exp2(log2(_516 * 9.999999747378752e-05f) * 0.1593017578125f);
