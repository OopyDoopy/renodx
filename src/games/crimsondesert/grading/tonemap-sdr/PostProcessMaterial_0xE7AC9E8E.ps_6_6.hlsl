...
float4 main(
  ...
  if (WaveReadLaneFirst(BindlessParameters_PostProcessAbyssEnter_CD[((int)((uint)(select(((uint)_38 < (uint)170000), _38, 0)) + 0u))]._effectType) == 0) {
    ...
    while(true) {
      ...
      float _117 = (pow(_107.x, 0.012683313339948654f));
      float _118 = (pow(_107.y, 0.012683313339948654f));
      float _119 = (pow(_107.z, 0.012683313339948654f));
      ...
      float _146 = exp2(log2(max(0.0f, (_119 + -0.8359375f)) / (18.8515625f - (_119 * 18.6875f))) * 6.277394771575928f) * 10000.0f;
      if ((_98 * 0.5400000214576721f) > 0.0f) {
        ...
        _155 = -1.0f;
        while(true) {
          float _160 = TEXCOORD.x - ((_150 * _79) * _155);
          float _161 = TEXCOORD.y - ((_151 * _80) * _155);
          float _162 = _160 + -0.5f;
          float _163 = _161 + -0.5f;
          float _172 = rsqrt(dot(float2(_162, _163), float2(_162, _163))) * ((_76 * 0.05999999865889549f) * sqrt((_162 * _162) + (_163 * _163)));
          float _173 = _172 * _162;
          float _175 = _172 * _163;
          float4 _181 = __3__36__0__0__g_postProcessSizeColor.Sample(__0__4__0__0__g_staticBilinearClamp, float2((_160 - _173), (_161 - _175)));
          float4 _183 = __3__36__0__0__g_postProcessSizeColor.Sample(__0__4__0__0__g_staticBilinearClamp, float2(_160, _161));
          float4 _185 = __3__36__0__0__g_postProcessSizeColor.Sample(__0__4__0__0__g_staticBilinearClamp, float2((_173 + _160), (_175 + _161)));
          float _190 = (_181.x * 0.20000000298023224f) + _152;
          float _191 = (_183.y * 0.20000000298023224f) + _153;
          float _192 = (_185.z * 0.20000000298023224f) + _154;
          float _198 = _155 + 0.20000000298023224f;
          if (!(!(_198 <= 1.0f))) {
          ...
          float _203 = 0.5400000214576721f / max(0.0010000000474974513f, _exposure0.x);
          int _210 = WaveReadLaneFirst(_materialIndex);
          float _219 = WaveReadLaneFirst(BindlessParameters_PostProcessAbyssEnter_CD[((int)((uint)(select(((uint)_210 < (uint)170000), _210, 0)) + 0u))]._ppAbyssEnterRatio) * saturate(_98 * 1.0800000429153442f);
    ...
    if (WaveReadLaneFirst(BindlessParameters_PostProcessAbyssEnter_CD[((int)((uint)(select(((uint)_227 < (uint)170000), _227, 0)) + 0u))]._effectType) == 1) {
      float4 _240 = __3__36__0__0__g_postProcessSizeColor.Sample(__0__4__0__0__g_staticBilinearWrap, float2(TEXCOORD.x, TEXCOORD.y));
      float _242 = _240.w + -0.4000000059604645f;
      float _246 = float((uint)uint(_srcTargetSizeAndInv.x * TEXCOORD.x));
      float _247 = float((uint)uint(_srcTargetSizeAndInv.y * TEXCOORD.y));
      float _261 = min(max(((_242 * 6.6666669845581055f) + -1.0f), -1.0f), 1.0f);
      float _266 = (_242 * 0.020000001415610313f) + -0.003000000026077032f;
      _268 = _266;
      _269 = _266;
      _270 = 0.0f;
      _271 = 0.0f;
      ...
      _273 = -1.0f;
      while(true) {
        float _278 = TEXCOORD.x - ((_268 * ((frac(frac(dot(float2(_246, _247), float2(0.0671105608344078f, 0.005837149918079376f))) * 52.98291778564453f) + -0.5f) - (_261 * 8.742277657347586e-08f))) * _273);
        float _279 = TEXCOORD.y - ((_269 * ((frac(frac(dot(float2((_246 + 32.665000915527344f), (_247 + 11.8149995803833f)), float2(0.0671105608344078f, 0.005837149918079376f))) * 52.98291778564453f) + -0.5f) - _261)) * _273);
        float _280 = _278 + -0.5f;
        float _281 = _279 + -0.5f;
        float _290 = rsqrt(dot(float2(_280, _281), float2(_280, _281))) * (((_240.w + -0.30000001192092896f) * 0.0010000000474974513f) * sqrt((_280 * _280) + (_281 * _281)));
        float _291 = _290 * _280;
        float _293 = _290 * _281;
        float4 _299 = __3__36__0__0__g_postProcessSizeColor.Sample(__0__4__0__0__g_staticBilinearClamp, float2((_278 - _291), (_279 - _293)));
        float4 _301 = __3__36__0__0__g_postProcessSizeColor.Sample(__0__4__0__0__g_staticBilinearClamp, float2(_278, _279));
        float4 _303 = __3__36__0__0__g_postProcessSizeColor.Sample(__0__4__0__0__g_staticBilinearClamp, float2((_291 + _278), (_293 + _279)));
        float _311 = ((_299.x * 0.20000000298023224f) + _270) * 0.5f;
        float _312 = ((_301.y * 0.20000000298023224f) + _271) * 0.5f;
        float _313 = ((_303.z * 0.20000000298023224f) + _272) * 0.5f;
        float _316 = _273 + 0.20000000298023224f;
        if (!(!(_316 <= 1.0f))) {
  ...
  bool _339 = (_localToneMappingParams.w > 0.0f);
  if (_339) {
  ...
  if (_etcParams.y > 1.0f) {
    float _703 = abs((TEXCOORD.x * 2.0f) + -1.0f);
    float _704 = abs((TEXCOORD.y * 2.0f) + -1.0f);
    float _708 = saturate(1.0f - (dot(float2(_703, _704), float2(_703, _704)) * saturate(_etcParams.y + -1.0f)));
    _713 = (_708 * _692);
    _714 = (_708 * _693);
    _715 = (_708 * _694);
  } else {
  ...
  float _773 = exp2(log2(_761 * 9.999999747378752e-05f) * 0.1593017578125f);
