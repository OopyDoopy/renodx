...
float4 main(
  ...
  while(true) {
    ...
    float _367 = dot(float3(_246.x, _246.y, _246.z), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f)) * 0.30000001192092896f;
    float _374 = ((_367 - _352) * 0.20000000298023224f) + _352;
    float _375 = ((_367 - _353) * 0.20000000298023224f) + _353;
    float _376 = ((_367 - _354) * 0.20000000298023224f) + _354;
    uint _377 = uint(SV_Position.y);
    if (_etcParams.y == 1.0f) {
      uint2 _384 = __3__36__0__0__g_stencil.Load(int3((int)(uint(SV_Position.x)), (int)(_377), 0));
      _390 = (float((uint)((uint)(_384.x & 127))) + 0.5f);
    } else {
      _390 = 0.0f;
    }
    bool _393 = (_localToneMappingParams.w > 0.0f);
    if (_393) {
      float3 output_color = TonemapReplacer(float3(_374, _375, _376));
      _746 = output_color.x;
      _747 = output_color.y;
      _748 = output_color.z;
    } else {
    ...
    if (_etcParams.y > 1.0f) {
      float _754 = abs(_21);
      float _755 = abs(_22 + -1.0f);
      float _759 = saturate(1.0f - (dot(float2(_754, _755), float2(_754, _755)) * saturate(_etcParams.y + -1.0f)));
      _764 = (_759 * _746);
      _765 = (_759 * _747);
      _766 = (_759 * _748);
    } else {
    ...
    if ((_393) && ((_etcParams.z > 0.0f))) {
      _796 = select((_764 <= 0.0031308000907301903f), (_764 * 12.920000076293945f), (((pow(_764, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
      _797 = select((_765 <= 0.0031308000907301903f), (_765 * 12.920000076293945f), (((pow(_765, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
      _798 = select((_766 <= 0.0031308000907301903f), (_766 * 12.920000076293945f), (((pow(_766, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
    } else {
      _796 = _764;
      _797 = _765;
      _798 = _766;
