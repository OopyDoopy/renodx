...
float4 main(
  ...
  float _930 = exp2(log2(_918 * 9.999999747378752e-05f) * 0.1593017578125f);
  float _931 = exp2(log2(_919 * 9.999999747378752e-05f) * 0.1593017578125f);
  SV_Target.x = exp2(log2((1.0f / ((_929 * 18.6875f) + 1.0f)) * ((_929 * 18.8515625f) + 0.8359375f)) * 78.84375f);
  SV_Target.y = exp2(log2((1.0f / ((_930 * 18.6875f) + 1.0f)) * ((_930 * 18.8515625f) + 0.8359375f)) * 78.84375f);
  SV_Target.z = exp2(log2((1.0f / ((_931 * 18.6875f) + 1.0f)) * ((_931 * 18.8515625f) + 0.8359375f)) * 78.84375f);
  SV_Target.w = _495;
  return SV_Target;
}