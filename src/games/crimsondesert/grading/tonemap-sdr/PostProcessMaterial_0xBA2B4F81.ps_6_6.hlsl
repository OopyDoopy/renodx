...
float4 main(
  ...
  if (_etcParams.y == 1.0f) {
    uint2 _84 = __3__36__0__0__g_stencil.Load(int3((int)(uint(SV_Position.x)), (int)(_77), 0));
    _90 = (float((uint)((uint)(_84.x & 127))) + 0.5f);
  } else {
    _90 = 0.0f;
  }
  bool _93 = (_localToneMappingParams.w > 0.0f);
  if (_93) {
  ...
  if (_etcParams.y > 1.0f) {
    float _457 = abs((TEXCOORD.x * 2.0f) + -1.0f);
    float _458 = abs((TEXCOORD.y * 2.0f) + -1.0f);
    float _462 = saturate(1.0f - (dot(float2(_457, _458), float2(_457, _458)) * saturate(_etcParams.y + -1.0f)));
    _467 = (_462 * _446);
    _468 = (_462 * _447);
    _469 = (_462 * _448);
  } else {
  ...
  float _529 = exp2(log2(_517 * 9.999999747378752e-05f) * 0.1593017578125f);
