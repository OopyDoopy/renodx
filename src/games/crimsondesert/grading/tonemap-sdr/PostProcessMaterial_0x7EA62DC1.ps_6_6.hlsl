...
float4 main(
  ...
  float _660 = exp2(log2(_648 * 9.999999747378752e-05f) * 0.1593017578125f);
  float _661 = exp2(log2(_649 * 9.999999747378752e-05f) * 0.1593017578125f);
  float _662 = exp2(log2(_650 * 9.999999747378752e-05f) * 0.1593017578125f);
