...
renodx::utils::settings::Settings settings = {
    ...
    //     .tooltip = "Sets the tone mapper type.\nVanilla uses the game's default highlight compression, with optional enhancements to the rest of the process.\nPsychoV uses a custom psychovisual tone mapper as a replacement for the final display mapper.",
