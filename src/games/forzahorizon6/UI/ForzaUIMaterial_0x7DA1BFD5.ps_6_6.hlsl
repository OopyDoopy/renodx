...
float4 main(
  ...
  float _132;
  float _133;
  _15 = PSConstants_000.w * TEXCOORD_1.z;
  _18 = t0.Sample(s0, float2(TEXCOORD_2.x, TEXCOORD_2.y));
  _23 = _18.w * _15;
  _29 = _15 * PSConstants_000.x;
  _30 = _29 * _18.x;
  _31 = _30 * PSConstants_016.x;
  _32 = _15 * PSConstants_000.y;
  _33 = _32 * _18.y;
  _34 = _33 * PSConstants_016.y;
  _35 = _15 * PSConstants_000.z;
  _36 = _35 * _18.z;
  _37 = _36 * PSConstants_016.z;
  _38 = _23 * PSConstants_016.w;
  _39 = _38 + 9.999999747378752e-06f;
  _40 = _31 / _39;
  _41 = _34 / _39;
  _42 = _37 / _39;
#if 1
  SV_Target = GenerateUIOutputColor(_40, _41, _42, _38);
#else
