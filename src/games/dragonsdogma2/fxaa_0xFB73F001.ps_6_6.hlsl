...
float4 main(
  ...
  if (!(_36 < max(0.08330000191926956f, (_33 * 0.3330000042915344f)))) {
    float4 _40 = HDRImage.SampleLevel(BilinearClamp, float2(_10, _11), 0.0f, int2(1, -1));
    float4 _42 = HDRImage.SampleLevel(BilinearClamp, float2(_10, _11), 0.0f, int2(-1, 1));
    float _44 = _23.z + _19.x;
    float _45 = _23.x + _19.z;
    float _48 = _14.y * 2.0f;
    float _51 = _40.y + _19.y;
    float _57 = _42.y + _23.w;
    bool _75 = ((((abs(_44 - _48) * 2.0f) + abs(_51 - (_19.z * 2.0f))) + abs(_57 - (_23.x * 2.0f))) >= (((abs(_45 - _48) * 2.0f) + abs((_23.w - (_23.z * 2.0f)) + _40.y)) + abs((_19.y - (_19.x * 2.0f)) + _42.y)));
