#define LUTSAMPLING_NEW_CBUFFER_LAYOUT
#include "../../common/lutsampling.hlsli"
#undef LUTSAMPLING_NEW_CBUFFER_LAYOUT
...
OutputSignature main(
  ...
  const float4 color = CustomLutSampling(TEXCOORD, whitePaperNits);
  OutputSignature output_signature = {color, color};
