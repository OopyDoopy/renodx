...
float4 main(
  ...
  float _99 = saturate(_96 + kerare_brightness);
  CustomVignette(_99);
  _99 *= Exposure;
  if (_41) {
    ...
    do {
      ...
      do {
        ...
        do {
          ...
          float _1936 = _1903 * fNoisePower.x;
          float _1937 = _1935 * fNoisePower.y;
          float _1938 = _1919 * fNoisePower.y;
  ...
  if (!((cPassEnabled & 4) == 0)) {
    bool _2100 = !(_2072 <= 0.0078125f);
    do {
      if (!_2100) {
        _2109 = ((_2072 * 10.540237426757812f) + 0.072905533015728f);
      } else {
        _2109 = ((log2(_2072) + 9.720000267028809f) * 0.05707762390375137f);
      }
      bool _2110 = !(_2073 <= 0.0078125f);
      do {
        if (!_2110) {
          _2119 = ((_2073 * 10.540237426757812f) + 0.072905533015728f);
        } else {
          _2119 = ((log2(_2073) + 9.720000267028809f) * 0.05707762390375137f);
        }
        bool _2120 = !(_2074 <= 0.0078125f);
        do {
          if (!_2120) {
            _2129 = ((_2074 * 10.540237426757812f) + 0.072905533015728f);
          } else {
            _2129 = ((log2(_2074) + 9.720000267028809f) * 0.05707762390375137f);
          }
          float4 _2138 = tTextureMap0.SampleLevel(TrilinearClamp, float3(((_2109 * fOneMinusTextureInverseSize) + fHalfTextureInverseSize), ((_2119 * fOneMinusTextureInverseSize) + fHalfTextureInverseSize), ((_2129 * fOneMinusTextureInverseSize) + fHalfTextureInverseSize)), 0.0f);
          do {
            if (_2138.x < 0.155251145362854f) {
              _2155 = ((_2138.x + -0.072905533015728f) * 0.09487452358007431f);
            } else {
              if ((bool)(_2138.x >= 0.155251145362854f) && (bool)(_2138.x < 1.4679962396621704f)) {
                _2155 = exp2((_2138.x * 17.520000457763672f) + -9.720000267028809f);
              } else {
                _2155 = 65504.0f;
              }
            }
            do {
              if (_2138.y < 0.155251145362854f) {
                _2169 = ((_2138.y + -0.072905533015728f) * 0.09487452358007431f);
              } else {
                if ((bool)(_2138.y >= 0.155251145362854f) && (bool)(_2138.y < 1.4679962396621704f)) {
                  _2169 = exp2((_2138.y * 17.520000457763672f) + -9.720000267028809f);
                } else {
                  _2169 = 65504.0f;
                }
              }
              do {
                if (_2138.z < 0.155251145362854f) {
                  _2183 = ((_2138.z + -0.072905533015728f) * 0.09487452358007431f);
                } else {
                  if ((bool)(_2138.z >= 0.155251145362854f) && (bool)(_2138.z < 1.4679962396621704f)) {
                    _2183 = exp2((_2138.z * 17.520000457763672f) + -9.720000267028809f);
                  } else {
                    _2183 = 65504.0f;
                  }
                }
                float _2184 = max(_2155, 0.0f);
                float _2185 = max(_2169, 0.0f);
                float _2186 = max(_2183, 0.0f);
                do {
                  [branch]
                  if (fTextureBlendRate > 0.0f) {
                    do {
                      if (!_2100) {
                        _2197 = ((_2072 * 10.540237426757812f) + 0.072905533015728f);
                      } else {
                        _2197 = ((log2(_2072) + 9.720000267028809f) * 0.05707762390375137f);
                      }
                      do {
                        if (!_2110) {
                          _2206 = ((_2073 * 10.540237426757812f) + 0.072905533015728f);
                        } else {
                          _2206 = ((log2(_2073) + 9.720000267028809f) * 0.05707762390375137f);
                        }
                        do {
                          if (!_2120) {
                            _2215 = ((_2074 * 10.540237426757812f) + 0.072905533015728f);
                          } else {
                            _2215 = ((log2(_2074) + 9.720000267028809f) * 0.05707762390375137f);
                          }
                          float4 _2223 = tTextureMap1.SampleLevel(TrilinearClamp, float3(((_2197 * fOneMinusTextureInverseSize) + fHalfTextureInverseSize), ((_2206 * fOneMinusTextureInverseSize) + fHalfTextureInverseSize), ((_2215 * fOneMinusTextureInverseSize) + fHalfTextureInverseSize)), 0.0f);
                          do {
                            if (_2223.x < 0.155251145362854f) {
                              _2240 = ((_2223.x + -0.072905533015728f) * 0.09487452358007431f);
                            } else {
                              if ((bool)(_2223.x >= 0.155251145362854f) && (bool)(_2223.x < 1.4679962396621704f)) {
                                _2240 = exp2((_2223.x * 17.520000457763672f) + -9.720000267028809f);
                              } else {
                                _2240 = 65504.0f;
                              }
                            }
                            do {
                              if (_2223.y < 0.155251145362854f) {
                                _2254 = ((_2223.y + -0.072905533015728f) * 0.09487452358007431f);
                              } else {
                                if ((bool)(_2223.y >= 0.155251145362854f) && (bool)(_2223.y < 1.4679962396621704f)) {
                                  _2254 = exp2((_2223.y * 17.520000457763672f) + -9.720000267028809f);
                                } else {
                                  _2254 = 65504.0f;
                                }
                              }
                              do {
                                if (_2223.z < 0.155251145362854f) {
                                  _2268 = ((_2223.z + -0.072905533015728f) * 0.09487452358007431f);
                                } else {
                                  if ((bool)(_2223.z >= 0.155251145362854f) && (bool)(_2223.z < 1.4679962396621704f)) {
                                    _2268 = exp2((_2223.z * 17.520000457763672f) + -9.720000267028809f);
                                  } else {
                                    _2268 = 65504.0f;
                                  }
                                }
                                float _2278 = ((max(_2240, 0.0f) - _2184) * fTextureBlendRate) + _2184;
                                float _2279 = ((max(_2254, 0.0f) - _2185) * fTextureBlendRate) + _2185;
                                float _2280 = ((max(_2268, 0.0f) - _2186) * fTextureBlendRate) + _2186;
                                if (fTextureBlendRate2 > 0.0f) {
                                  do {
                                    if (!(!(_2278 <= 0.0078125f))) {
                                      _2292 = ((_2278 * 10.540237426757812f) + 0.072905533015728f);
                                    } else {
                                      _2292 = ((log2(_2278) + 9.720000267028809f) * 0.05707762390375137f);
                                    }
                                    do {
                                      if (!(!(_2279 <= 0.0078125f))) {
                                        _2302 = ((_2279 * 10.540237426757812f) + 0.072905533015728f);
                                      } else {
                                        _2302 = ((log2(_2279) + 9.720000267028809f) * 0.05707762390375137f);
                                      }
                                      do {
                                        if (!(!(_2280 <= 0.0078125f))) {
                                          _2312 = ((_2280 * 10.540237426757812f) + 0.072905533015728f);
                                        } else {
                                          _2312 = ((log2(_2280) + 9.720000267028809f) * 0.05707762390375137f);
                                        }
                                        float4 _2320 = tTextureMap2.SampleLevel(TrilinearClamp, float3(((_2292 * fOneMinusTextureInverseSize) + fHalfTextureInverseSize), ((_2302 * fOneMinusTextureInverseSize) + fHalfTextureInverseSize), ((_2312 * fOneMinusTextureInverseSize) + fHalfTextureInverseSize)), 0.0f);
                                        do {
                                          if (_2320.x < 0.155251145362854f) {
                                            _2337 = ((_2320.x + -0.072905533015728f) * 0.09487452358007431f);
                                          } else {
                                            if ((bool)(_2320.x >= 0.155251145362854f) && (bool)(_2320.x < 1.4679962396621704f)) {
                                              _2337 = exp2((_2320.x * 17.520000457763672f) + -9.720000267028809f);
                                            } else {
                                              _2337 = 65504.0f;
                                            }
                                          }
                                          do {
                                            if (_2320.y < 0.155251145362854f) {
                                              _2351 = ((_2320.y + -0.072905533015728f) * 0.09487452358007431f);
                                            } else {
                                              if ((bool)(_2320.y >= 0.155251145362854f) && (bool)(_2320.y < 1.4679962396621704f)) {
                                                _2351 = exp2((_2320.y * 17.520000457763672f) + -9.720000267028809f);
                                              } else {
                                                _2351 = 65504.0f;
                                              }
                                            }
                                            do {
                                              if (_2320.z < 0.155251145362854f) {
                                                _2365 = ((_2320.z + -0.072905533015728f) * 0.09487452358007431f);
                                              } else {
                                                if ((bool)(_2320.z >= 0.155251145362854f) && (bool)(_2320.z < 1.4679962396621704f)) {
                                                  _2365 = exp2((_2320.z * 17.520000457763672f) + -9.720000267028809f);
                                                } else {
                                                  _2365 = 65504.0f;
                                                }
                                              }
                                              _2477 = (((max(_2337, 0.0f) - _2278) * fTextureBlendRate2) + _2278);
                                              _2478 = (((max(_2351, 0.0f) - _2279) * fTextureBlendRate2) + _2279);
                                              _2479 = (((max(_2365, 0.0f) - _2280) * fTextureBlendRate2) + _2280);
                                            } while (false);
                                          } while (false);
                                        } while (false);
                                      } while (false);
                    ...
                    if (fTextureBlendRate2 > 0.0f) {
                      do {
                        if (!(!(_2184 <= 0.0078125f))) {
                          _2390 = ((_2184 * 10.540237426757812f) + 0.072905533015728f);
                        } else {
                          _2390 = ((log2(_2184) + 9.720000267028809f) * 0.05707762390375137f);
                        }
                        do {
                          if (!(!(_2185 <= 0.0078125f))) {
                            _2400 = ((_2185 * 10.540237426757812f) + 0.072905533015728f);
                          } else {
                            _2400 = ((log2(_2185) + 9.720000267028809f) * 0.05707762390375137f);
                          }
                          do {
                            if (!(!(_2186 <= 0.0078125f))) {
                              _2410 = ((_2186 * 10.540237426757812f) + 0.072905533015728f);
                            } else {
                              _2410 = ((log2(_2186) + 9.720000267028809f) * 0.05707762390375137f);
                            }
                            float4 _2418 = tTextureMap2.SampleLevel(TrilinearClamp, float3(((_2390 * fOneMinusTextureInverseSize) + fHalfTextureInverseSize), ((_2400 * fOneMinusTextureInverseSize) + fHalfTextureInverseSize), ((_2410 * fOneMinusTextureInverseSize) + fHalfTextureInverseSize)), 0.0f);
                            do {
                              if (_2418.x < 0.155251145362854f) {
                                _2435 = ((_2418.x + -0.072905533015728f) * 0.09487452358007431f);
                              } else {
                                if ((bool)(_2418.x >= 0.155251145362854f) && (bool)(_2418.x < 1.4679962396621704f)) {
                                  _2435 = exp2((_2418.x * 17.520000457763672f) + -9.720000267028809f);
                                } else {
                                  _2435 = 65504.0f;
                                }
                              }
                              do {
                                if (_2418.y < 0.155251145362854f) {
                                  _2449 = ((_2418.y + -0.072905533015728f) * 0.09487452358007431f);
                                } else {
                                  if ((bool)(_2418.y >= 0.155251145362854f) && (bool)(_2418.y < 1.4679962396621704f)) {
                                    _2449 = exp2((_2418.y * 17.520000457763672f) + -9.720000267028809f);
                                  } else {
                                    _2449 = 65504.0f;
                                  }
                                }
                                do {
                                  if (_2418.z < 0.155251145362854f) {
                                    _2463 = ((_2418.z + -0.072905533015728f) * 0.09487452358007431f);
                                  } else {
                                    if ((bool)(_2418.z >= 0.155251145362854f) && (bool)(_2418.z < 1.4679962396621704f)) {
                                      _2463 = exp2((_2418.z * 17.520000457763672f) + -9.720000267028809f);
                                    } else {
                                      _2463 = 65504.0f;
                                    }
                                  }
                                  _2477 = (((max(_2435, 0.0f) - _2184) * fTextureBlendRate2) + _2184);
                                  _2478 = (((max(_2449, 0.0f) - _2185) * fTextureBlendRate2) + _2185);
                                  _2479 = (((max(_2463, 0.0f) - _2186) * fTextureBlendRate2) + _2186);
                                } while (false);
                              } while (false);
                            } while (false);
                          } while (false);
                  ...
                  _2498 = max((mad(_2479, (fColorMatrix[2].z), mad(_2478, (fColorMatrix[1].z), (_2477 * (fColorMatrix[0].z)))) + (fColorMatrix[3].z)), 0.0f);
                } while (false);
              } while (false);
            } while (false);
          } while (false);
  ...
  float _2501 = min(_2498, 65000.0f);
  if (!((cPassEnabled & 8) == 0)) {
    _2533 = (((cvdR.x * _2499) + (cvdR.y * _2500)) + (cvdR.z * _2501));
    _2534 = (((cvdG.x * _2499) + (cvdG.y * _2500)) + (cvdG.z * _2501));
    _2535 = (((cvdB.x * _2499) + (cvdB.y * _2500)) + (cvdB.z * _2501));
  } else {
    _2533 = _2499;
    _2534 = _2500;
    _2535 = _2501;
  ...
  if (!((cPassEnabled & 16) == 0)) {
    float _2547 = screenInverseSize.x * SV_Position.x;
    float _2548 = screenInverseSize.y * SV_Position.y;
    float4 _2551 = ImagePlameBase.SampleLevel(BilinearClamp, float2(_2547, _2548), 0.0f);
    float _2556 = _2551.x * ColorParam.x;
    float _2557 = _2551.y * ColorParam.y;
    float _2558 = _2551.z * ColorParam.z;
    float _2561 = ImagePlameAlpha.SampleLevel(BilinearClamp, float2(_2547, _2548), 0.0f);
    float _2566 = (_2551.w * ColorParam.w) * saturate((_2561.x * Levels_Rate) + Levels_Range);
    do {
      if (_2556 < 0.5f) {
        _2578 = ((_2533 * 2.0f) * _2556);
      } else {
        _2578 = (1.0f - (((1.0f - _2533) * 2.0f) * (1.0f - _2556)));
      }
      do {
        if (_2557 < 0.5f) {
          _2590 = ((_2534 * 2.0f) * _2557);
        } else {
          _2590 = (1.0f - (((1.0f - _2534) * 2.0f) * (1.0f - _2557)));
        }
        do {
          if (_2558 < 0.5f) {
            _2602 = ((_2535 * 2.0f) * _2558);
          } else {
            _2602 = (1.0f - (((1.0f - _2535) * 2.0f) * (1.0f - _2558)));
          }
          _2613 = (lerp(_2533, _2578, _2566));
          _2614 = (lerp(_2534, _2590, _2566));
          _2615 = (lerp(_2535, _2602, _2566));
        } while (false);
      } while (false);
    } while (false);
  } else {
