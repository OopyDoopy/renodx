// ---- Created with 3Dmigoto v1.4.1 on Tue Apr 22 00:20:52 2025
  ...
  out float4 o0 : SV_TARGET0)
{
 ...
 //r6.xyzw = (int4)r6.xyzw & asint(cb3[44].xyzw);
 //r6.xyzw = (int4)r6.xyzw | asint(cb3[45].xyzw);
  r7.xyzw = t0.Sample(s0_s, r5.xy).xyzw;
 //r7.xyzw = (int4)r7.xyzw & asint(cb3[44].xyzw);
 //r7.xyzw = (int4)r7.xyzw | asint(cb3[45].xyzw);
 ...
 //r4.xyzw = (int4)r4.xyzw | asint(cb3[45].xyzw);
  ...
  r0.x = -cb4[8].z + v5.x;
  r1.w = dot(r5.xyz, float3(0.330000013,0.330000013,0.330000013));
  r9.xyzw = t0.Sample(s0_s, r1.xy).xyzw;
 //r9.xyzw = (int4)r9.xyzw & asint(cb3[44].xyzw);
 //r9.xyzw = (int4)r9.xyzw | asint(cb3[45].xyzw);
  r10.xyzw = t0.Sample(s0_s, r2.xy).xyzw;
 //r10.xyzw = (int4)r10.xyzw & asint(cb3[44].xyzw);
 //r10.xyzw = (int4)r10.xyzw | asint(cb3[45].xyzw);
  r2.xyzw = r4.xyzw + r4.xyzw;
  r5.xyzw = r10.xyzw + r9.xyzw;
  r0.w = r1.w * 3 + -0.100000001;
  r5.xyzw = float4(2,2,2,2) * r5.xyzw + r2.xyzw;
  r0.y = v5.y;
  r1.xyz = float3(0.166666999,0.166666999,0.166666999) * r5.xyz;
  r11.x = cb4[8].z + v5.x;
  r0.z = dot(r1.xyz, float3(0.330000013,0.330000013,0.330000013));
  r1.xyzw = r5.xyzw * float4(0.166666999,0.166666999,0.166666999,0.166666999) + -r4.xyzw;
  r12.y = cmp(0 < abs(r0.z));
  r12.x = rcp(r0.z);
  r5.w = r12.y ? r12.x : 99999999;
  r0.w = saturate(r5.w * r0.w);
  r8.x = v5.x;
  r12.xyzw = t0.Sample(s0_s, r3.xy).xyzw;
 //r12.xyzw = (int4)r12.xyzw & asint(cb3[44].xyzw);
 //r12.xyzw = (int4)r12.xyzw | asint(cb3[45].xyzw);
  r13.xyzw = t0.Sample(s0_s, r8.xy).xyzw;
 //r13.xyzw = (int4)r13.xyzw & asint(cb3[44].xyzw);
 //r13.xyzw = (int4)r13.xyzw | asint(cb3[45].xyzw);
 ...
 //r11.xyzw = (int4)r11.xyzw & asint(cb3[44].xyzw);
 //r11.xyzw = (int4)r11.xyzw | asint(cb3[45].xyzw);
  r2.xyz = r11.xyz + r0.xyz;
  r2.w = dot(r1.xyz, float3(0.330000013,0.330000013,0.330000013));
  r2.xyz = float3(2,2,2) * -r4.xyz + r2.xyz;
  r16.y = cmp(0 < abs(r2.w));
  r16.x = rcp(r2.w);
  r15.w = r16.y ? r16.x : 99999999;
 ...
 //r16.xyzw = (int4)r16.xyzw & asint(cb3[44].xyzw);
 //r16.xyzw = (int4)r16.xyzw | asint(cb3[45].xyzw);
  r1.z = r16.w + r10.w;
  r2.x = r2.z * 5.5 + v5.x;
  r2.y = v5.y;
  r17.xyzw = t0.Sample(s0_s, r2.xy).xyzw;
 //r17.xyzw = (int4)r17.xyzw & asint(cb3[44].xyzw);
 //r17.xyzw = (int4)r17.xyzw | asint(cb3[45].xyzw);
  r1.z = r17.w + r1.z;
  r2.x = r2.z * 7.5 + v5.x;
  r2.y = v5.y;
  r18.xyzw = t0.Sample(s0_s, r2.xy).xyzw;
 //r18.xyzw = (int4)r18.xyzw & asint(cb3[44].xyzw);
 //r18.xyzw = (int4)r18.xyzw | asint(cb3[45].xyzw);
  r2.y = r18.w + r1.z;
 ...
 //r19.xyzw = (int4)r19.xyzw & asint(cb3[44].xyzw);
 //r19.xyzw = (int4)r19.xyzw | asint(cb3[45].xyzw);
  r1.w = r19.w + r1.w;
  r2.x = r2.z * -5.5 + v5.x;
  r2.y = v5.y;
  r20.xyzw = t0.Sample(s0_s, r2.xy).xyzw;
 //r20.xyzw = (int4)r20.xyzw & asint(cb3[44].xyzw);
 //r20.xyzw = (int4)r20.xyzw | asint(cb3[45].xyzw);
  r1.w = r20.w + r1.w;
  r2.x = r2.z * -7.5 + v5.x;
  r2.y = v5.y;
  r8.xyzw = t0.Sample(s0_s, r2.xy).xyzw;
 //r8.xyzw = (int4)r8.xyzw & asint(cb3[44].xyzw);
 //r8.xyzw = (int4)r8.xyzw | asint(cb3[45].xyzw);
  r2.y = r2.w * 3.5 + v5.y;
  r2.x = v5.x;
  r21.xyzw = t0.Sample(s0_s, r2.xy).xyzw;
 //r21.xyzw = (int4)r21.xyzw & asint(cb3[44].xyzw);
 //r21.xyzw = (int4)r21.xyzw | asint(cb3[45].xyzw);
  r2.z = r21.w + r13.w;
  r2.y = r2.w * 5.5 + v5.y;
  r2.x = v5.x;
  r22.xyzw = t0.Sample(s0_s, r2.xy).xyzw;
 //r22.xyzw = (int4)r22.xyzw & asint(cb3[44].xyzw);
 //r22.xyzw = (int4)r22.xyzw | asint(cb3[45].xyzw);
  r2.z = r22.w + r2.z;
  r2.y = r2.w * 7.5 + v5.y;
  r2.x = v5.x;
  r23.xyzw = t0.Sample(s0_s, r2.xy).xyzw;
 //r23.xyzw = (int4)r23.xyzw & asint(cb3[44].xyzw);
 //r23.xyzw = (int4)r23.xyzw | asint(cb3[45].xyzw);
  r2.z = r23.w + r2.z;
  r8.w = r8.w + r1.w;
  r2.z = r2.z + r12.w;
  r2.y = r2.w * -3.5 + v5.y;
 ...
 //r2.xyzw = (int4)r2.xyzw | asint(cb3[45].xyzw);
  ...
  if (r24.x != 0) {
    ...
    r1.y = dot(r1.xyz, float3(0.330000013,0.330000013,0.330000013));
    r2.xyz = float3(0.125,0.125,0.125) * r2.xyz;
    r1.w = dot(r4.xyz, float3(0.330000013,0.330000013,0.330000013));
    r2.w = dot(r11.xyz, float3(0.330000013,0.330000013,0.330000013));
    r2.x = dot(r2.xyz, float3(0.330000013,0.330000013,0.330000013));
    r2.z = -r2.w + r1.w;
    r2.w = r2.x + -r1.w;
    r24.y = cmp(0 < abs(r2.z));
    r24.x = rcp(r2.z);
    r2.z = r24.y ? r24.x : 99999999;
    r2.y = saturate(r2.w * r2.z + 1);
    r2.z = dot(r7.xyz, float3(0.330000013,0.330000013,0.330000013));
    r2.w = -r1.w + r1.y;
    r2.z = -r2.z + r1.w;
    r24.y = cmp(0 < abs(r2.z));
    r24.x = rcp(r2.z);
    r2.z = r24.y ? r24.x : 99999999;
    r1.x = dot(r0.xyz, float3(0.330000013,0.330000013,0.330000013));
    r2.w = saturate(r2.w * r2.z + 1);
    r2.z = -r1.x + r1.w;
    r24.y = cmp(0 < abs(r2.z));
    r24.x = rcp(r2.z);
    r1.z = r24.y ? r24.x : 99999999;
    r2.z = dot(r6.xyz, float3(0.330000013,0.330000013,0.330000013));
    r2.x = -r1.x + r2.x;
    r1.w = -r2.z + r1.w;
    r24.y = cmp(0 < abs(r1.w));
    r24.x = rcp(r1.w);
    r1.w = r24.y ? r24.x : 99999999;
    r2.z = -r2.z + r1.y;
