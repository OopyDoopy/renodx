...
// ---- Created with 3Dmigoto v1.4.1 on Fri Apr 18 22:29:24 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xyzw = r3.xyzw * float4(0.0625,0.0625,0.0625,0.0625) + r2.xyzw;
  ...
  r2.xyzw = r4.xyzw * float4(0.125,0.125,0.125,0.125) + r2.xyzw;
  r3.xy = saturate(v1.xy);
  r3.xy = cb0[26].xx * r3.xy;
  r4.xyzw = t2.Sample(s2_s, r3.xy).xyzw;
  r2.xyzw = r4.xyzw * float4(0.25,0.25,0.25,0.25) + r2.xyzw;
  r3.xyzw = t2.Sample(s2_s, r3.zw).xyzw;
  r2.xyzw = r3.xyzw * float4(0.125,0.125,0.125,0.125) + r2.xyzw;
  r3.xyzw = saturate(r0.zywy * cb0[34].xxxx + v1.xyxy);
  r3.xyzw = cb0[26].xxxx * r3.xyzw;
  r4.xyzw = t2.Sample(s2_s, r3.xy).xyzw;
  r2.xyzw = r4.xyzw * float4(0.0625,0.0625,0.0625,0.0625) + r2.xyzw;
  r3.xyzw = t2.Sample(s2_s, r3.zw).xyzw;
  r2.xyzw = r3.xyzw * float4(0.125,0.125,0.125,0.125) + r2.xyzw;
