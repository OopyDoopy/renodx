// ---- Created with 3Dmigoto v1.4.1 on Fri Apr 18 21:49:58 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = saturate(cb0[28].xyxy * float4(-1,-1,1,-1) + v1.xyxy);
  ...
  r1.xyzw = saturate(cb0[28].xyxy * float4(-1,1,1,1) + v1.xyxy);
