...
renodx::mods::shader::CustomShaders custom_shaders = {
    CustomShaderEntry(0xE5994A4B),  // Uber
    CustomShaderEntry(0xBE655D3E),  // Uber2
    CustomShaderEntry(0xB354D940),  // Uber3
    CustomShaderEntry(0x53F10D59),  // Uber4
    CustomShaderEntry(0xABF2B519),  // Final Post
...
extern "C" __declspec(dllexport) constexpr const char* DESCRIPTION = "RenoDX for Risk of Rain 2";
