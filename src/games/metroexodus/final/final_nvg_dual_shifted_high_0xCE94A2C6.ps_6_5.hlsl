...
float4 main(
  ...
  _734 = _729 * 1.4142135381698608f;
  _735 = _730 * 1.4142135381698608f;
  _736 = _731 * 1.4142135381698608f;
  _802 = saturate((cb_instance_016.y * _22.w) * _37);
  _809 = (_22.x * 0.14000000059604645f) + -0.5699999928474426f;
  _810 = (_22.y * 0.14000000059604645f) + -0.5699999928474426f;
  _812 = rsqrt(dot(float3(_809, _810, 1.0f), float3(_809, _810, 1.0f)));
  _824 = (dot(float3((-0.0f - cb_misc_272.x), (-0.0f - cb_misc_272.y), (-0.0f - cb_misc_272.z)), float3((_812 * _809), (_812 * _810), _812)) * 0.5f) + 1.0f;
  _832 = saturate(cb_misc_288.x);
  _851 = (saturate((_38 * 2.0f) + (_802 * (_22.w - _38))) * _38) * (min(_832, (dot(float3(_832, saturate(cb_misc_288.y), saturate(cb_misc_288.z)), float3(0.5f, 0.5f, 0.5f)) * 0.30000001192092896f)) + 0.10000000149011612f);
  _856 = ((_20.w * _20.w) * _38) * _851;
  _858 = 1.0f - (_38 * _38);
  _865 = _851 * ((saturate(max((_824 * _824), 0.25f)) * 0.4999999701976776f) + 0.4000000059604645f);
  _869 = (_865 * ((((((_22.z * 0.14000000059604645f) + -0.07000000029802322f) * _22.w) * _802) + (_38 * _20.x)) + _856)) + (_858 * max((((((((((_729 * 3830.7001953125f) + 6801.15234375f) * _734) + 1079.54736328125f) * _734) + 1.1614649295806885f) * _734) + -4.139374868827872e-05f) / ((((((((_729 * 1390.7225341796875f) + 4132.06640625f) * _734) + 2881.652099609375f) * _734) + 128.35911560058594f) * _734) + 1.0f)), 0.0f));
  _870 = (_865 * ((((((_22.w * 0.14000000059604645f) + -0.07000000029802322f) * _22.w) * _802) + (_38 * _20.y)) + _856)) + (_858 * max((((((((((_730 * 3830.7001953125f) + 6801.15234375f) * _735) + 1079.54736328125f) * _735) + 1.1614649295806885f) * _735) + -4.139374868827872e-05f) / ((((((((_730 * 1390.7225341796875f) + 4132.06640625f) * _735) + 2881.652099609375f) * _735) + 128.35911560058594f) * _735) + 1.0f)), 0.0f));
  _871 = (_865 * ((((_22.z * _22.w) * _802) + (_38 * _20.z)) + _856)) + (_858 * max((((((((((_731 * 3830.7001953125f) + 6801.15234375f) * _736) + 1079.54736328125f) * _736) + 1.1614649295806885f) * _736) + -4.139374868827872e-05f) / ((((((((_731 * 1390.7225341796875f) + 4132.06640625f) * _736) + 2881.652099609375f) * _736) + 128.35911560058594f) * _736) + 1.0f)), 0.0f));
  _874 = max(max(max(_869, _870), _871), 9.999999974752427e-07f);
  _885 = select((abs(1.0f - _874) < 0.5249999761581421f), ((((5.809524059295654f - (_874 * 1.9047620296478271f)) * _874) + -0.42976200580596924f) * 0.25f), saturate(_874)) / _874;
  _886 = _869 * _885;
  _887 = _870 * _885;
  _888 = _871 * _885;
  min16float4 _889 = t3.Sample(s6, float3(_888, _887, _886));
  _908 = saturate((_886 + -1.0f) + (float(_889.z) * 2.0f)) / _885;
  _909 = saturate((_887 + -1.0f) + (float(_889.y) * 2.0f)) / _885;
  _910 = saturate((_888 + -1.0f) + (float(_889.x) * 2.0f)) / _885;
  _943 = (((((((_719 * 2.0f) + _626) * 0.5f) + 0.5f) + cb_misc_704.x) * 0.008331298828125f) + 0.008331298828125f) * (frac(sin(dot(float2((cb_misc_576.w + _18), (cb_misc_576.w + _19)), float2(12.989800453186035f, 78.23300170898438f))) * 43758.546875f) + -0.5f);
  _944 = _943 + sqrt(max(0.0f, ((cb_misc_272.w * (2.700000047683716f - _908)) + _908)));
  _945 = sqrt(max(0.0f, ((cb_misc_272.w * (2.700000047683716f - _909)) + _909))) + _943;
  _946 = sqrt(max(0.0f, ((cb_misc_272.w * (2.700000047683716f - _910)) + _910))) + _943;
  min16float4 _950 = t1.SampleLevel(s6, float2(_18, _19), 0.0f);
  _958 = float(_950.w);
  _965 = max(6.103519990574569e-05f, (((_944 * _944) * _958) + float(_950.x)));
  _966 = max(6.103519990574569e-05f, (((_945 * _945) * _958) + float(_950.y)));
  _967 = max(6.103519990574569e-05f, (((_946 * _946) * _958) + float(_950.z)));
  _989 = select((_965 > 0.040449999272823334f), exp2(log2((_965 * 0.9478672742843628f) + 0.05213269963860512f) * 2.4000000953674316f), (_965 * 0.07739938050508499f));
  _990 = select((_966 > 0.040449999272823334f), exp2(log2((_966 * 0.9478672742843628f) + 0.05213269963860512f) * 2.4000000953674316f), (_966 * 0.07739938050508499f));
  _991 = select((_967 > 0.040449999272823334f), exp2(log2((_967 * 0.9478672742843628f) + 0.05213269963860512f) * 2.4000000953674316f), (_967 * 0.07739938050508499f));
  _1002 = cb_misc_704.y * 9.999999747378752e-05f;
  _1015 = exp2(log2(abs(_1002 * mad(0.04331360012292862f, _991, mad(0.3292819857597351f, _990, (_989 * 0.627403974533081f))))) * 0.1593017578125f);
  _1016 = exp2(log2(abs(_1002 * mad(0.011361200362443924f, _991, mad(0.9195399880409241f, _990, (_989 * 0.06909699738025665f))))) * 0.1593017578125f);
  _1017 = exp2(log2(abs(_1002 * mad(0.8955950140953064f, _991, mad(0.08801320195198059f, _990, (_989 * 0.01639159955084324f))))) * 0.1593017578125f);
  SV_Target.x = exp2(log2(((_1015 * 18.8515625f) + 0.8359375f) / ((_1015 * 18.6875f) + 1.0f)) * 78.84375f);
  SV_Target.y = exp2(log2(((_1016 * 18.8515625f) + 0.8359375f) / ((_1016 * 18.6875f) + 1.0f)) * 78.84375f);
  SV_Target.z = exp2(log2(((_1017 * 18.8515625f) + 0.8359375f) / ((_1017 * 18.6875f) + 1.0f)) * 78.84375f);
  SV_Target.w = 1.0f;
  return SV_Target;
}