...
void main(uint3 vThreadID: SV_DispatchThreadID) {
  ...
  if (r0.a != 0) {
    ...
    //r0.rgb = lerp(preContrast, r0.rgb, CUSTOM_LUT_STRENGTH);
    ...
    //r0.rgb = lerp(preCG, r0.rgb, lut_config.strength);
    ...
    if (RENODX_TONE_MAP_TYPE == 0.f) {
      ...
      outputColor = renodx::draw::ToneMapPass(preCG, untonemapped);
      //outputColor = renodx::draw::ToneMapPass(preCG);
    }
