...
#define RENODX_TONE_MAP_TYPE                 1 // 0 = Vanilla, 1 = None, 2 = ACES, 3 = RenoDRT
...
#define RENODX_COLOR_GRADE_STRENGTH          (100.f * 0.01f) //shader_injection.tone_map_color_grade_strength
//#define RENODX_SWAP_CHAIN_CLAMP_COLOR_SPACE  color::convert::COLOR_SPACE_BT2020
#define CUSTOM_COLOR_GRADE_TWO               (100.f * 0.01f) //shader_injection.custom_color_grading_two
#define CUSTOM_SCENE_GRADE_METHOD              shader_injection.scene_grade_method
#define CUSTOM_SCENE_GRADE_HUE_CORRECTION      (100.f * 0.01f) //shader_injection.scene_grade_hue_correction
#define CUSTOM_SCENE_GRADE_SATURATION_CORRECTION (100.f * 0.01f) //shader_injection.scene_grade_saturation_correction
#define CUSTOM_SCENE_GRADE_BLOWOUT_RESTORATION (50.f * 0.01f) //shader_injection.scene_grade_blowout_restoration
#define CUSTOM_SCENE_GRADE_HUE_SHIFT           (50.f * 0.01f) //shader_injection.scene_grade_hue_shift
#define CUSTOM_FILM_GRAIN_STRENGTH           (50.f * 0.01f) //shader_injection.custom_film_grain_strength
#define CUSTOM_RANDOM                        shader_injection.custom_random
#define CUSTOM_BLOOM_STRENGTH                (50.f * 0.01f) //shader_injection.custom_bloom_strength
#define CUSTOM_LENS_FLARE                    (50.f * 0.01f) //shader_injection.custom_lens_flare
#define CUSTOM_LENS_DIRT                     (50.f * 0.01f) //shader_injection.custom_lens_dirt
#define CUSTOM_ANTI_ALIASING                 1.f //shader_injection.custom_anti_aliasing
