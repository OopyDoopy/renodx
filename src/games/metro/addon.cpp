...
//     // },
    new renodx::utils::settings::Setting{
        ...
        .label = "This mod requires the use of ReShade shaders (such as AdvancedAutoHDR.fx or lilium__tone_mapping.fx) in order to scale brightness and apply tonemapping!",
