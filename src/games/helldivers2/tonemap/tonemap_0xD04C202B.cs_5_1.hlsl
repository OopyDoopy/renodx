...
void comp_main()
{
    ...
    aces_parameters.diffuse_white_nits = RENODX_DIFFUSE_WHITE_NITS;
        ...
        if (RENODX_TONE_MAP_TYPE != 0.f) {
            if (_582) {
                float3 scene_color = float3(_1027.x, _1027.y, _1027.z);
    ...
    if (_582)
    {
      ...
      float3 bt2020_color = renodx::color::bt2020::from::XYZ(_1801);
    float3 pq_color = renodx::color::pq::EncodeSafe(bt2020_color, 1.f);
      u0[uint2(_397, _398)] = float4(pq_color, 1.f);
    }
}
