...
float4 main(
  ...
  float _602 = min(max((mad(_586, (fColorMatrix[2].x), mad(_585, (fColorMatrix[1].x), (_584 * (fColorMatrix[0].x)))) + (fColorMatrix[3].x)), 0.0f), 65000.0f);
  float _603 = min(max((mad(_586, (fColorMatrix[2].y), mad(_585, (fColorMatrix[1].y), (_584 * (fColorMatrix[0].y)))) + (fColorMatrix[3].y)), 0.0f), 65000.0f);
  float _604 = min(max((mad(_586, (fColorMatrix[2].z), mad(_585, (fColorMatrix[1].z), (_584 * (fColorMatrix[0].z)))) + (fColorMatrix[3].z)), 0.0f), 65000.0f);
#endif
