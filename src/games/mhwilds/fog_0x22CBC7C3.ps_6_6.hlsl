...
cbuffer LightInfo : register(b3) {
  ...
  float ContactShadowThicknessHalf : packoffset(c003.z);
...
float4 main(
  ...
  if (fogMaxOpacity > 0.0f) {
    ...
    float _576 = max(0.0f, ((_568 * _567) - fogStartDistance));
    float _582 = (_576 * _572) * fogDensity;
    do {
      if (abs(-0.0f - _582) > 9.999999747378752e-06f) {
        _594 = ((1.0f - exp2(_582 * -1.4426950216293335f)) / _572);
      } else {
        _594 = (fogDensity * _576);
      }
      float _599 = min(fogMaxOpacity, (exp2((fogHeightFalloff * -1.4426950216293335f) * max(0.0f, (_71 - fogHeightStartDistance))) * _594));
      _608 = (fogInscatteringColor.x * _599);
      _609 = (fogInscatteringColor.y * _599);
      _610 = (fogInscatteringColor.z * _599);
      _611 = (1.0f - _599);
    } while (false);
  } else {
    _608 = 0.0f;
