...
float4 main(
  ...
  float _675 = min(max((mad(_659, (fColorMatrix[2].x), mad(_658, (fColorMatrix[1].x), (_657 * (fColorMatrix[0].x)))) + (fColorMatrix[3].x)), 0.0f), 65000.0f);
  float _676 = min(max((mad(_659, (fColorMatrix[2].y), mad(_658, (fColorMatrix[1].y), (_657 * (fColorMatrix[0].y)))) + (fColorMatrix[3].y)), 0.0f), 65000.0f);
  float _677 = min(max((mad(_659, (fColorMatrix[2].z), mad(_658, (fColorMatrix[1].z), (_657 * (fColorMatrix[0].z)))) + (fColorMatrix[3].z)), 0.0f), 65000.0f);
#endif
