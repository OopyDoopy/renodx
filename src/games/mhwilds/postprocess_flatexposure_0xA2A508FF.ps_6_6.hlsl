...
float4 main(
  ...
  if (!((cPassEnabled & 4) == 0)) {
    ...
    float3 new_color = CustomLUTColor(float3(_2128, _2129, _2130), lut_output);
    _2540 = new_color.r;
    _2541 = new_color.g;
    _2542 = new_color.b;
  } else {
...
#if 0  // Original manual LUT sampling
  if (!((cPassEnabled & 4) == 0)) {
            ...
            do {
              ...
              do {
                ...
                do {
                  ...
                  _2540 = max((mad(_2523, (fColorMatrix[2].x), mad(_2522, (fColorMatrix[1].x), (_2521 * (fColorMatrix[0].x)))) + (fColorMatrix[3].x)), 0.0f);
                  _2541 = max((mad(_2523, (fColorMatrix[2].y), mad(_2522, (fColorMatrix[1].y), (_2521 * (fColorMatrix[0].y)))) + (fColorMatrix[3].y)), 0.0f);
                  _2542 = max((mad(_2523, (fColorMatrix[2].z), mad(_2522, (fColorMatrix[1].z), (_2521 * (fColorMatrix[0].z)))) + (fColorMatrix[3].z)), 0.0f);
                } while (false);
              } while (false);
            } while (false);
          } while (false);
...
#endif
  float _2543 = min(_2540, 65000.0f);
  float _2544 = min(_2541, 65000.0f);
  float _2545 = min(_2542, 65000.0f);
  bool _2548 = isfinite(max(max(_2543, _2544), _2545));
  float _2549 = select(_2548, _2543, 1.0f);
  float _2550 = select(_2548, _2544, 1.0f);
  float _2551 = select(_2548, _2545, 1.0f);
  if (!((cPassEnabled & 8) == 0)) {
    _2586 = saturate(((cvdR.x * _2549) + (cvdR.y * _2550)) + (cvdR.z * _2551));
    _2587 = saturate(((cvdG.x * _2549) + (cvdG.y * _2550)) + (cvdG.z * _2551));
    _2588 = saturate(((cvdB.x * _2549) + (cvdB.y * _2550)) + (cvdB.z * _2551));
  } else {
    _2586 = _2549;
    _2587 = _2550;
    _2588 = _2551;
  ...
  if (!((cPassEnabled & 16) == 0)) {
    float _2603 = screenInverseSize.x * SV_Position.x;
    float _2604 = screenInverseSize.y * SV_Position.y;
    float4 _2607 = ImagePlameBase.SampleLevel(BilinearClamp, float2(_2603, _2604), 0.0f);
    float _2612 = _2607.x * ColorParam.x;
    float _2613 = _2607.y * ColorParam.y;
    float _2614 = _2607.z * ColorParam.z;
    float _2617 = ImagePlameAlpha.SampleLevel(BilinearClamp, float2(_2603, _2604), 0.0f);
    float _2622 = (_2607.w * ColorParam.w) * saturate((_2617.x * Levels_Rate) + Levels_Range);
    do {
      if (_2612 < 0.5f) {
        _2634 = ((_2586 * 2.0f) * _2612);
      } else {
        _2634 = (1.0f - (((1.0f - _2586) * 2.0f) * (1.0f - _2612)));
      }
      do {
        if (_2613 < 0.5f) {
          _2646 = ((_2587 * 2.0f) * _2613);
        } else {
          _2646 = (1.0f - (((1.0f - _2587) * 2.0f) * (1.0f - _2613)));
        }
        do {
          if (_2614 < 0.5f) {
            _2658 = ((_2588 * 2.0f) * _2614);
          } else {
            _2658 = (1.0f - (((1.0f - _2588) * 2.0f) * (1.0f - _2614)));
          }
          _2669 = (lerp(_2586, _2634, _2622));
          _2670 = (lerp(_2587, _2646, _2622));
          _2671 = (lerp(_2588, _2658, _2622));
        } while (false);
      } while (false);
    } while (false);
  } else {
...
#if 0  // Original tonemap
  if (tonemapParam_isHDRMode == 0.0f) {
    float _2679 = invLinearBegin * _2669;
    do {
      if (!(_2669 >= linearBegin)) {
        _2687 = ((_2679 * _2679) * (3.0f - (_2679 * 2.0f)));
      } else {
        _2687 = 1.0f;
      }
      float _2688 = invLinearBegin * _2670;
      do {
        if (!(_2670 >= linearBegin)) {
          _2696 = ((_2688 * _2688) * (3.0f - (_2688 * 2.0f)));
        } else {
          _2696 = 1.0f;
        }
        float _2697 = invLinearBegin * _2671;
        do {
          if (!(_2671 >= linearBegin)) {
            _2705 = ((_2697 * _2697) * (3.0f - (_2697 * 2.0f)));
          } else {
            _2705 = 1.0f;
          }
          float _2714 = select((_2669 < linearStart), 0.0f, 1.0f);
          float _2715 = select((_2670 < linearStart), 0.0f, 1.0f);
          float _2716 = select((_2671 < linearStart), 0.0f, 1.0f);
          _2776 = (((((contrast * _2669) + madLinearStartContrastFactor) * (_2687 - _2714)) + (((pow(_2679, toe)) * (1.0f - _2687)) * linearBegin)) + ((maxNit - (exp2((contrastFactor * _2669) + mulLinearStartContrastFactor) * displayMaxNitSubContrastFactor)) * _2714));
          _2777 = (((((contrast * _2670) + madLinearStartContrastFactor) * (_2696 - _2715)) + (((pow(_2688, toe)) * (1.0f - _2696)) * linearBegin)) + ((maxNit - (exp2((contrastFactor * _2670) + mulLinearStartContrastFactor) * displayMaxNitSubContrastFactor)) * _2715));
          _2778 = (((((contrast * _2671) + madLinearStartContrastFactor) * (_2705 - _2716)) + (((pow(_2697, toe)) * (1.0f - _2705)) * linearBegin)) + ((maxNit - (exp2((contrastFactor * _2671) + mulLinearStartContrastFactor) * displayMaxNitSubContrastFactor)) * _2716));
        } while (false);
      } while (false);
    } while (false);
  } else {
  ...
  SV_Target.xyz = CustomTonemap(float3(_2669, _2670, _2671), params, tonemapParam_isHDRMode == 0.0f);
  SV_Target.w = 0.0f;
  return SV_Target;
}
