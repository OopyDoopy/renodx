...
// #endif
  ...
  float3 ap0_color = float3(_387, _390, _393);
  float _394 = abs(_387);
  ...
  // ap1_color = renodx::color::pq::EncodeSafe(ap0_color, 100.f);
  // float _477 = ap1_color.r * 64.f;
  // float _478 = ap1_color.g * 64.f;
  // float _479 = ap1_color.b * 64.f;
