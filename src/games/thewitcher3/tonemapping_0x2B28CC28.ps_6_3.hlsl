...
OutputSignature main(
  ...
  //float3 untonemapped = renodx::color::gamma::DecodeSafe(_29.rgb);
  //float3 untonemapped = _29.rgb;
  //untonemapped = renodx::color::y::from::BT2020(untonemapped);

  float _34 = CustomPixelConsts_032.y * CustomPixelConsts_032.x;
  ...
  float3 untonemapped = float3(_140, _141, _142);
  ...
  float3 tonemapped_bt709 = float3(_180, _181, _182);
  ...
  SV_Target.rgb = renodx::color::pq::EncodeSafe(untonemapped.rgb, 1.f);
  //SV_Target.w = untonemapped.w;
  //SV_Target.rgb = renodx::color::pq::EncodeSafe(tonemapped_bt709, 1.f);
