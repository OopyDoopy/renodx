  ...
  out float4 o0 : SV_Target0)
{
  ...
  if (r0.y != 0) {
    ...
    if (r0.y != 0) {
      ...
      r2.xyzw = r1.yxzw * cb0[128].xyxy + v1.xyxy;
      r2.xyzw = cb0[128].xyxy * float4(-1,0,1,0) + r2.xyzw;
    ...
    r2.x = r3.w;
    r0.zw = cb0[128].xy * float2(1,0) + v1.xy;
    ...
    if (r0.y != 0) {
      r2.y = -r2.x;
      r4.xyzw = r2.yyzz * cb0[128].xyxy + v1.xyxy;
      r5.xyzw = cb0[128].xyxy * float4(-1,0,0,-1) + r4.xyxy;
      r6.xyzw = t0.SampleLevel(s0_s, r5.xy, 0).xyzw;
      r5.xyzw = t0.SampleLevel(s0_s, r5.zw, 0).yzxw;
      r0.yz = cb0[128].xy * float2(1,0) + r4.zw;
      r4.xyzw = t0.SampleLevel(s0_s, r0.yz, 0).xyzw;
      r5.x = r6.y;
      r5.yw = r4.yx;
    ...
    if (r0.y != 0) {
      ...
      while (true) {
        ...
        if (r0.y == 0) break;
        r3.xyzw = t0.SampleLevel(s0_s, r2.xy, 0).xyzw;
        r2.xy = cb0[128].xy * float2(-2,-0) + r2.xy;
        r2.z = r3.y;
      }
      r3.yz = r2.xz;
      ...
      while (true) {
        ...
        r4.xy = cb0[128].xy * float2(2,0) + r4.xy;
        r4.z = r5.y;
      }
      r5.yz = r4.xz;
      ...
      r2.z = -cb0[128].x * r0.y + r5.y;
      //r4.xyzw = cb0[128].zzzz * r2.zxzx + -w1.xzzz;
      r4.xyzw = round(r4.xyzw);
      r0.yz = sqrt(abs(r4.wz));
      r1.zw = cb0[128].xy * float2(1,0) + r2.zy;
      r5.xyzw = t0.SampleLevel(s0_s, r1.zw, 0).yxzw;
      r5.x = r3.x;
      ...
      r0.yz = r4.zw / r0.yy;
      r2.w = v1.y;
      r1.zw = cb0[128].xy * float2(0,1) + r2.xw;
      r4.xyzw = t0.SampleLevel(s0_s, r1.zw, 0).xyzw;
      r0.w = -r0.y * r4.x + 1;
      r1.zw = cb0[128].xy + r2.zw;
      r4.xyzw = t0.SampleLevel(s0_s, r1.zw, 0).xyzw;
      r4.x = saturate(-r0.z * r4.x + r0.w);
      r2.xyzw = cb0[128].xyxy * float4(0,-2,1,-2) + r2.xwzw;
      r5.xyzw = t0.SampleLevel(s0_s, r2.xy, 0).xyzw;
      r0.y = -r0.y * r5.x + 1;
      r2.xyzw = t0.SampleLevel(s0_s, r2.zw, 0).xyzw;
      r4.y = saturate(-r0.z * r2.x + r0.y);
      o0.xy = r4.xy * r3.xy;
    } else {
      o0.xy = r1.xy;
      r0.x = 0;
  ...
  if (r0.x != 0) {
    ...
    while (true) {
      ...
      r0.xy = cb0[128].xy * float2(-0,-2) + r0.xy;
      r0.z = r1.y;
    }
    r1.yz = r0.yz;
    ...
    while (true) {
      ...
      if (r1.x == 0) break;
      r3.xyzw = t0.SampleLevel(s0_s, r2.xy, 0).yxzw;
      r2.xy = cb0[128].xy * float2(0,2) + r2.xy;
      r2.z = r3.y;
    }
    r3.yz = r2.yz;
    ...
    r0.z = -cb0[128].y * r1.x + r3.y;
    //r2.xyzw = cb0[128].wwww * r0.zxzx + -w1.ywww;
    r2.xyzw = round(r2.xyzw);
    r1.xz = sqrt(abs(r2.wz));
    r3.xy = cb0[128].xy * float2(0,1) + r0.yz;
    ...
    r1.zw = r2.zw / r0.yy;
    r0.w = v1.x;
    r2.xy = cb0[128].xy * float2(1,0) + r0.wx;
    r2.xyzw = t0.SampleLevel(s0_s, r2.xy, 0).xyzw;
    r0.y = -r1.z * r2.y + 1;
    r2.xy = cb0[128].xy + r0.wz;
    r2.xyzw = t0.SampleLevel(s0_s, r2.xy, 0).xyzw;
    r2.z = saturate(-r1.w * r2.y + r0.y);
    r0.xyzw = cb0[128].xyxy * float4(-2,0,-2,1) + r0.wxwz;
    r3.xyzw = t0.SampleLevel(s0_s, r0.xy, 0).xyzw;
    r0.x = -r1.z * r3.y + 1;
    r3.xyzw = t0.SampleLevel(s0_s, r0.zw, 0).xyzw;
    r2.w = saturate(-r1.w * r3.y + r0.x);
    o0.zw = r2.zw * r1.xy;
  } else {
    o0.zw = float2(0,0);
  }
