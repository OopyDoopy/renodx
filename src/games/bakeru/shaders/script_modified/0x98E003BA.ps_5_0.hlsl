  ...
  out uint o1 : SV_Target1)
{
  ...
  r0.xyz = t5.SampleBias(s5_s, v4.xy, cb0[19].x).xyw;
  r0.x = r0.z * r0.x;
  ...
  r0.w = cmp(0 >= r2.z);
  r1.w = cmp(r2.z >= 1);
  r2.x = t6.SampleCmpLevelZero(s6_s, r2.xy, r2.z).x;
  ...
  r0.xyz = r2.xyz + r0.xyz;
  r2.xyzw = t4.SampleBias(s2_s, v4.xy, cb0[19].x).xyzw;
  r2.xyz = cb2[27].xyz * r2.xyz;
  r0.w = cb2[6].w * r2.w;
  r2.xyz = v1.xyz * r2.xyz;
  r3.x = dot(v12.xzy, r1.xyz);
  r3.y = dot(v13.xzy, r1.xyz);
  r1.xy = r3.xy * float2(0.5,0.5) + float2(0.5,0.5);
  r3.xyz = t1.Sample(s3_s, r1.xy).xyz;
  r1.xyz = t0.Sample(s0_s, r1.xy).xyz;
  r1.xyz = cb2[17].xyz * r1.xyz;
  r3.xyz = r3.xyz * cb2[38].xyz + -r1.xyz;
  r1.xyz = v4.zzz * r3.xyz + r1.xyz;
  r1.w = t3.Sample(s4_s, v4.xy).w;
  r2.w = t2.Sample(s1_s, v3.xy).w;
  r1.w = -r2.w + r1.w;
  r1.w = v4.z * r1.w + r2.w;
