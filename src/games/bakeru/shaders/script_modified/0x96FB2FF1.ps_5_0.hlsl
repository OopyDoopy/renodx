  ...
  out uint o1 : SV_Target1)
{
  ...
  r0.w = t1.Sample(s3_s, v4.xy).w;
  r0.xyz = r0.xyz * r0.www;
  r2.xyzw = t3.SampleBias(s0_s, v5.xy, cb0[19].x).xyzw;
  r2.xyz = float3(-0.5,-0.5,-0.5) + r2.xyz;
  r0.w = max(9.99999975e-05, r2.w);
  r1.x = dot(r1.xyz, r2.xyz);
  r1.x = 0.5 + r1.x;
  r1.yzw = t2.SampleBias(s0_s, v5.xy, cb0[19].x).xyz;
  r1.xyz = r1.yzw * r1.xxx;
  r1.xyz = r1.xyz / r0.www;
  r2.xyzw = t4.SampleBias(s1_s, v4.xy, cb0[19].x).xyzw;
