  ...
  out uint o1 : SV_Target1)
{
  ...
  r0.w = cmp(0 >= r0.z);
  r1.x = cmp(r0.z >= 1);
  r0.x = t2.SampleCmpLevelZero(s1_s, r0.xy, r0.z).x;
  ...
  r1.xyzw = t1.SampleBias(s0_s, v3.xy, cb0[19].x).xyzw;
  r1.xyzw = cb2[6].xyzw * r1.xyzw;
  r1.xyz = v1.xyz * r1.xyz;
  r2.xyz = r1.xyz * r0.xyz + cb2[18].xyz;
  r0.xyz = r1.xyz * r0.xyz + -r2.xyz;
  r0.w = saturate(dot(v5.xyz, float3(0.298999995,0.587000012,0.114)));
