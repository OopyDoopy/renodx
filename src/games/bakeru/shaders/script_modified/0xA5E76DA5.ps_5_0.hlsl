  ...
  out uint o1 : SV_Target1)
{
  ...
  r0.xyz = t9.SampleBias(s6_s, v10.xy, cb0[19].x).xyw;
  r0.x = r0.z * r0.x;
  ...
  r1.xyz = t7.SampleBias(s2_s, v9.xy, cb0[19].x).xyw;
  r1.x = r1.z * r1.x;
  ...
  r2.xyzw = t5.SampleBias(s0_s, v3.xy, cb0[19].x).xyzw;
  r2.xyz = float3(-0.5,-0.5,-0.5) + r2.xyz;
  r0.w = max(9.99999975e-05, r2.w);
  r0.x = dot(r0.xyz, r2.xyz);
  r0.x = 0.5 + r0.x;
  r2.xyz = t4.SampleBias(s0_s, v3.xy, cb0[19].x).xyz;
  r0.xyz = r2.xyz * r0.xxx;
  r0.xyz = r0.xyz / r0.www;
  r2.xyz = t8.SampleBias(s5_s, v10.xy, cb0[19].x).xyz;
  r2.xyz = cb1[23].xyz * r2.xyz;
  r2.xyz = v8.yyy * r2.xyz;
  r3.xyzw = t6.SampleBias(s1_s, v9.xy, cb0[19].x).xyzw;
