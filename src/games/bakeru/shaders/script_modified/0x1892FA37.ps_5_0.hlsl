  ...
  out uint o1 : SV_Target1)
{
  ...
  r0.xyzw = t8.SampleBias(s7_s, r0.xy, cb0[19].x).xyzw;
  r0.x = r0.x + r0.y;
  r0.x = r0.x + r0.z;
  ...
  r0.x = cmp(r0.x < 0);
  if (r0.x != 0) discard;
  r0.xyz = t7.SampleBias(s5_s, v4.xy, cb0[19].x).xyw;
  r0.x = r0.z * r0.x;
  ...
  r2.xyzw = t6.SampleBias(s2_s, v4.xy, cb0[19].x).xyzw;
  r2.xyz = cb2[27].xyz * r2.xyz;
  r1.w = cb2[6].w * r2.w;
  ...
  r2.xy = t1.Sample(s4_s, v4.xy).zw;
r0.xyz = HDRSaturate(r0.xyz * r2.yyy + r1.xyz);
  r1.xyz = t2.Sample(s1_s, v9.xy).xyz;
  r1.xyz = cb2[14].xyz * r1.xyz;
  r2.yzw = t2.Sample(s1_s, v9.zw).xyz;
  r1.xyz = r2.yzw * r1.xyz;
  r0.xyz = r1.xyz * r2.xxx + r0.xyz;
  r1.xyz = cb3[2].xyz + v2.xyz;
  r2.xy = cb3[4].xy * r1.zz;
  r1.xz = cb3[3].xy * r1.xx + r2.xy;
  r1.xy = cb3[5].xy * r1.yy + r1.xz;
  r1.xy = cb3[6].xy + r1.xy;
  r2.xyzw = t3.Sample(s6_s, r1.xy).xyzw;
  r1.xyz = float3(1,1,1) + -cb3[1].xyz;
