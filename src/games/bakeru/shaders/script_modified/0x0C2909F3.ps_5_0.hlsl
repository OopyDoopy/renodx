  ...
  out uint o1 : SV_Target1)
{
  ...
  r1.xyz = t4.SampleBias(s2_s, v3.xy, cb0[19].x).xyw;
  r1.x = r1.z * r1.x;
  r1.xy = r1.xy * float2(2,2) + float2(-1,-1);
  r1.zw = cb1[17].ww * r1.xy;
  ...
  r1.xyzw = t2.SampleBias(s0_s, v5.xy, cb0[19].x).xyzw;
  r1.xyz = float3(-0.5,-0.5,-0.5) + r1.xyz;
  r0.w = max(9.99999975e-05, r1.w);
  r0.x = dot(r0.xyz, r1.xyz);
  r0.x = 0.5 + r0.x;
  r1.xyz = t1.SampleBias(s0_s, v5.xy, cb0[19].x).xyz;
  r0.xyz = r1.xyz * r0.xxx;
  r0.xyz = r0.xyz / r0.www;
  r0.w = saturate(dot(r0.xyz, float3(0.298999995,0.587000012,0.114)));
  r1.xyzw = t3.SampleBias(s1_s, v3.xy, cb0[19].x).xyzw;
  r1.xyzw = cb1[6].xyzw * r1.xyzw;
  r1.xyz = v1.xyz * r1.xyz;
  r2.xyz = r1.xyz * r0.xyz + cb1[18].xyz;
  r0.xyz = r1.xyz * r0.xyz + -r2.xyz;
r0.xyz = HDRSaturate(r0.www * r0.xyz + r2.xyz);
