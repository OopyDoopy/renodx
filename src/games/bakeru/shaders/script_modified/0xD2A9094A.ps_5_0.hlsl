  ...
  out uint o1 : SV_Target1)
{
  ...
  r0.x = cmp(r0.x < 0);
  if (r0.x != 0) discard;
  r0.xyzw = t5.SampleBias(s1_s, v3.xy, cb0[19].x).xyzw;
  ...
  r2.xyz = t6.SampleBias(s2_s, v3.xy, cb0[19].x).xyw;
  r2.x = r2.z * r2.x;
  ...
  r2.xyzw = t4.SampleBias(s0_s, v5.xy, cb0[19].x).xyzw;
  r2.xyz = float3(-0.5,-0.5,-0.5) + r2.xyz;
  r1.w = max(9.99999975e-05, r2.w);
  r1.x = dot(r1.xyz, r2.xyz);
  r1.x = 0.5 + r1.x;
  r2.xyz = t3.SampleBias(s0_s, v5.xy, cb0[19].x).xyz;
