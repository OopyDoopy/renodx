  ...
  out uint o1 : SV_Target1)
{
  ...
  r0.xyzw = t8.SampleBias(s8_s, r0.xy, cb0[19].x).xyzw;
  r0.x = r0.x + r0.y;
  r0.x = r0.x + r0.z;
  ...
  r1.xyz = t6.SampleBias(s1_s, v3.xy, cb0[19].x).xyw;
  r1.x = r1.z * r1.x;
  ...
  r1.w = cmp(0 >= r1.z);
  r2.w = cmp(r1.z >= 1);
  r1.x = t7.SampleCmpLevelZero(s6_s, r1.xy, r1.z).x;
  ...
  r2.xyz = cb2[24].xyz * w2.xww;
  r3.xyzw = t5.SampleBias(s0_s, v3.xy, cb0[19].x).xyzw;
