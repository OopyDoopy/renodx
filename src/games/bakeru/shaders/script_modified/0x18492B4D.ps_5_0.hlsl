  ...
  out uint o1 : SV_Target1)
{
  ...
  r1.xyz = t5.SampleBias(s1_s, v3.xy, cb0[19].x).xyw;
  r1.x = r1.z * r1.x;
  ...
  r1.w = cmp(0 >= r1.z);
  r2.w = cmp(r1.z >= 1);
  r1.x = t6.SampleCmpLevelZero(s6_s, r1.xy, r1.z).x;
  ...
  r2.xyzw = t4.SampleBias(s0_s, v3.xy, cb0[19].x).xyzw;
