  ...
  out uint o1 : SV_Target1)
{
  ...
  r0.xyzw = t6.SampleBias(s1_s, v3.xy, cb0[19].x).xyzw;
  ...
  r2.xyz = t7.SampleBias(s2_s, v3.xy, cb0[19].x).xyw;
  r2.x = r2.z * r2.x;
  r2.xy = r2.xy * float2(2,2) + float2(-1,-1);
  r3.xy = cb1[17].ww * r2.xy;
  ...
  r1.x = 0.5 + r1.x;
  r2.xyz = t4.SampleBias(s0_s, v5.xy, cb0[19].x).xyz;
...
r0.xyz = HDRSaturate(r1.xyz * r2.yyy + r0.xyz);
  ...
  r1.xyzw = t3.Sample(s6_s, r1.xy).xyzw;
