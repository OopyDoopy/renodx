  ...
  out uint o1 : SV_Target1)
{
  ...
  r0.xyzw = t9.SampleBias(s8_s, r0.xy, cb0[19].x).xyzw;
  r0.x = r0.x + r0.y;
  r0.x = r0.x + r0.z;
  ...
  r1.xyz = t8.SampleBias(s2_s, v3.xy, cb0[19].x).xyw;
  r1.x = r1.z * r1.x;
  ...
  r1.xyzw = t6.SampleBias(s0_s, v5.xy, cb0[19].x).xyzw;
  r1.xyz = float3(-0.5,-0.5,-0.5) + r1.xyz;
  r0.w = max(9.99999975e-05, r1.w);
  r0.x = dot(r0.xyz, r1.xyz);
  r0.x = 0.5 + r0.x;
  r1.xyz = t5.SampleBias(s0_s, v5.xy, cb0[19].x).xyz;
  ...
  r2.xyzw = t7.SampleBias(s1_s, v3.xy, cb0[19].x).xyzw;
...
r0.xyz = HDRSaturate(r2.xyz * r0.xyz + r1.xyz);
  ...
  r1.xyz = exp2(r1.xyz);
  r2.xyz = t4.Sample(s5_s, v3.xy).xyz;
  r1.xyz = r2.xyz * r1.xyz;
  r0.w = exp2(cb2[22].x);
  r1.xyz = r1.xyz * r0.www;
  r2.x = cb2[22].y * cb0[11].y;
  r2.y = 0.5;
  r0.w = t3.Sample(s6_s, r2.xy).w;
  r1.xyz = r1.xyz * r0.www;
  r2.xyz = cb3[2].xyz + v2.xyz;
  r3.xy = cb3[4].xy * r2.zz;
  r2.xz = cb3[3].xy * r2.xx + r3.xy;
  r2.xy = cb3[5].xy * r2.yy + r2.xz;
  r2.xy = cb3[6].xy + r2.xy;
  r3.xyzw = t2.Sample(s7_s, r2.xy).xyzw;
