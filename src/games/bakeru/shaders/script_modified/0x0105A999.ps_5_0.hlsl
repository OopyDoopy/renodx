#include "..\..\common.hlsl"
// ---- Created with 3Dmigoto v1.4.1 on Sat Mar 29 10:57:17 2025
  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.w = cmp(0 != cb2[8].x);
  r0.w = r0.w ? v4.w : 1;
  r1.xyzw = cmp(cb2[0].wwww == float4(1,2,3,4));
  r2.xyzw = cmp(cb2[0].wwww == float4(5,6,7,8));
  r3.xyzw = cmp(cb2[0].wwyy == float4(9,10,1,2));
  r3.y = r3.y ? v3.w : 1;
  r3.x = r3.x ? v3.z : r3.y;
  r2.w = r2.w ? v3.y : r3.x;
  r2.z = r2.z ? v3.x : r2.w;
  ...
  r5.xyzw = cmp(cb2[0].yyyy == float4(7,8,9,10));
  r1.z = r5.w ? v3.w : 1;
  r1.z = r5.z ? v3.z : r1.z;
  r1.z = r5.y ? v3.y : r1.z;
  r1.z = r5.x ? v3.x : r1.z;
  ...
  r1.z = r4.y ? v1.w : r1.z;
  r3.y = r4.x ? v1.z : r1.z;
  r1.zw = cb2[6].zw * r3.xy;
  r3.xyzw = cmp(cb2[10].zzzz == float4(1,2,3,4));
  r4.xyzw = cmp(cb2[10].zzzz == float4(5,6,7,8));
  r5.xy = cmp(cb2[10].zz == float2(9,10));
  r2.w = r5.y ? v3.w : 0;
  r2.w = r5.x ? v3.z : r2.w;
  r2.w = r4.w ? v3.y : r2.w;
  r2.w = r4.z ? v3.x : r2.w;
  ...
  r2.w = r2.w + r1.z;
  r1.x = saturate(-cb2[8].z * r1.x + r2.w);
  r2.w = r3.y + -r3.x;
  r1.x = r1.x + -r3.x;
  r2.w = 1 / r2.w;
  ...
  r1.y = -0.5 + r1.z;
  r1.z = cb2[11].x * r1.y;
  r3.xyzw = cmp(cb2[1].yyyy == float4(1,2,3,4));
  r4.xyzw = cmp(cb2[1].yyyy == float4(5,6,7,8));
  r5.xy = cmp(cb2[1].yy == float2(9,10));
  r1.w = r5.y ? v3.w : 0;
  r1.w = r5.x ? v3.z : r1.w;
  r1.w = r4.w ? v3.y : r1.w;
  r1.w = r4.z ? v3.x : r1.w;
  ...
  r1.w = r1.w * r3.x + cb2[7].z;
  r3.z = cb2[5].w * r2.z;
  r3.x = r2.y * cb2[5].z + r1.w;
  r1.w = 0.0174532924 * cb2[1].z;
  ...
  r1.y = cb2[11].x * r1.y + r1.w;
  r1.y = 0.5 + r1.y;
  r1.w = saturate(r1.y);
  r1.y = 1 + -r1.y;
  r1.y = saturate(cb2[8].y * r1.y);
  r2.y = r1.w * r1.y;
  r2.z = cb2[6].y + -cb2[6].x;
  r1.y = r1.w * r1.y + -cb2[6].x;
  r1.w = 1 / r2.z;
