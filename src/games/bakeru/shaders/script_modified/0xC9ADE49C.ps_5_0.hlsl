  ...
  out uint o1 : SV_Target1)
{
  ...
  r0.xyzw = t0.SampleBias(s0_s, v3.xy, cb0[19].x).xyzw;
  r1.x = r0.w * cb1[6].w + -cb1[7].x;
  r0.xyzw = cb1[6].xyzw * r0.xyzw;
  r1.x = cmp(r1.x < 0);
  if (r1.x != 0) discard;
  r0.xyz = v1.xyz * r0.xyz;
  r1.xyz = r0.xyz * v5.xyz + cb1[18].xyz;
  r0.xyz = r0.xyz * v5.xyz + -r1.xyz;
  r1.w = saturate(dot(v5.xyz, float3(0.298999995,0.587000012,0.114)));
r0.xyz = HDRSaturate(r1.www * r0.xyz + r1.xyz);
