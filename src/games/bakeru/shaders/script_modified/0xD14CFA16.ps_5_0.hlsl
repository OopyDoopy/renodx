  ...
  out uint o1 : SV_Target1)
{
  ...
  r0.w = cmp(0 >= r0.z);
  r1.x = cmp(r0.z >= 1);
  r0.x = t2.SampleCmpLevelZero(s2_s, r0.xy, r0.z).x;
  ...
  r0.w = t1.Sample(s1_s, v3.xy).w;
  r1.xyz = r1.xyz * r0.www;
  r2.xyz = cb2[6].xyz * v1.xyz;
r0.xyz = HDRSaturate(r2.xyz * r0.xyz + r1.xyz);
  r0.xyz = cb2[23].xyz + r0.xyz;
  r0.xyz = cb2[46].xyz * r0.xyz + -cb2[48].xyz;
  r0.w = -cb2[47].x + v2.y;
  r1.x = cb2[47].y + -cb2[47].x;
  r0.w = saturate(r0.w / r1.x);
  r0.xyz = r0.www * r0.xyz + cb2[48].xyz;
  r1.xyz = r0.xyz * cb2[49].xxx + -cb0[56].xyz;
  r1.xyz = v3.zzz * r1.xyz + cb0[56].xyz;
  r0.xyz = r0.xyz * cb2[49].xxx + -r1.xyz;
  r0.w = -cb2[45].z + v2.y;
  r1.w = cb2[45].w + -cb2[45].z;
