...
r0.xyz = HDRSaturate(r2.xyz * r0.xyz + r1.xyz);
  ...
  r0.xyz = cb1[46].xyz * r0.xyz + -cb1[48].xyz;
  r0.w = -cb1[47].x + v2.y;
  r1.x = cb1[47].y + -cb1[47].x;
  r0.w = saturate(r0.w / r1.x);
  r0.xyz = r0.www * r0.xyz + cb1[48].xyz;
  r1.xyz = r0.xyz * cb1[49].xxx + -cb0[56].xyz;
  r1.xyz = v3.zzz * r1.xyz + cb0[56].xyz;
  r0.xyz = r0.xyz * cb1[49].xxx + -r1.xyz;
  r0.w = -cb1[45].z + v2.y;
  r1.w = cb1[45].w + -cb1[45].z;
