  ...
  out uint o1 : SV_Target1)
{
  ...
  r0.xyz = cb2[2].xyz + v2.xyz;
  r0.zw = cb2[4].xy * r0.zz;
  r0.xz = cb2[3].xy * r0.xx + r0.zw;
  r0.xy = cb2[5].xy * r0.yy + r0.xz;
  r0.xy = cb2[6].xy + r0.xy;
  ...
  r1.x = 0.5 + r1.x;
  r1.yzw = t1.SampleBias(s0_s, v5.xy, cb0[19].x).xyz;
  r1.xyz = r1.yzw * r1.xxx;
  r1.xyz = r1.xyz / r0.www;
  r2.xyzw = t3.SampleBias(s1_s, v3.xy, cb0[19].x).xyzw;
  r2.xyzw = cb1[6].xyzw * r2.xyzw;
  r2.xyz = v1.xyz * r2.xyz;
  r3.xyz = r2.xyz * r1.xyz + cb1[18].xyz;
  r2.xyz = r2.xyz * r1.xyz + -r3.xyz;
  r0.w = saturate(dot(r1.xyz, float3(0.298999995,0.587000012,0.114)));
r1.xyz = HDRSaturate(r0.www * r2.xyz + r3.xyz);
  r0.xyz = r1.xyz * r0.xyz + cb1[23].xyz;
