  ...
  out uint o1 : SV_Target1)
{
  ...
  r1.xyz = t7.SampleBias(s2_s, v3.xy, cb0[19].x).xyw;
  r1.x = r1.z * r1.x;
  ...
  r1.xyzw = t5.SampleBias(s0_s, v5.xy, cb0[19].x).xyzw;
  r1.xyz = float3(-0.5,-0.5,-0.5) + r1.xyz;
  r0.w = max(9.99999975e-05, r1.w);
  r0.x = dot(r0.xyz, r1.xyz);
  r0.x = 0.5 + r0.x;
  r1.xyz = t4.SampleBias(s0_s, v5.xy, cb0[19].x).xyz;
  r0.xyz = r1.xyz * r0.xxx;
  r0.xyz = r0.xyz / r0.www;
  r0.w = saturate(dot(r0.xyz, float3(0.298999995,0.587000012,0.114)));
  r1.xyzw = t6.SampleBias(s1_s, v3.xy, cb0[19].x).xyzw;
  r1.xyzw = cb1[6].xyzw * r1.xyzw;
  r1.xyz = v1.xyz * r1.xyz;
  r3.xyz = r1.xyz * r0.xyz + cb1[18].xyz;
