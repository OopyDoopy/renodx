  ...
  out uint o1 : SV_Target1)
{
  ...
  r0.xyz = t10.SampleBias(s6_s, v10.xy, cb0[19].x).xyw;
  r0.x = r0.z * r0.x;
  ...
  r1.xyz = t8.SampleBias(s2_s, v9.xy, cb0[19].x).xyw;
  r1.x = r1.z * r1.x;
