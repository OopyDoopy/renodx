  ...
  out uint o1 : SV_Target1)
{
  ...
  r0.xyzw = t7.SampleBias(s6_s, r0.xy, cb0[19].x).xyzw;
  r0.x = r0.x + r0.y;
  r0.x = r0.x + r0.z;
  ...
  r1.xyz = t6.SampleBias(s2_s, v3.xy, cb0[19].x).xyw;
  r1.x = r1.z * r1.x;
  ...
  r1.xyzw = t4.SampleBias(s0_s, v5.xy, cb0[19].x).xyzw;
  r1.xyz = float3(-0.5,-0.5,-0.5) + r1.xyz;
  r0.w = max(9.99999975e-05, r1.w);
  r0.x = dot(r0.xyz, r1.xyz);
  r0.x = 0.5 + r0.x;
  r1.xyz = t3.SampleBias(s0_s, v5.xy, cb0[19].x).xyz;
  r0.xyz = r1.xyz * r0.xxx;
  r0.xyz = r0.xyz / r0.www;
  r1.xyzw = t5.SampleBias(s1_s, v3.xy, cb0[19].x).xyzw;
  r1.xyzw = cb2[6].xyzw * r1.xyzw;
  r1.xyz = v1.xyz * r1.xyz;
  r3.xyz = r1.xyz * r0.xyz;
  r3.xyz = cb2[18].xyz * r3.xyz;
  r1.xyz = r1.xyz * r0.xyz + -r3.xyz;
  r0.x = saturate(dot(r0.xyz, float3(0.298999995,0.587000012,0.114)));
...
r0.xyz = HDRSaturate(r1.xyz * r0.www + r0.xyz);
  ...
  r2.xyzw = t2.Sample(s5_s, r1.xy).xyzw;
