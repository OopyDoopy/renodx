// ---- Created with 3Dmigoto v1.4.1 on Fri Mar 28 23:31:13 2025
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r2.xyzw = float4(-1,-1,-1,-1) + cb0[128].xyxy;
  ...
  r0.yzw = t0.SampleBias(s0_s, r4.xy, cb0[19].x).xyz;
  r1.yzw = t0.SampleBias(s0_s, r4.zw, cb0[19].x).xyz;
  //r1.yzw = saturate(r1.yzw);
  //r0.yzw = saturate(r0.yzw);
  r4.xyz = t0.SampleBias(s0_s, r3.zw, cb0[19].x).xyz;
  r3.xyz = t0.SampleBias(s0_s, r3.xy, cb0[19].x).xyz;
  ...
  r1.x = max(r1.x, r0.x);
  r0.x = min(r2.w, r0.x);
  r3.xyz = t0.SampleBias(s0_s, v1.xy, cb0[19].x).xyz;
  //r3.xyz = saturate(r3.xyz);
