  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.xyzw = t1.SampleBias(s0_s, v2.xy, cb0[19].x).xyzw;
  r1.xyzw = t1.SampleBias(s0_s, v2.zw, cb0[19].x).xyzw;
  r2.xyzw = t1.SampleBias(s0_s, v1.xy, cb0[19].x).ywzx;
  r2.x = r0.w;
  r2.y = r1.y;
  r0.x = dot(r2.xyzw, float4(1,1,1,1));
  r0.x = cmp(r0.x < 9.99999975e-06);
  if (r0.x != 0) {
